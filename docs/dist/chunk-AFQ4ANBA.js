import{a as at,e as ot,f as K,g as rt,h as lt,j as dt}from"./chunk-T55EH3WB.js";import{b as k}from"./chunk-J3NRXPJ3.js";import{a as tt,b as D,e}from"./chunk-33BPFLKT.js";import{B as j,D as et,E as nt,G as R,N as it,Q as G,R as f,a as c,c as l,g as st,k as q,l as Q,m as _}from"./chunk-J7UMASMC.js";var L,M,x,V,Y,P,pt,C,yt=null,mt="kanau-setlist-v1",E=[],H=null,I=null,T=null;function W(){T&&(T.disconnect(),T=null)}function ht(t){if(W(),e.songsLimit>=t)return;let s=document.getElementById("songs-infinite-sentinel");s&&(T=new IntersectionObserver(i=>{i[0].isIntersecting&&(e.songsLimit+=100,h())},{rootMargin:"200px"}),T.observe(s))}function Wt(){W(),Et(),Mt(),at(e.data?.songs||[]);let t=c("#panel-songs");t.innerHTML=`
  ...
  `,L=c("#songs-search"),M=c("#songs-sort"),x=c("#songs-genre"),V=c("#songs-filters"),Y=c("#songs-genre-chips"),P=c("#songs-list"),pt=c("#songs-count"),C=c("#songs-more-wrap"),M.value=e.songsSort,x.value=Lt(e.songsGenre)?e.songsGenre:"all",e.songsGenre=x.value,U(),N(),O();let s=document.getElementById("search-suggest"),i=it(()=>{e.songsQuery=L.value,e.songsLimit=100,K(e.songsQuery),F(),k({tab:"songs",q:e.songsQuery},{replace:!0}),N(),h()},120);L.addEventListener("input",()=>{i()}),L.addEventListener("focus",()=>{ct()}),L.addEventListener("blur",()=>{setTimeout(()=>{F()},200)}),s&&s.addEventListener("click",n=>{let a=n.target.closest("[data-suggest]");if(!a)return;let u=a.dataset.suggest;L.value===u?(L.value="",e.songsQuery=""):(L.value=u,e.songsQuery=u),e.songsLimit=100,K(e.songsQuery||u),k({tab:"songs",q:e.songsQuery},{replace:!0}),N(),h()}),M.addEventListener("change",()=>{e.songsSort=M.value,h()}),x.addEventListener("change",()=>{e.songsGenre=x.value,e.songsLimit=100,O(),h()}),V.addEventListener("click",n=>{let a=n.target.closest("[data-filter]");a&&(a.dataset.filter==="favorites"?e.favoritesFilter=!e.favoritesFilter:(e.songsFilter=a.dataset.filter,e.favoritesFilter=!1),e.songsLimit=100,U(),h())}),t.querySelector(".songs-fav-toggle")?.addEventListener("click",()=>{e.favoritesFilter=!e.favoritesFilter,e.favoritesFilter&&(e.songsFilter="all"),e.songsLimit=100,U(),h()}),Y.addEventListener("click",n=>{let a=n.target.closest("[data-genre]");a&&(e.songsGenre=a.dataset.genre,x.value=e.songsGenre,e.songsLimit=100,O(),h())});for(let n of t.querySelectorAll("[data-singer-preset]"))n.addEventListener("click",()=>{e.singerMode=!0,e.singerPreset=e.singerPreset===n.dataset.singerPreset?"all":n.dataset.singerPreset,e.songsLimit=100,h()});c("#compact-btn")?.addEventListener("click",()=>{e.songsView=e.songsView==="compact"?"comfortable":"compact",h()}),c("#setlist-toggle-btn")?.addEventListener("click",()=>$t()),c("#recommend-btn")?.addEventListener("click",()=>xt()),c("#todays-song-btn")?.addEventListener("click",()=>ut());for(let n of t.querySelectorAll("[data-mobile-panel-toggle]"))n.addEventListener("click",()=>bt(n.dataset.mobilePanelToggle));t.onclick=n=>{if(n.target.closest("#search-history-clear")){n.preventDefault(),n.stopPropagation(),lt(),F();return}let u=n.target.closest(".search-history-remove");if(u){n.preventDefault(),n.stopPropagation(),rt(u.dataset.remove),ct();return}let r=n.target.closest(".search-history-item");if(r){n.preventDefault(),n.stopPropagation();let v=r.dataset.query;e.songsQuery=v,L.value=v,e.songsLimit=100,F(),k({tab:"songs",q:v}),h();return}if(n.target.closest("[data-recommend-dismiss]")){n.preventDefault(),n.stopPropagation();let v=c("#recommend-box");v&&(v.hidden=!0,v.innerHTML="");return}if(n.target.closest("[data-todays-song-dismiss]")){n.preventDefault(),n.stopPropagation();let v=c("#todays-song-box");v&&(v.hidden=!0,v.innerHTML="");return}if(n.target.closest("[data-todays-song-reroll]")){n.preventDefault(),n.stopPropagation(),ut();return}let p=n.target.closest("[data-setlist-action]");if(p){n.stopPropagation(),Ft(p);return}let b=n.target.closest("[data-artist-search]");if(b){n.stopPropagation();let v=String(b.dataset.artistSearch||"").replace(/"/g,"");e.songsQuery=`artist:"${v}"`,L.value=e.songsQuery,e.songsLimit=100,k({tab:"songs",q:e.songsQuery}),h();return}let m=n.target.closest("[data-fav-toggle]");if(m){n.preventDefault(),n.stopPropagation();let v=m.dataset.favToggle;tt(v);let Z=D(v);m.classList.toggle("is-active",Z),m.setAttribute("aria-pressed",String(Z)),m.innerHTML=f("heart");return}let $=n.target.closest("[data-tag-search]");if(!$)return;n.stopPropagation();let S=$.dataset.tagType||"tag";e.songsQuery=`${S}:${$.dataset.tagSearch}`,L.value=e.songsQuery,e.songsLimit=100,k({tab:"songs",q:e.songsQuery}),h()},t.oninput=n=>{n.target.id==="setlist-theme"&&(e.setlist.theme=n.target.value,w())},t.onchange=n=>{n.target.id==="setlist-copy-format"&&(e.setlist.copyFormat=n.target.value,w())},t.onkeydown=n=>{n.key==="Enter"&&(!n.target.closest(".setlist-custom-add")&&!n.target.closest(".setlist-custom-details")||n.target.tagName!=="BUTTON"&&(n.preventDefault(),ft()))},h()}function ct(){let t=ot(),s=c("#search-history-dropdown");s&&(yt=s,t.length?s.innerHTML=`
      ...
      `).join("")}
    `:s.innerHTML='<div class="search-history-empty">\u691C\u7D22\u5C65\u6B74\u304C\u3042\u308A\u307E\u305B\u3093</div>',s.hidden=!1)}function F(){let t=c("#search-history-dropdown");t&&(t.hidden=!0)}function bt(t){let s=c("#songs-filter-panel"),i=c("#setlist-planner");if(t==="setlist"&&!e.singerMode){s?.classList.add("is-open"),i?.classList.remove("is-open");for(let a of document.querySelectorAll("[data-mobile-panel-toggle]"))a.classList.toggle("active",a.dataset.mobilePanelToggle==="filters");return}if(e.singerMode){s?.classList.add("is-open"),s?.scrollIntoView({behavior:"smooth",block:"start"});for(let u of document.querySelectorAll("[data-mobile-panel-toggle]"))u.classList.toggle("active",u.dataset.mobilePanelToggle==="filters");return}let n=t==="setlist";s?.classList.toggle("is-open",!n),i?.classList.toggle("is-open",n);for(let a of document.querySelectorAll("[data-mobile-panel-toggle]"))a.classList.toggle("active",a.dataset.mobilePanelToggle===t)}function $t(){if(!e.singerMode)return;e.setlistExpanded=!e.setlistExpanded,y();let t=c("#setlist-planner");e.setlistExpanded&&t?.scrollIntoView({behavior:"smooth",block:"start"})}function B(t){return String(t.genre||"\u672A\u5206\u985E").trim()||"\u672A\u5206\u985E"}function z(){let t=new Map;for(let s of e.data.songs||[]){let i=B(s);t.set(i,(t.get(i)||0)+1)}return[...t.entries()].sort((s,i)=>i[1]-s[1]||s[0].localeCompare(i[0],"ja"))}function Lt(t){return t==="all"||z().some(([s])=>s===t)}function St(){let t=['<option value="all">\u5168\u30B8\u30E3\u30F3\u30EB</option>'];for(let[s,i]of z())t.push(`<option value="${l(s)}">${l(s)} (${i})</option>`);return t.join("")}function wt(){let t=['<button class="genre-chip" type="button" data-genre="all">\u5168\u30B8\u30E3\u30F3\u30EB</button>'];for(let[s,i]of z())t.push(`
      <button class="genre-chip" type="button" data-genre="${l(s)}">
        <span>${l(s)}</span><small>${i}</small>
      </button>
    `);return t.join("")}function O(){for(let t of Y.querySelectorAll("[data-genre]"))t.classList.toggle("active",t.dataset.genre===e.songsGenre)}function U(){for(let s of V.querySelectorAll("[data-filter]"))s.dataset.filter==="favorites"?(s.classList.toggle("primary",e.favoritesFilter),s.classList.toggle("ghost",!e.favoritesFilter)):(s.classList.toggle("primary",s.dataset.filter===e.songsFilter&&!e.favoritesFilter),s.classList.toggle("ghost",s.dataset.filter!==e.songsFilter||e.favoritesFilter));let t=document.querySelector(".songs-fav-toggle");t&&(t.classList.toggle("is-active",e.favoritesFilter),t.setAttribute("aria-pressed",String(e.favoritesFilter)),t.innerHTML=f("heart"))}function N(){let t=document.getElementById("search-suggest");if(!t)return;let s=(e.songsQuery||"").trim();for(let i of t.querySelectorAll("[data-suggest]"))i.classList.toggle("is-active",i.dataset.suggest===s)}function h(){let{songs:t}=e.data,s=q(t,e.songsGenre,B),i=_(s,{singerMode:e.singerMode,preset:e.singerPreset,keyPublished:e.data?.stats?.keyPublished}),n=Q(i,e.songsFilter),{results:a,tokens:u}=dt(e.songsQuery,n),r=e.songsQuery.trim()?a.filter(o=>n.includes(o)):n;if(e.favoritesFilter&&(r=r.filter(o=>e.favorites.has(o.key))),r=j(r,e.songsSort,!!e.songsQuery.trim()),E=r,pt.textContent=`${r.length} / ${t.length}\u66F2`,!r.length){P.innerHTML='<div class="empty-state">\u8A72\u5F53\u3059\u308B\u66F2\u304C\u3042\u308A\u307E\u305B\u3093 \u{1F420}</div>',C.innerHTML="";return}let d=r.slice(0,e.songsLimit);P.classList.toggle("compact",e.songsView==="compact");for(let o of document.querySelectorAll("[data-singer-preset]")){let g=e.singerMode&&e.singerPreset===o.dataset.singerPreset;o.classList.toggle("primary",g),o.classList.toggle("ghost",!g)}c("#compact-btn")&&(c("#compact-btn").textContent=`\u8868\u793A: ${e.songsView==="compact"?"\u30B3\u30F3\u30D1\u30AF\u30C8":"\u8A73\u7D30"}`),P.innerHTML=d.map(o=>_t(o,u)).join(""),y(),e.songsLimit<r.length?(C.innerHTML=`
  ...
  `}function Et(){try{let t=localStorage.getItem(mt);if(!t)return;let s=JSON.parse(t);e.setlist.theme=String(s.theme||""),e.setlist.copyFormat=s.copyFormat==="timestamp"?"timestamp":"simple",e.setlist.items=Array.isArray(s.items)?s.items:[]}catch{e.setlist.items=[]}}function Tt(){let t=e.setlist.items;if(!t.length)return window.location.href.split("?")[0];let s=btoa(unescape(encodeURIComponent(JSON.stringify(t)))),i=new URL(window.location.href.split("?")[0]);return i.searchParams.set("setlist",s),i.toString()}function Mt(){try{let s=new URLSearchParams(window.location.search).get("setlist");if(!s)return;let i=decodeURIComponent(escape(atob(s))),n=JSON.parse(i);if(!Array.isArray(n)||!n.length)return;let a=new Set(e.setlist.items.map(r=>r.key)),u=n.filter(r=>!a.has(r.key));u.length&&(e.setlist.items=[...e.setlist.items,...u],w())}catch{}}async function Ht(){let t=Tt();if(!e.setlist.items.length){y("\u5171\u6709\u3059\u308B\u66F2\u304C\u3042\u308A\u307E\u305B\u3093");return}try{await navigator.clipboard.writeText(t),y("\u5171\u6709URL\u3092\u30B3\u30D4\u30FC\u3057\u307E\u3057\u305F")}catch{y("\u30B3\u30D4\u30FC\u306B\u5931\u6557\u3057\u307E\u3057\u305F")}}function w(){localStorage.setItem(mt,JSON.stringify(e.setlist))}function J(t){return(e.data.songs||[]).find(s=>s.key===t)||null}function A(t){t&&(e.setlist.items.push({key:t.key,title:t.title,artist:t.artist,displayKey:t.displayKey||"",genre:t.genre||"",moodTags:t.moodTags||[],seasonTags:t.seasonTags||[],daysSinceLast:t.daysSinceLast}),w(),y("\u8FFD\u52A0\u3057\u307E\u3057\u305F"))}function ft(){let t=c("#setlist-custom-title"),s=c("#setlist-custom-artist"),i=c("#setlist-custom-key"),n=String(t?.value||"").trim(),a=String(s?.value||"").trim(),u=String(i?.value||"").trim();if(!n){y("\u66F2\u540D\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044");return}e.setlist.items.push({key:`custom:${Date.now()}:${Math.random().toString(36).slice(2,8)}`,custom:!0,title:n,artist:a,displayKey:u,genre:"\u65B0\u898F",moodTags:[],seasonTags:[],daysSinceLast:null}),w(),y("\u65B0\u3057\u3044\u66F2\u3092\u8FFD\u52A0\u3057\u307E\u3057\u305F")}function It(t){if(t.custom)return t;let s=J(t.key);return s?{...t,...s}:t}function Ft(t){let s=t.dataset.setlistAction,i=Number(t.dataset.index);if(s==="add"&&A(J(t.dataset.songkey)),s==="todays-song-add"&&A(J(t.dataset.songkey)),s==="remove"&&e.setlist.items.splice(i,1),s==="up"&&i>0&&([e.setlist.items[i-1],e.setlist.items[i]]=[e.setlist.items[i],e.setlist.items[i-1]]),s==="down"&&i<e.setlist.items.length-1&&([e.setlist.items[i+1],e.setlist.items[i]]=[e.setlist.items[i],e.setlist.items[i+1]]),s==="copy-item"){Qt(i);return}if(s==="add-custom"){ft();return}if(s==="random"&&Pt(),s==="copy"&&qt(),s==="share"){Ht();return}s==="clear"&&confirm("\u30BB\u30C8\u30EA\u3092\u7A7A\u306B\u3057\u307E\u3059\u304B\uFF1F")&&(e.setlist.items=[]),w(),["add","random","copy"].includes(s)||y()}function Pt(){let t=new Set(e.setlist.items.map(n=>n.key)),s=(E.length?E:e.data.songs).filter(n=>n.key&&!t.has(n.key));if(!s.length){y("\u8FFD\u52A0\u3067\u304D\u308B\u5019\u88DC\u304C\u3042\u308A\u307E\u305B\u3093");return}let i=s[Math.floor(Math.random()*s.length)];A(i)}function X(){return e.setlist.items.map(It)}function y(t=""){let s=c("#setlist-planner");if(!s)return;if(jt(),s.hidden=!e.singerMode||!e.setlistExpanded,s.classList.toggle("is-open",e.singerMode&&e.setlistExpanded),!e.singerMode){s.innerHTML="";return}let i=X(),n=nt(i),a=i.length*5;s.innerHTML=`
    ...
    <div class="setlist-items">
      ${i.length?i.map((u,r)=>Ct(u,r)).join(""):'<div class="setlist-empty">\u66F2\u306E\u300C\u30BB\u30C8\u30EA\u300D\u30DC\u30BF\u30F3\u304B\u30E9\u30F3\u30C0\u30E0\u8FFD\u52A0\u304B\u3089\u4F5C\u308C\u307E\u3059</div>'}
    </div>
  ...
  `,At(),Bt()}function gt(t,s){return s.length?`<span>${t} ${s.map(([i,n])=>`${l(i)} ${n}`).join(" / ")}</span>`:`<span>${t} \u2014</span>`}function Ct(t,s){return`
  ...
  `}function At(){let t=document.getElementById("setlist-search-input"),s=document.getElementById("setlist-search-dropdown");if(!t||!s)return;let i=[],n=-1;function a(d){let o=d.trim().toLowerCase();if(!o){s.hidden=!0,i=[],n=-1;return}let p=(e.data?.songs||[]).filter(m=>m.title.toLowerCase().includes(o)||(m.artist||"").toLowerCase().includes(o)).sort((m,$)=>{let S=m.title.toLowerCase().startsWith(o)?2:m.title.toLowerCase().includes(o)?1:0,v=$.title.toLowerCase().startsWith(o)?2:$.title.toLowerCase().includes(o)?1:0;return S!==v?v-S:$.count-m.count}).slice(0,8),b={_isNew:!0,title:d.trim()};p.length?(s.innerHTML=p.map((m,$)=>`
...
`)}function vt(t){let s=String(t?.title||"").trim(),i=String(t?.artist||"").trim(),n=i?`${s} / ${i}`:s;return e.setlist.copyFormat==="timestamp"?`00:00\u3000${n}\u300000:00`:n}async function qt(){let t=Dt();if(!t.trim()){y("\u30B3\u30D4\u30FC\u3059\u308B\u66F2\u304C\u3042\u308A\u307E\u305B\u3093");return}try{await navigator.clipboard.writeText(t),y("\u30B3\u30D4\u30FC\u3057\u307E\u3057\u305F")}catch{y("\u30B3\u30D4\u30FC\u306B\u5931\u6557\u3057\u307E\u3057\u305F")}}async function Qt(t){let s=X()[t];if(!s){y("\u30B3\u30D4\u30FC\u3059\u308B\u66F2\u304C\u3042\u308A\u307E\u305B\u3093");return}try{await navigator.clipboard.writeText(vt(s)),y("1\u66F2\u30B3\u30D4\u30FC\u3057\u307E\u3057\u305F")}catch{y("\u30B3\u30D4\u30FC\u306B\u5931\u6557\u3057\u307E\u3057\u305F")}}function _t(t,s){let i=t.rank===1?"r1":t.rank===2?"r2":t.rank===3?"r3":"",n=t.lastSung?`<span class="last-date">${R(t.lastSung)}</span><span class="badge ${st(t.daysSinceLast)}">${t.daysSinceLast}\u65E5\u524D</span>`:'<span class="last-date">\u5C65\u6B74\u672A\u78BA\u8A8D</span><span class="badge never">\u8981\u78BA\u8A8D</span>',a=G(t.title,s),u=G(t.artist,s),r=et(t,e.songsQuery),d=D(t.key);return`
  ...
  `}function jt(){let t=c("#setlist-toggle-btn");if(!t)return;let s=e.setlist.items.length;t.setAttribute("aria-expanded",e.setlistExpanded?"true":"false"),t.textContent=e.setlistExpanded?`\u30BB\u30C8\u30EA\u5236\u4F5C\u3092\u9589\u3058\u308B${s?` (${s})`:""}`:`\u30BB\u30C8\u30EA\u5236\u4F5C\u3092\u958B\u304F${s?` (${s})`:""}`}function Rt(t){return[...(t.seasonTags||[]).map(i=>({tag:i,type:"season"})),...(t.moodTags||[]).map(i=>({tag:i,type:"mood"})),...e.singerMode?(t.singerTags||[]).map(i=>({tag:i,type:"tag"})):[]].slice(0,e.songsView==="compact"?2:5).map(({tag:i,type:n})=>`
    <button class="tag-badge tag-click" type="button" data-tag-type="${n}" data-tag-search="${l(i)}">${l(i)}</button>
  `).join("")}function Gt(t){if(!e.singerMode)return"";let s=`<button class="setlist-add-btn" type="button" data-setlist-action="add" data-songkey="${l(t.key)}">${f("plus")} \u30BB\u30C8\u30EA</button>`;if(!e.data?.stats?.keyPublished)return`<div class="song-key-line song-key-actions">${s}</div>`;let i=String(t.displayKey||"").split(",").map(a=>a.trim()).filter(Boolean);return i.length?`<div class="song-key-line song-key-actions">${i.map(a=>`<button type="button" class="song-key-badge" data-tooltip="\u914D\u4FE1\u3067\u4F7F\u308F\u308C\u305F\u53C2\u8003\u30AD\u30FC"><span>\u30AD\u30FC</span><strong>${l(a)}</strong></button>`).join("")}${s}</div>`:`<div class="song-key-line song-key-actions"><span class="song-key-empty">\u30AD\u30FC\u672A\u767B\u9332</span>${s}</div>`}export{Wt as renderSongs};

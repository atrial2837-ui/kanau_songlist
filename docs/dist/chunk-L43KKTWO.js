import{b as f,c as y}from"./chunk-MKJIXTK4.js";import{f as k}from"./chunk-55G5GR7B.js";import{e as r}from"./chunk-33BPFLKT.js";import{a as u}from"./chunk-3Q4FI4S7.js";import{G as g,I as $,a as d,c}from"./chunk-C3AAXPYP.js";var I='<svg viewBox="0 0 24 24" width="13" height="13" aria-hidden="true"><rect x="9" y="2" width="6" height="4" rx="1"/><path d="M9 4H7a2 2 0 0 0-2 2v14a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2h-2"/></svg>',w='<svg viewBox="0 0 24 24" width="13" height="13" aria-hidden="true"><polygon points="6 4 19 12 6 20 6 4"/></svg>';function v(){let{streams:s}=r.data,o=r.timelineFilter,t=o?s.filter(e=>e.songs.some(a=>a.key===o.key)):s,n=E(t,r.timelineSort),i=r.timelineSort==="date-desc"||r.timelineSort==="date-asc",l=d("#panel-timeline");l.innerHTML=`
  ...
  `,d("#timeline-sort")?.addEventListener("change",e=>{r.timelineSort=e.target.value||"date-desc",r.timelineLimit=f,v()});let m=d("#timeline-filter-banner");if(o){let e=n.reduce((a,b)=>a+b.songs.filter(h=>h.key===o.key).length,0);m.innerHTML=`

import{b as gt,c as kt,d as wt,i as $t,k as it,l as V}from"./chunk-DSNH5IKV.js";import{a as Lt,b as St,e as nt,f as Et}from"./chunk-SIADDXVK.js";import{a as Y}from"./chunk-MKJIXTK4.js";import{I as st,J as L,L as D,Q as P,R as yt,a as ht,b as at,c as bt,e as c,f as i,g as w,i as m}from"./chunk-6YA3HG5E.js";var g=-1,E=[],lt=null;function _t(t){lt=t;let e=document.createElement("div");e.id="omni-backdrop",e.hidden=!0,e.setAttribute("role","dialog"),e.setAttribute("aria-modal","true"),e.setAttribute("aria-label","\u30B5\u30A4\u30C8\u5185\u691C\u7D22"),e.innerHTML=`
    <div id="omni-box">
  ...
  `,document.body.appendChild(e),e.addEventListener("click",s=>{s.target===e&&R()});let a=document.getElementById("omni-input");a.addEventListener("input",()=>It(a.value)),a.addEventListener("keydown",Xt),document.getElementById("omni-listbox").addEventListener("click",s=>{let l=s.target.closest("[data-omni-idx]");l&&Mt(Number(l.dataset.omniIdx))})}function Ct(){let t=document.getElementById("omni-backdrop");if(!t)return;t.hidden=!1,g=-1,E=[];let e=document.getElementById("omni-input");e&&(e.value="",e.focus(),e.select()),It("")}function R(){let t=document.getElementById("omni-backdrop");t&&(t.hidden=!0),g=-1}function Pt(){let t=document.getElementById("omni-backdrop");return!!(t&&!t.hidden)}function Xt(t){let e=document.querySelectorAll("#omni-listbox [data-omni-idx]");t.key==="ArrowDown"?(t.preventDefault(),g=Math.min(g+1,e.length-1),Tt(e)):t.key==="ArrowUp"?(t.preventDefault(),g=Math.max(g-1,-1),Tt(e)):t.key==="Enter"?(t.preventDefault(),g>=0&&E[g]&&Mt(g)):t.key==="Escape"&&(t.preventDefault(),R())}function Tt(t){t.forEach((e,a)=>{e.classList.toggle("is-active",a===g),e.setAttribute("aria-selected",String(a===g))}),g>=0&&t[g]?.scrollIntoView({block:"nearest"})}function Mt(t){let e=E[t];!e||!lt||(R(),lt(e))}function It(t){let e=document.getElementById("omni-listbox");if(!e)return;g=-1,E=[];let a=c.data?.songs||[],s=c.data?.streams||[],l=t.trim().toLowerCase(),n="",o=0;if(!c.data){e.innerHTML='<div class="omni-empty">\u30C7\u30FC\u30BF\u8AAD\u307F\u8FBC\u307F\u4E2D\u2026</div>';return}if(!l){let r=a.slice(0,8);if(r.length){n+=G("\u{1F3C6} \u3088\u304F\u6B4C\u308F\u308C\u308B\u66F2");for(let p of r)E.push({type:"song",song:p}),n+=xt(p,o++,"")}e.innerHTML=n||'<div class="omni-empty">\u691C\u7D22\u30EF\u30FC\u30C9\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044</div>';return}let d=a.filter(r=>A(r.title).includes(l)||A(r.artist).includes(l)).slice(0,8);if(d.length){n+=G("\u{1F3B5} \u66F2");for(let r of d)E.push({type:"song",song:r}),n+=xt(r,o++,l)}let v=new Set,u=[];for(let r of a)if(A(r.artist).includes(l)&&!v.has(r.artist)&&(v.add(r.artist),u.push(r.artist),u.length>=4))break;if(u.length){n+=G("\u{1F3A4} \u30A2\u30FC\u30C6\u30A3\u30B9\u30C8");for(let r of u){let p=a.filter(f=>f.artist===r).length;E.push({type:"artist",artist:r}),n+=`<div class="omni-item" role="option" aria-selected="false" data-omni-idx="${o++}">
        <span class="omni-item-icon">\u{1F3A4}</span>
        <div class="omni-item-body">
          <span class="omni-item-title">${z(m(r),l)}</span>
          <span class="omni-item-meta">${p}\u66F2 \xB7 \u30A2\u30FC\u30C6\u30A3\u30B9\u30C8\u7D5E\u308A\u8FBC\u307F</span>
        </div>
      </div>`}}if(s.length){let r=s.filter(p=>A(p.title).includes(l)||p.songs?.some(f=>A(f.title).includes(l)||A(f.artist).includes(l))).slice(0,5);if(r.length){n+=G("\u{1F4C5} \u914D\u4FE1\u67A0");for(let p of r){E.push({type:"stream",stream:p});let f=p.channel==="new"?"\u65B0ch":p.channel==="old"?"\u65E7ch":"";n+=`<div class="omni-item" role="option" aria-selected="false" data-omni-idx="${o++}">
          <span class="omni-item-icon">\u{1F4C5}</span>
          <div class="omni-item-body">
            <span class="omni-item-title">${z(m(p.title||"\u914D\u4FE1"),l)}</span>
  ...
  `)}function ae(t){if(c.channelData?.fullLoaded)return;c.channelData=t;let e=x(c.channel)?c.channel:Y,a=x(e);a&&(c.data=a),!Bt(c.activeTab)&&c.data&&I(c.activeTab,{autoLoad:!1})}function se(t){c.channelData=t,c.channelData.fullLoaded=!0;let e=x(c.channel)?c.channel:Y;et(e,{resetSearch:!1,updateUrl:!1,render:!1}),I(c.activeTab,{autoLoad:!1})}function Yt(){return N=kt({meta:c.channelData,onSongsReady:ae}).then(se).finally(()=>{N=null}),N}async function ne(){c.channelData?.fullLoaded||(N||Yt(),await N)}async function I(t=c.activeTab,e={}){if(t!=="playlists"&&(!c.data||!W(t))||!W(t))return;let a=c.channelData?.partialLoaded||c.channelData?.fullLoaded,s=c.channelData?.fullLoaded;if(t==="playlists"?!1:Bt(t)?!s:!a)if(e.autoLoad){ee(t);try{await ne()}catch(o){console.error("[data] full load failed",o);let d=i(`#panel-${t}`);d&&(d.innerHTML=`
            <div class="state-card">
          ...
          `,d.querySelector("[data-load-full-data]")?.addEventListener("click",()=>{I(t,{autoLoad:!0})}));return}}else{te(t,{initial:e.initial});return}let n=++Dt;try{let o=await Wt(t);if(n!==Dt||t!==c.activeTab||!c.data)return;t==="songs"&&$t(c.data.songs||[]),o()}catch(o){console.error(`[${t}] render failed`,o);let d=i(`#panel-${t}`);d&&(d.innerHTML=`
        <div class="state-card">
          <div class="msg">\u8868\u793A\u306B\u5931\u6557\u3057\u307E\u3057\u305F</div>
          <div class="err-detail">${m(o?.message||String(o))}</div>
        </div>
      `)}}function C(t,e={}){W(t)||(t="dashboard"),c.activeTab=t,Rt(t),e.updateUrl!==!1&&V({tab:t}),I(t,{autoLoad:e.autoLoad!==!1,initial:!!e.initial})}function Rt(t){w(".tab-btn").forEach(e=>e.classList.toggle("active",e.dataset.tab===t)),w(".panel").forEach(e=>e.classList.toggle("active",e.id===`panel-${t}`))}function x(t){return c.channelData?t==="all"?c.channelData.combined:c.channelData.channels[t]||null:null}function et(t,e={}){let a=x(t);a&&(c.channel=t,De(t),c.data=a,c.timelineFilter=null,c.timelineFocus=null,c.timelineLimit=12,c.songsLimit=100,e.resetSearch!==!1&&(c.songsQuery="",c.songsGenre="all"),nt(),w("#channel-switch [data-channel]").forEach(s=>s.classList.toggle("active",s.dataset.channel===t)),rt(),e.updateUrl!==!1&&V({tab:c.activeTab,channel:t,q:c.songsQuery}),Ce(),e.render!==!1&&I(c.activeTab,{autoLoad:e.autoLoad!==!1,initial:!!e.initial}))}function ie(t,e={}){c.audience=t==="singer"?"singer":"listener",c.singerMode=c.audience==="singer",c.singerMode||(c.singerPreset="all"),w(".audience-switch [data-audience]").forEach(a=>{a.classList.toggle("active",a.dataset.audience===c.audience)}),document.body.dataset.audience=c.audience,rt(),c.audience==="singer"?(c.songsLimit=100,C("songs",{autoLoad:e.autoLoad!==!1})):c.data&&I(c.activeTab,{autoLoad:e.autoLoad!==!1,initial:!!e.initial})}function rt(){let t=i("#mobile-menu-label");if(!t)return;let e=i("#channel-switch [data-channel].active")?.textContent?.trim()||"\u65B0ch",a=i("#audience-switch [data-audience].active")?.textContent?.trim()||"\u30EA\u30B9\u30CA\u30FC";t.textContent=`${e} / ${a}`}function le(){let t=i("#mobile-menu-toggle"),e=i("#mobile-menu-state"),a=i("#topbar-actions");if(!t||!e||!a)return;let s=n=>{e.checked=n,a.classList.toggle("is-open",n),t.setAttribute("aria-expanded",String(n))},l=()=>{s(!1),t.focus()};t.addEventListener("click",n=>{n.stopPropagation(),requestAnimationFrame(()=>s(e.checked))}),t.addEventListener("keydown",n=>{n.key!=="Enter"&&n.key!==" "||(n.preventDefault(),s(!e.checked))}),e.addEventListener("change",()=>{s(e.checked)}),document.addEventListener("click",n=>{a.classList.contains("is-open")&&(n.target.closest("#topbar-actions")||n.target.closest("#mobile-menu-toggle")||n.target.closest("#mobile-menu-state")||l())}),document.addEventListener("keydown",n=>{n.key==="Escape"&&l()}),a.addEventListener("click",n=>{n.stopPropagation()}),rt()}function oe(){let t=i("#page-top-toast");if(!t)return;let e=t.querySelector("img[data-src]"),a=!1,s=420,l=()=>{!e||e.src||(e.src=e.dataset.src||"")},n=()=>{a=!1;let d=window.scrollY>s;d&&l(),t.hidden=!d,t.classList.toggle("is-visible",d),t.setAttribute("aria-hidden",String(!d)),t.tabIndex=d?0:-1},o=()=>{a||(a=!0,requestAnimationFrame(n))};t.hidden=!0,t.setAttribute("aria-hidden","true"),t.tabIndex=-1,t.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})}),window.addEventListener("scroll",o,{passive:!0}),n()}function ce(){if(c.channelData)for(let t of w("#channel-switch [data-channel]")){let e=t.dataset.channel,a=e==="all"?!!c.channelData.combined:!!(c.channelData.channels&&c.channelData.channels[e]);t.disabled=!a,a?t.removeAttribute("title"):t.title="\u30C7\u30FC\u30BF\u3092\u53D6\u5F97\u3067\u304D\u307E\u305B\u3093\u3067\u3057\u305F"}}function re({key:t,title:e,artist:a}){c.timelineFilter&&c.timelineFilter.key===t&&c.activeTab==="timeline"?c.timelineFilter=null:c.timelineFilter={key:t,title:e,artist:a},c.timelineFocus=null,c.timelineLimit=12,C("timeline"),i("#panel-timeline").scrollIntoView({behavior:"smooth",block:"start"})}function de(t,e){c.timelineFilter={key:t.key,title:t.title,artist:t.artist},c.timelineFocus=D(e),c.timelineLimit=9999,C("timeline"),i("#panel-timeline").scrollIntoView({behavior:"smooth",block:"start"})}function ue(t){dt(t.artist||"")}function dt(t){let e=String(t||"").replace(/"/g,"");c.songsQuery=e?`artist:"${e}"`:"",c.songsLimit=100,V({tab:"songs",q:c.songsQuery}),C("songs",{updateUrl:!1})}function Z(t){return(c.data?.songs||[]).find(e=>e.key===t)||null}function H(t){let e=String(t||""),a=[/youtu\.be\/([A-Za-z0-9_-]{11})/,/youtube\.com\/watch\?[^#]*v=([A-Za-z0-9_-]{11})/,/youtube\.com\/live\/([A-Za-z0-9_-]{11})/,/youtube\.com\/shorts\/([A-Za-z0-9_-]{11})/,/youtube\.com\/embed\/([A-Za-z0-9_-]{11})/];for(let s of a){let l=e.match(s);if(l)return l[1]}return""}function ut(t){let e=H(t);return e?`https://i.ytimg.com/vi/${e}/hqdefault.jpg`:""}function pe(t){let e=H(t);return e?`https://i.ytimg.com/vi/${e}/mqdefault.jpg`:""}function ve(t){let e=H(t);return e?`https://i.ytimg.com/vi/${e}/default.jpg`:""}function Ut(){X&&(clearInterval(X),X=null)}function me(){Ut(),X=setInterval(()=>{if(y)try{let t=y.getDuration?.()||0,e=y.getCurrentTime?.()||0,a=t>0?Math.min(e/t*100,100):0,s=i("#yt-mini-progress-fill");s&&(s.style.width=`${a}%`);let n=y.getPlayerState?.()===window.YT?.PlayerState?.PLAYING,o=i("#yt-mini-play");o&&o.setAttribute("data-playing",n?"1":"0")}catch{}},400)}function pt(){if(Ut(),y){try{y.destroy()}catch{}y=null}let t=i("#yt-player-container");t&&(t.innerHTML="")}function fe(){if(y?.getCurrentTime)try{return y.getCurrentTime()}catch{}return Math.max(0,ct+(Date.now()-Gt)/1e3)}function K(t,e=0,a=""){let s=H(t);if(!s)return;if(window.matchMedia("(max-width: 600px)").matches){window.open(String(t||""),"_blank","noopener");return}Ot(),jt();let l=i("#yt-player-container"),n=i("#yt-player-panel");if(!l||!n)return;pt();let o=i("#yt-mini-title");o&&(o.textContent=a||"\u30A4\u30F3\u30E9\u30A4\u30F3\u518D\u751F");let d=i("#yt-mini-hint");d&&(d.textContent=M?"\u25B2 \u30BF\u30C3\u30D7\u3057\u3066\u914D\u4FE1\u30D3\u30E5\u30FC\u30EF\u30FC\u3078\u623B\u308B":""),n.classList.toggle("has-stream",!!M),n.hidden=!1,Vt(()=>{let v=document.createElement("div");l.appendChild(v);try{y=new window.YT.Player(v,{videoId:s,width:"100%",height:"100%",playerVars:{autoplay:1,playsinline:1,rel:0,controls:0,disablekb:1,modestbranding:1,...e>0?{start:Math.floor(e)}:{}},events:{onReady:u=>{if(e>5)try{u.target.seekTo(e,!0)}catch{}me()},onStateChange:u=>{let r=u.data===window.YT.PlayerState.PLAYING,p=i("#yt-mini-play");p&&p.setAttribute("data-playing",r?"1":"0")}}})}catch{let r=e>0?`&start=${Math.floor(e)}`:"";l.innerHTML=`<iframe src="https://www.youtube.com/embed/${s}?autoplay=1&playsinline=1${r}" frameborder="0" allowfullscreen allow="autoplay; encrypted-media; picture-in-picture"></iframe>`}})}function jt(){if(i("#yt-player-panel"))return;let t=document.createElement("div");t.id="yt-player-panel",t.hidden=!0,t.innerHTML=`
  ...
  `,document.body.appendChild(t),i("#yt-player-close").addEventListener("click",()=>{t.hidden=!0,pt(),M=null}),i("#yt-mini-play").addEventListener("click",()=>{if(y)try{y.getPlayerState?.()===window.YT?.PlayerState?.PLAYING?y.pauseVideo():y.playVideo()}catch{}}),i("#yt-mini-restore").addEventListener("click",()=>{M&&q(M,fe())}),i("#yt-mini-progress-bar").addEventListener("click",e=>{if(!y)return;let s=e.currentTarget.getBoundingClientRect(),l=Math.max(0,Math.min(1,(e.clientX-s.left)/s.width));try{let n=y.getDuration?.()||0;n>0&&y.seekTo(l*n,!0)}catch{}})}var Ft=!1,Kt=[];window.onYouTubeIframeAPIReady=()=>{Ft=!0,Kt.splice(0).forEach(t=>t())};function Ot(){if(document.getElementById("yt-iframe-api-script"))return;let t=document.createElement("script");t.id="yt-iframe-api-script",t.src="https://www.youtube.com/iframe_api",document.head.appendChild(t)}function Vt(t){if(Ft&&window.YT?.Player){t();return}Kt.push(t)}var k=null,U=0,M=null,ct=0,Gt=0,_=!1,vt="timeline",S={},j=!1,y=null,X=null;function he(){vt=c.activeTab||"timeline",c.activeTab="player",w(".tab-btn").forEach(t=>t.classList.remove("active")),w(".panel").forEach(t=>t.classList.toggle("active",t.id==="panel-player"))}function be(){C(vt||"timeline")}function ye(){_=!0;let t=i("#stream-viewer");if(!t)return;document.body.appendChild(t),t.classList.add("sv-fullscreen"),document.body.style.overflow="hidden";let e=i("#sv-close");e&&(e.title="\u901A\u5E38\u8868\u793A\u306B\u623B\u308B\uFF08Esc\uFF09");let a=i("#sv-fullscreen-btn");a&&a.setAttribute("aria-pressed","true")}function T(t){let e=Math.floor(t),a=Math.floor(e/3600),s=Math.floor(e%3600/60),l=e%60;return a>0?`${a}:${String(s).padStart(2,"0")}:${String(l).padStart(2,"0")}`:`${s}:${String(l).padStart(2,"0")}`}function zt(t){return`kanau-ts-${t.channel||""}-${t.index||""}`}function O(t){try{return JSON.parse(localStorage.getItem(zt(t))||"null")||{}}catch{return{}}}function ot(t,e){try{localStorage.setItem(zt(t),JSON.stringify(e))}catch{}}function ge(t,e,a){let s=a[e],l=s!=null?`<button class="sv-ts-badge" data-idx="${e}" data-action="seek" title="${m(T(s))} \u306B\u79FB\u52D5">${m(T(s))}</button><button class="sv-ts-del" data-idx="${e}" data-action="del-ts" aria-label="\u30BF\u30A4\u30E0\u30B9\u30BF\u30F3\u30D7\u524A\u9664">\u2715</button>`:"",o=(S[e]||[]).map(u=>`<button class="sv-cts-badge" data-idx="${e}" data-action="cts-seek" data-cts-seconds="${u.timeSeconds}" title="\u307F\u3093\u306A\u306E\u30BF\u30A4\u30E0\u30B9\u30BF\u30F3\u30D7: ${m(T(u.timeSeconds))}">${m(T(u.timeSeconds))}</button>`).join(""),d=`<button class="sv-cts-propose" data-idx="${e}" data-action="cts-propose" type="button">+ \u63D0\u6848</button>`,v=`<div class="sv-cts-row">${o}${d}</div>`;return`<div class="sv-song" data-idx="${e}">
    ...
    ${v}
  </div>`}async function ke(t){if(S={},!t?.channel||t?.index==null)return;try{let s=`/api/timestamps/${encodeURIComponent(t.channel)}/${t.index}`,l=await fetch(s);if(!l.ok)return;let n=await l.json();for(let o of n.items||[])S[o.songIndex]||(S[o.songIndex]=[]),S[o.songIndex].push({timeSeconds:o.timeSeconds,note:o.note??null})}catch{}let e=i("#stream-viewer");if(!e||e._currentStream!==t)return;let a=i("#sv-setlist");a&&F(a,t.songs,O(t)),$e(t)}function we(t,e,a){i("#sv-cts-modal")?.remove();let s=k?.getCurrentTime?.()??0,l=T(Math.floor(s)),n=document.createElement("div");n.id="sv-cts-modal",n.className="sv-cts-modal-overlay",n.innerHTML=`
  ...
  `,document.body.appendChild(o);let d=()=>o.remove();o.querySelector(".sv-cts-modal-close").addEventListener("click",d),o.querySelector(".sv-cts-modal-cancel").addEventListener("click",d),o.addEventListener("click",v=>{v.target===o&&d()}),o.querySelector(".sv-bulk-rows").addEventListener("click",v=>{let u=v.target.closest("[data-bulk-now]");if(!u)return;let r=parseInt(u.dataset.bulkNow,10),p=k?.getCurrentTime?.();if(p!=null){let f=o.querySelector(`[data-bulk-ts-idx="${r}"]`);f&&(f.value=T(Math.floor(p)))}}),o.querySelector("#sv-bulk-submit").addEventListener("click",async()=>{let v=o.querySelector("#sv-bulk-note").value.trim()||null,u=o.querySelector("#sv-bulk-status"),r=o.querySelector("#sv-bulk-submit"),p=[];if(o.querySelectorAll("[data-bulk-ts-idx]").forEach(h=>{let $=parseInt(h.dataset.bulkTsIdx,10),B=mt(h.value.trim());B!==null&&p.push({songIndex:$,timeSeconds:B})}),!p.length){u.textContent="\u30BF\u30A4\u30E0\u30B9\u30BF\u30F3\u30D7\u304C1\u3064\u3082\u5165\u529B\u3055\u308C\u3066\u3044\u307E\u305B\u3093",u.className="sv-cts-modal-status error",u.hidden=!1;return}r.disabled=!0,r.textContent=`\u7533\u8ACB\u4E2D\u2026 (0/${p.length})`,u.hidden=!0;let f=0,b=0;await Promise.all(p.map(async h=>{try{(await fetch(`/api/timestamps/${encodeURIComponent(t.channel)}/${t.index}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({songIndex:h.songIndex,timeSeconds:h.timeSeconds,submitterNote:v})})).ok?f++:b++}catch{b++}r.textContent=`\u7533\u8ACB\u4E2D\u2026 (${f+b}/${p.length})`})),b===0?(u.textContent=`${f}\u66F2\u5206\u306E\u30BF\u30A4\u30E0\u30B9\u30BF\u30F3\u30D7\u3092\u7533\u8ACB\u3057\u307E\u3057\u305F\uFF01\u5BE9\u67FB\u5F8C\u306B\u516C\u958B\u3055\u308C\u307E\u3059\u3002`,u.className="sv-cts-modal-status success",r.hidden=!0,o.querySelector(".sv-cts-modal-cancel").textContent="\u9589\u3058\u308B"):(u.textContent=`${f}\u4EF6\u6210\u529F / ${b}\u4EF6\u5931\u6557\u3002\u5931\u6557\u5206\u3092\u518D\u8A66\u884C\u3057\u3066\u304F\u3060\u3055\u3044\u3002`,u.className="sv-cts-modal-status error",r.disabled=!1,r.textContent="\u4E00\u62EC\u7533\u8ACB\u3059\u308B"),u.hidden=!1}),document.addEventListener("keydown",function v(u){u.key==="Escape"&&(d(),document.removeEventListener("keydown",v))})}function Qt(){try{return JSON.parse(localStorage.getItem("kanau-playlists")||"null")||[]}catch{return[]}}function Se(t){try{localStorage.setItem("kanau-playlists",JSON.stringify(t))}catch{}}function Ee(t,e){let a=Qt(),s=a.find(l=>String(l.id)===String(t));return s?(s.streams||(s.streams=[]),s.streams.includes(e)||(s.streams.push(e),Se(a)),!0):!1}function Te(){let t=c.data?.streams||[],a=i("#stream-viewer")?._currentStream;if(!a)return;let s=t.findIndex(l=>l.channel===a.channel&&l.index===a.index);s<0||s>=t.length-1||q(t[s+1])}function At(t,e){if(!t)return`<div class="sv-bp-nav-card sv-bp-nav-empty">${m(e==="newer"?"\u6700\u65B0\u914D\u4FE1":"\u6700\u521D\u306E\u914D\u4FE1")}</div>`;let a=ut(t.url),s=e==="newer"?"\u65B0\u3057\u3044\u914D\u4FE1 \u2192":"\u2190 \u53E4\u3044\u914D\u4FE1";return`<button class="sv-bp-nav-card" type="button" data-bp-action="open-stream" data-bp-channel="${m(t.channel)}" data-bp-index="${t.index}">
  ...
  </button>`}function xe(t){let e=i("#sv-below-player");if(!e)return;let a=c.data?.streams||[],s=a.findIndex(r=>r.channel===t.channel&&r.index===t.index),l=s>=0&&s<a.length-1?a[s+1]:null,n=s>0?a[s-1]:null,o=new Set(t.songs.map(r=>r.title)),d=a.filter((r,p)=>p!==s).map(r=>{let p=r.songs.filter(f=>o.has(f.title));return{stream:r,overlap:p.length,sharedSongs:p.slice(0,3).map(f=>f.title)}}).filter(r=>r.overlap>0).sort((r,p)=>p.overlap-r.overlap).slice(0,8),v=Qt(),u=D(t);e.innerHTML=`
  ...
  `,e.onchange=r=>{let p=r.target.closest("#sv-ap-check");if(!p)return;j=p.checked;let f=e.querySelector(".sv-bp-ap-switch");f&&f.classList.toggle("sv-bp-ap-switch--on",j)},e.onclick=r=>{let p=r.target.closest("[data-bp-action]");if(!p)return;let f=p.dataset.bpAction;if(f==="open-stream"){let b=p.dataset.bpChannel,h=parseInt(p.dataset.bpIndex,10),$=(c.data?.streams||[]).find(B=>B.channel===b&&B.index===h);$&&q($)}else if(f==="add-pl"){let b=p.dataset.bpPlId;if(Ee(b,u)){p.classList.add("sv-bp-pl-btn--added"),p.disabled=!0;let h=p.querySelector(".sv-bp-pl-status");h&&(h.textContent="\u2713 \u767B\u9332\u6E08\u307F")}}}}function F(t,e,a){t.innerHTML=e.map((s,l)=>ge(s,l,a)).join("")}function mt(t){let e=t.match(/(\d+):(\d{2}):(\d{2})|(\d+):(\d{2})/);return e?e[1]!==void 0?parseInt(e[1])*3600+parseInt(e[2])*60+parseInt(e[3]):parseInt(e[4])*60+parseInt(e[5]):null}function Jt(){if(i("#stream-viewer"))return;let t=i("#panel-player");if(!t)return;let e=document.createElement("div");e.id="stream-viewer",e.hidden=!0,e.setAttribute("aria-label","\u914D\u4FE1\u30D7\u30EC\u30A4\u30E4\u30FC"),e.innerHTML=`
  ...
  `,t.appendChild(e),i("#sv-close").addEventListener("click",tt),i("#sv-fullscreen-btn").addEventListener("click",ye),e.querySelectorAll("[data-bc-tab]").forEach(a=>{a.addEventListener("click",()=>{tt(),C(a.dataset.bcTab)})}),i("#sv-import-toggle").addEventListener("click",()=>{let a=i("#sv-import-area");a&&(a.hidden=!a.hidden,a.hidden||i("#sv-import-input")?.focus())}),i("#sv-import-cancel").addEventListener("click",()=>{let a=i("#sv-import-area");a&&(a.hidden=!0);let s=i("#sv-import-input");s&&(s.value="")}),i("#sv-import-apply").addEventListener("click",()=>{let a=e._currentStream;if(!a)return;let s=i("#sv-import-input");if(!s)return;let n=s.value.split(`
`).map(v=>mt(v)).filter(v=>v!==null);if(!n.length)return;let o=O(a);n.forEach((v,u)=>{u<a.songs.length&&(o[u]=v)}),ot(a,o),F(i("#sv-setlist"),a.songs,o);let d=i("#sv-import-area");d&&(d.hidden=!0),s.value=""}),i("#sv-cts-bulk-btn").addEventListener("click",()=>{let a=e._currentStream;a&&Le(a)}),i("#sv-setlist").addEventListener("click",a=>{let s=a.target.closest("[data-action]");if(!s)return;let l=parseInt(s.dataset.idx,10),n=e._currentStream;if(!n)return;let o=O(n);if(s.dataset.action==="seek"){if(o[l]!=null&&k?.seekTo){k.seekTo(o[l],!0);try{k.playVideo()}catch{}}}else if(s.dataset.action==="set-ts"){let d=k?.getCurrentTime?.();d!=null&&(o[l]=Math.floor(d),ot(n,o),F(i("#sv-setlist"),n.songs,o))}else if(s.dataset.action==="del-ts")delete o[l],ot(n,o),F(i("#sv-setlist"),n.songs,o);else if(s.dataset.action==="cts-seek"){let d=Number(s.dataset.ctsSeconds);if(!isNaN(d)&&k?.seekTo){k.seekTo(d,!0);try{k.playVideo()}catch{}}}else if(s.dataset.action==="cts-propose"){let d=n.songs[l];we(n,l,d?.title||`\u66F2 ${l+1}`)}})}function q(t,e=0){if(!t?.url)return;let a=H(t.url);if(!a){K(t.url);return}Jt(),Ot();let s=i("#yt-player-panel");if(s&&!s.hidden&&(s.hidden=!0,pt()),M=null,_){_=!1;let b=i("#stream-viewer");if(b){b.classList.remove("sv-fullscreen");let h=i("#panel-player");h&&h.appendChild(b)}document.body.style.overflow=""}_=!1,he();let l=i("#stream-viewer");l.classList.remove("sv-fullscreen"),l._currentStream=t;let n=++U,o=i("#sv-bc-title");o&&(o.textContent=t.title||"\u914D\u4FE1");let d=i("#sv-stream-meta");d&&(d.textContent=`${L(t.date)}\u3000\u7B2C${t.index}\u67A0\u3000\u{1F3A4} ${t.songs.length}\u66F2`);let v=i("#sv-yt-link");v&&(v.href=t.url);let u=i("#sv-song-count");u&&(u.textContent=`${t.songs.length}\u66F2`),S={};let r=O(t);F(i("#sv-setlist"),t.songs,r),ke(t),xe(t),l.hidden=!1,document.body.style.overflow="",setTimeout(()=>{i("#sv-close")?.focus({preventScroll:!0})},50),k=null;let p=i("#sv-player-wrap");p.innerHTML='<div class="sv-player-loading">\u8AAD\u307F\u8FBC\u307F\u4E2D\u2026</div>';let f=Math.floor(e);Vt(()=>{if(n!==U||l.hidden)return;p.innerHTML="";let b=document.createElement("div");p.appendChild(b);try{k=new window.YT.Player(b,{videoId:a,width:"100%",height:"100%",playerVars:{autoplay:1,playsinline:1,rel:0,modestbranding:1,...f>0?{start:f}:{}},events:{onReady:h=>{try{h.target.setPlaybackQuality("hd1080")}catch{}try{h.target.setPlaybackQualityRange("hd720","hd1080")}catch{}if(f>5)try{h.target.seekTo(f,!0)}catch{}},onStateChange:h=>{if(n===U){if(h.data===window.YT.PlayerState.PLAYING)try{h.target.setPlaybackQuality("hd1080")}catch{}h.data===window.YT.PlayerState.ENDED&&j&&Te()}},onError:()=>{n===U&&(p.innerHTML=`<iframe src="https://www.youtube.com/embed/${m(a)}?autoplay=1&playsinline=1&rel=0${f>0?`&start=${f}`:""}" allow="autoplay; encrypted-media; picture-in-picture" allowfullscreen></iframe>`)}}})}catch{p.innerHTML=`<iframe src="https://www.youtube.com/embed/${m(a)}?autoplay=1&playsinline=1&rel=0${f>0?`&start=${f}`:""}" allow="autoplay; encrypted-media; picture-in-picture" allowfullscreen></iframe>`}})}function tt(){let t=i("#stream-viewer");if(!t)return;if(_){_=!1,t.classList.remove("sv-fullscreen"),document.body.style.overflow="";let n=i("#panel-player");n&&n.appendChild(t);let o=i("#sv-close");o&&(o.title="\u30DF\u30CB\u30D7\u30EC\u30A4\u30E4\u30FC\u3067\u518D\u751F\u3092\u7D9A\u3051\u306A\u304C\u3089\u623B\u308A\u307E\u3059\uFF08Esc\uFF09");let d=i("#sv-fullscreen-btn");d&&d.setAttribute("aria-pressed","false");return}let e=t._currentStream,a=k?.getCurrentTime?.()??0,s=e?.url?H(e.url):"";++U,t.hidden=!0,t._currentStream=null,k=null;let l=i("#sv-player-wrap");l&&(l.innerHTML=""),document.body.style.overflow="",be(),s&&e?.url&&(M=e,ct=Math.floor(a),Gt=Date.now(),K(e.url,ct,e.title||""))}window.__openStreamViewer=q;function Zt(t){let e=Z(t),a=i("#song-modal"),s=i("#song-modal-body"),l=i("#song-modal-title");if(!e||!a||!s||!l)return;gt(e),l.textContent=e.title;let n=(e.streamRefs||[]).slice(0,8).map(v=>({...v,thumbnail:ut(v.url),thumbnailFallback:pe(v.url),thumbnailTiny:ve(v.url),detailKey:D(v)})),o=[e.genre,...e.seasonTags||[],...e.moodTags||[],...e.singerTags||[]].filter(Boolean),d=at(e.key);s.innerHTML=`
    <div class="song-detail-main">
      <div>
        ...
        <div class="song-detail-tags">${o.map(v=>`<span class="tag-badge">${m(v)}</span>`).join("")}</div>
      </div>
  ...
  `,a.hidden=!1,i("#song-modal-close")?.focus()}function _e(){let t=i("#song-modal"),e=i("#song-modal-close");if(!t||!e)return;let a=()=>{t.hidden=!0};e.addEventListener("click",a),t.addEventListener("click",s=>{s.target===t&&a();let l=s.target.closest("[data-inline-youtube]");if(l){s.preventDefault(),s.stopPropagation(),K(l.dataset.inlineYoutube);return}let n=s.target.closest("[data-detail-action]");if(n){if(s.stopPropagation(),n.dataset.detailAction==="close"&&a(),n.dataset.detailAction==="favorite"){let o=n.dataset.songkey;ht(o);let d=at(o);n.textContent=d?"\u2665 \u304A\u6C17\u306B\u5165\u308A\u89E3\u9664":"\u2661 \u304A\u6C17\u306B\u5165\u308A\u306B\u8FFD\u52A0",n.classList.toggle("primary",d),n.classList.toggle("ghost",!d)}if(n.dataset.detailAction==="timeline"){let o=Z(n.dataset.songkey);a(),o&&re(o)}if(n.dataset.detailAction==="stream"){let o=Z(n.dataset.songkey),d=o?.streamRefs?.find(v=>D(v)===n.dataset.streamkey);a(),o&&d&&de(o,d)}if(n.dataset.detailAction==="artist"){let o=Z(n.dataset.songkey);a(),o&&ue(o)}}}),t.addEventListener("error",s=>{let l=s.target.closest?.(".song-detail-thumb");if(!l)return;let n=l.dataset.fallback||l.dataset.tiny||"";if(n&&l.src!==n){l.src=n,l.dataset.fallback===n?delete l.dataset.fallback:delete l.dataset.tiny;return}l.closest(".song-detail-thumb-link")?.classList.add("thumb-missing")},!0),document.addEventListener("keydown",s=>{s.key==="Escape"&&!t.hidden&&a()})}var Nt=!1;function Ce(){if(!c.data)return;let{stats:t,streams:e=[]}=c.data,a=e[0]?.date||null,s=st(a),l=t.dataGeneratedDate||c.channelData?.dataGeneratedDate||null,n=st(l),o=t.channelLabel||t.channelId||"",d=o?`<span class="badge accent" style="margin-right:8px;">${m(o)}</span>`:"";i("#updated-info").innerHTML=d+`\u30C7\u30FC\u30BF\u66F4\u65B0\u65E5\uFF1A<strong>${L(l)||"\u2014"}</strong>`+(n!=null?` <span class="badge">${n}\u65E5\u524D</span>`:"");let v=i("#stats-grid");if(!Nt)v.innerHTML=`
      <div class="stat-card">

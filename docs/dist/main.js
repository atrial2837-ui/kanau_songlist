import{a as me,b as fe,e as Nt,f as he}from"./chunk-SIADDXVK.js";import{b as ce,c as de,d as ue,i as ve,j as pe,k as j,l as z}from"./chunk-FIQJD23O.js";import{a as lt}from"./chunk-MKJIXTK4.js";import{a as le,b as qt,c as re,e as u}from"./chunk-JT7WCFD3.js";import{E as Vt,F as M,H as W,M as O,N as oe,a as l,b as P,c as f}from"./chunk-T4BEBXYH.js";var _=-1,V=[],Ht=null,G=null,kt=null;function we(t){Ht=t;let e=document.createElement("div");e.id="omni-backdrop",e.hidden=!0,e.setAttribute("role","dialog"),e.setAttribute("aria-modal","true"),e.setAttribute("aria-label","\u30B5\u30A4\u30C8\u5185\u691C\u7D22"),e.innerHTML=`
    <div id="omni-box">
  ...
  `,document.body.appendChild(e),e.addEventListener("click",n=>{n.target===e&&ct()});let s=document.getElementById("omni-input");s.addEventListener("input",()=>Bt(s.value)),s.addEventListener("keydown",Ze),document.getElementById("omni-listbox").addEventListener("click",n=>{let a=n.target.closest("[data-omni-idx]");a&&$e(Number(a.dataset.omniIdx))})}function ke(){let t=document.getElementById("omni-backdrop");if(!t)return;t.hidden=!1,_=-1,V=[];let e=document.getElementById("omni-input");e&&(e.value="",e.focus(),e.select()),Bt(""),es().then(()=>{if(!Rt())return;let s=document.getElementById("omni-input")?.value||"";s.trim()&&Bt(s)})}function ct(){let t=document.getElementById("omni-backdrop");t&&(t.hidden=!0),_=-1}function Rt(){let t=document.getElementById("omni-backdrop");return!!(t&&!t.hidden)}function Ze(t){let e=document.querySelectorAll("#omni-listbox [data-omni-idx]");t.key==="ArrowDown"?(t.preventDefault(),_=Math.min(_+1,e.length-1),be(e)):t.key==="ArrowUp"?(t.preventDefault(),_=Math.max(_-1,-1),be(e)):t.key==="Enter"?(t.preventDefault(),_>=0&&V[_]&&$e(_)):t.key==="Escape"&&(t.preventDefault(),ct())}function be(t){t.forEach((e,s)=>{e.classList.toggle("is-active",s===_),e.setAttribute("aria-selected",String(s===_))}),_>=0&&t[_]?.scrollIntoView({block:"nearest"})}function $e(t){let e=V[t];!e||!Ht||(ct(),Ht(e))}function Bt(t){let e=document.getElementById("omni-listbox");if(!e)return;_=-1,V=[];let s=u.data?.songs||[],n=u.data?.streams||[],a=G||[],i=X(t),r="",c=0;if(!u.data){e.innerHTML='<div class="omni-empty">\u30C7\u30FC\u30BF\u8AAD\u307F\u8FBC\u307F\u4E2D\u2026</div>';return}if(!i){let p=s.slice(0,8);if(p.length){r+=rt("\u{1F3C6} \u3088\u304F\u6B4C\u308F\u308C\u308B\u66F2");for(let m of p)V.push({type:"song",song:m}),r+=ye(m,c++,"")}e.innerHTML=r||'<div class="omni-empty">\u691C\u7D22\u30EF\u30FC\u30C9\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044</div>';return}let o=[];try{o=(pe(t,s).results||[]).slice(0,8)}catch{}if(o.length||(o=s.filter(p=>ge(t,`${p.title} ${p.artist}`)).slice(0,8)),o.length){r+=rt("\u{1F3B5} \u66F2");for(let p of o)V.push({type:"song",song:p}),r+=ye(p,c++,i)}if(a.length){let p=a.filter(m=>ss(m,t)).slice(0,6);if(p.length){r+=rt("\u{1F3AC} \u6B4C\u307F\u305F\u30FB\u30AA\u30EA\u66F2");for(let m of p)V.push({type:"music-video",video:m}),r+=ts(m,c++,t)}}let d=new Set,v=[];for(let p of s)if(p.artist&&ge(t,p.artist)&&!d.has(p.artist)&&(d.add(p.artist),v.push(p.artist),v.length>=4))break;if(v.length){r+=rt("\u{1F3A4} \u30A2\u30FC\u30C6\u30A3\u30B9\u30C8");for(let p of v){let m=s.filter(h=>h.artist===p).length;V.push({type:"artist",artist:p}),r+=`<div class="omni-item" role="option" aria-selected="false" data-omni-idx="${c++}">
  ...
  `)}function rs(t){if(u.channelData?.fullLoaded)return;u.channelData=t;let e=F(u.channel)?u.channel:lt,s=F(e);s&&(u.data=s),!Pe(u.activeTab)&&u.data&&J(u.activeTab,{autoLoad:!1})}function os(t){u.channelData=t,u.channelData.fullLoaded=!0;let e=F(u.channel)?u.channel:lt;It(e,{resetSearch:!1,updateUrl:!1,render:!1}),J(u.activeTab,{autoLoad:!1})}function Ie(){return tt=de({meta:u.channelData,onSongsReady:rs}).then(os).finally(()=>{tt=null}),tt}async function jt(){u.channelData?.fullLoaded||(tt||Ie(),await tt)}async function J(t=u.activeTab,e={}){if(t!=="playlists"&&(!u.data||!Et(t))||!Et(t))return;let s=u.channelData?.partialLoaded||u.channelData?.fullLoaded,n=u.channelData?.fullLoaded;if(t==="playlists"?!1:Pe(t)?!n:!s)if(e.autoLoad){ls(t);try{await jt()}catch(r){console.error("[data] full load failed",r);let c=l(`#panel-${t}`);c&&(c.innerHTML=`
            <div class="state-card">
...
${r}`)}`),r};l("#sv-share-ts-check").addEventListener("change",s),t._rebuild=s,l("#sv-share-url").addEventListener("focus",a=>a.target.select()),l("#sv-share-copy").addEventListener("click",async()=>{let a=l("#sv-share-url")?.value;if(!a)return;let i=!1;try{await navigator.clipboard.writeText(a),i=!0}catch{try{l("#sv-share-url").select(),i=document.execCommand("copy")}catch{}}let r=l("#sv-share-copy");r&&(r.textContent=i?"\u30B3\u30D4\u30FC\u3067\u304D\u307E\u3057\u305F":"\u30B3\u30D4\u30FC\u3067\u304D\u307E\u305B\u3093",r.classList.add("copied"),setTimeout(()=>{r.textContent="\u30EA\u30F3\u30AF\u3092\u30B3\u30D4\u30FC",r.classList.remove("copied")},1600))});let n=l("#sv-share-native");navigator.share&&n&&(n.hidden=!1,n.addEventListener("click",async()=>{let a=t._shareState,i=l("#sv-share-url")?.value;if(i)try{await navigator.share({title:a?.title||"",url:i})}catch{}}))}function xs(){let e=l("#stream-viewer")?._currentStream;if(!e?.url)return;let s=E(e.url);if(!s)return;Ss();let n=l("#sv-share-modal"),a=zt(j().t);n._shareState={id:s,t:a,title:e.title||""};let i=l("#sv-share-video-title");i&&(i.textContent=e.title||"(\u30BF\u30A4\u30C8\u30EB\u306A\u3057)");let r=l("#sv-share-ts-row"),c=l("#sv-share-ts-check"),o=l("#sv-share-ts-label");r&&(r.hidden=a<=5),c&&(c.checked=a>5),o&&(o.textContent=R(a)),n._rebuild?.(),n.hidden=!1}var _e=new URLSearchParams(location.search).get("pl");async function _s(){if(!_e)return;let t=null;try{let n=_e.replace(/-/g,"+").replace(/_/g,"/"),a=Uint8Array.from(atob(n),i=>i.charCodeAt(0));t=JSON.parse(new TextDecoder().decode(a))}catch{return}if(!t||typeof t.n!="string"||!Array.isArray(t.s))return;let e=t.n.slice(0,60)||"\u5171\u6709\u30D7\u30EC\u30A4\u30EA\u30B9\u30C8",s=t.s.filter(n=>typeof n=="string"&&n.length<100).slice(0,300);if(s.length){if(!confirm(`\u5171\u6709\u3055\u308C\u305F\u30D7\u30EC\u30A4\u30EA\u30B9\u30C8\u300C${e}\u300D\uFF08${s.length}\u4EF6\uFF09\u3092\u53D6\u308A\u8FBC\u307F\u307E\u3059\u304B\uFF1F`)){z({},{replace:!0});return}try{let n=await import("./chunk-2FJXAY3H.js"),a=n.createPlaylist(e);for(let i of s)n.addStreamToPlaylist(a.id,i);z({tab:"playlists"},{replace:!0}),D("playlists",{updateUrl:!1})}catch{}}}async function Ts(){let t=j();if(!t.v)return!1;let e=t.v,s=t.t;try{await jt()}catch{}let n=[];u.channelData?.combined&&n.push(u.channelData.combined),Object.values(u.channelData?.channels||{}).forEach(a=>{a&&n.push(a)});for(let a of n){let i=(a.streams||[]).find(r=>E(r.url)===e);if(i)return S(i,s),!0}try{let r=((await(await fetch("data/music.json")).json())?.videos||[]).find(c=>E(c.url)===e);if(r)return S({url:r.url,title:r.title,isMv:!0},s),!0}catch{}return S({url:`https://www.youtube.com/watch?v=${e}`,title:"",isMv:!0},s),!0}function Mt(t,e=0,s=""){let n=E(t);if(!n)return;if(window.matchMedia("(max-width: 600px)").matches){window.open(String(t||""),"_blank","noopener");return}{let o=l("#stream-viewer");if(o&&!o.hidden&&!I)if(U(o))At();else{++N,o.hidden=!0,o._currentStream=null,g=null;let d=l("#sv-player-wrap");d&&(d.innerHTML=""),document.body.style.overflow="",T=null,Ct={},Dt(),q()}}Qt(),Gt();let a=l("#yt-player-container"),i=l("#yt-player-panel");if(!a||!i)return;nt();let r=l("#yt-mini-title");r&&(r.textContent=s||"\u30A4\u30F3\u30E9\u30A4\u30F3\u518D\u751F");let c=l("#yt-mini-hint");c&&(c.textContent=T?"\u25B2 \u30BF\u30C3\u30D7\u3057\u3066\u914D\u4FE1\u30D3\u30E5\u30FC\u30EF\u30FC\u3078\u623B\u308B":""),i.classList.toggle("has-stream",!!T),i.hidden=!1,Ue(()=>{let o=document.createElement("div");a.appendChild(o);try{w=new window.YT.Player(o,{videoId:n,width:"100%",height:"100%",playerVars:{autoplay:1,playsinline:1,rel:0,controls:0,disablekb:1,modestbranding:1,...e>0?{start:Math.floor(e)}:{}},events:{onReady:d=>{let v=Q();try{d.target.setVolume(v)}catch{}if(et(l("#yt-mini-vol-slider"),l("#yt-mini-vol-btn"),null,v),e>5)try{d.target.seekTo(e,!0)}catch{}Ot()},onStateChange:d=>{let v=d.data===window.YT.PlayerState.PLAYING,p=l("#yt-mini-play");p&&p.setAttribute("data-playing",v?"1":"0")}}})}catch{let v=e>0?`&start=${Math.floor(e)}`:"";a.innerHTML=`<iframe src="https://www.youtube.com/embed/${n}?autoplay=1&playsinline=1${v}" frameborder="0" allowfullscreen allow="autoplay; encrypted-media; picture-in-picture"></iframe>`}})}function Gt(){if(l("#yt-player-panel"))return;let t=document.createElement("div");t.id="yt-player-panel",t.hidden=!0,t.innerHTML=`
  ...
  `,document.body.appendChild(i);let r=()=>i.remove();i.querySelector(".sv-cts-modal-close").addEventListener("click",r),i.querySelector(".sv-cts-modal-cancel").addEventListener("click",r),i.addEventListener("click",c=>{c.target===i&&r()}),i.querySelector("#sv-cts-submit").addEventListener("click",async()=>{let c=i.querySelector("#sv-cts-ts-input").value.trim(),o=i.querySelector("#sv-cts-note-input").value.trim()||null,d=ee(c),v=i.querySelector("#sv-cts-status");if(d===null){v.textContent="\u30BF\u30A4\u30E0\u30B9\u30BF\u30F3\u30D7\u306E\u5F62\u5F0F\u304C\u6B63\u3057\u304F\u3042\u308A\u307E\u305B\u3093\uFF08\u4F8B: 1:23 \u307E\u305F\u306F 1:23:45\uFF09",v.className="sv-cts-modal-status error",v.hidden=!1;return}let p=i.querySelector("#sv-cts-submit");p.disabled=!0,p.textContent="\u9001\u4FE1\u4E2D\u2026";try{let m=await fetch(`/api/timestamps/${encodeURIComponent(t.channel)}/${t.index}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({songIndex:e,timeSeconds:d,submitterNote:o})});if(m.ok)v.textContent="\u63D0\u6848\u3092\u9001\u4FE1\u3057\u307E\u3057\u305F\uFF01\u5BE9\u67FB\u5F8C\u306B\u516C\u958B\u3055\u308C\u307E\u3059\u3002",v.className="sv-cts-modal-status success",v.hidden=!1,p.hidden=!0,i.querySelector(".sv-cts-modal-cancel").textContent="\u9589\u3058\u308B";else{let h=await m.json().catch(()=>({}));v.textContent=`\u9001\u4FE1\u306B\u5931\u6557\u3057\u307E\u3057\u305F: ${h.error||m.statusText}`,v.className="sv-cts-modal-status error",v.hidden=!1,p.disabled=!1,p.textContent="\u63D0\u6848\u3059\u308B"}}catch(m){v.textContent=`\u9001\u4FE1\u306B\u5931\u6557\u3057\u307E\u3057\u305F: ${m.message}`,v.className="sv-cts-modal-status error",v.hidden=!1,p.disabled=!1,p.textContent="\u63D0\u6848\u3059\u308B"}}),setTimeout(()=>i.querySelector("#sv-cts-ts-input")?.focus(),50),document.addEventListener("keydown",function c(o){o.key==="Escape"&&(r(),document.removeEventListener("keydown",c))})}function Is(t){let e=l("#sv-cts-bulk-btn");if(!e||!t?.songs?.length)return;let n=Object.keys(A).length>=t.songs.length;e.textContent=n?"\u4FEE\u6B63\u7533\u8ACB":"\u30BB\u30C8\u30EA\u767B\u9332",e.hidden=!1}function As(t){l("#sv-bulk-modal")?.remove();let e=ht(t),a=Object.keys(A).length>=t.songs.length,i=t.songs.map((o,d)=>{let v=e[d]!=null?R(e[d]):"",p=A[d]?.[0]?.timeSeconds!=null?R(A[d][0].timeSeconds):"",m=v||p;return`
...
`).map(m=>m.trim()).filter(Boolean),v=0;for(let m of d){let h=Ys(m);if(!h)continue;let y=js(h.title,h.artist,t.songs);if(y>=0){let b=r.querySelector(`[data-bulk-ts-idx="${y}"]`);b&&(b.value=h.start,v++)}}let p=r.querySelector(".sv-paste-result");p&&(p.textContent=v>0?`${d.length}\u884C\u3092\u89E3\u6790 \u2192 ${v}\u66F2\u306B\u5165\u529B\u3057\u307E\u3057\u305F`:"\u4E00\u81F4\u3059\u308B\u66F2\u304C\u898B\u3064\u304B\u308A\u307E\u305B\u3093\u3067\u3057\u305F",p.hidden=!1)}),r.querySelector(".sv-bulk-rows").addEventListener("click",o=>{let d=o.target.closest("[data-bulk-now]");if(!d)return;let v=parseInt(d.dataset.bulkNow,10),p=g?.getCurrentTime?.();if(p!=null){let m=r.querySelector(`[data-bulk-ts-idx="${v}"]`);m&&(m.value=R(Math.floor(p)))}}),r.querySelector("#sv-bulk-submit").addEventListener("click",async()=>{let o=r.querySelector("#sv-bulk-note").value.trim()||null,d=r.querySelector("#sv-bulk-status"),v=r.querySelector("#sv-bulk-submit"),p=[];if(r.querySelectorAll("[data-bulk-ts-idx]").forEach(y=>{let b=parseInt(y.dataset.bulkTsIdx,10),k=ee(y.value.trim());k!==null&&p.push({songIndex:b,timeSeconds:k})}),!p.length){d.textContent="\u30BF\u30A4\u30E0\u30B9\u30BF\u30F3\u30D7\u304C1\u3064\u3082\u5165\u529B\u3055\u308C\u3066\u3044\u307E\u305B\u3093",d.className="sv-cts-modal-status error",d.hidden=!1;return}v.disabled=!0,v.textContent=`\u7533\u8ACB\u4E2D\u2026 (0/${p.length})`,d.hidden=!0;let m=0,h=0;await Promise.all(p.map(async y=>{try{(await fetch(`/api/timestamps/${encodeURIComponent(t.channel)}/${t.index}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({songIndex:y.songIndex,timeSeconds:y.timeSeconds,submitterNote:o})})).ok?m++:h++}catch{h++}v.textContent=`\u7533\u8ACB\u4E2D\u2026 (${m+h}/${p.length})`})),h===0?(d.textContent=`${m}\u66F2\u5206\u306E\u30BF\u30A4\u30E0\u30B9\u30BF\u30F3\u30D7\u3092\u7533\u8ACB\u3057\u307E\u3057\u305F\uFF01\u5BE9\u67FB\u5F8C\u306B\u516C\u958B\u3055\u308C\u307E\u3059\u3002`,d.className="sv-cts-modal-status success",v.hidden=!0,r.querySelector(".sv-cts-modal-cancel").textContent="\u9589\u3058\u308B"):(d.textContent=`${m}\u4EF6\u6210\u529F / ${h}\u4EF6\u5931\u6557\u3002\u5931\u6557\u5206\u3092\u518D\u8A66\u884C\u3057\u3066\u304F\u3060\u3055\u3044\u3002`,d.className="sv-cts-modal-status error",v.disabled=!1,v.textContent="\u4E00\u62EC\u7533\u8ACB\u3059\u308B"),d.hidden=!1}),document.addEventListener("keydown",function o(d){d.key==="Escape"&&(c(),document.removeEventListener("keydown",o))})}function je(){try{return JSON.parse(localStorage.getItem("kanau-playlists")||"null")||[]}catch{return[]}}function Ds(t){try{localStorage.setItem("kanau-playlists",JSON.stringify(t))}catch{}}function qs(t,e){let s=je(),n=s.find(a=>String(a.id)===String(t));return n?(n.streams||(n.streams=[]),n.streams.includes(e)||(n.streams.push(e),Ds(s)),!0):!1}var Xt="kanauViewerQueueCollapsed",$=null,bt=!1;function Pt(t){let e=$,s=e?.items?.[t];if(s){e.idx=t,bt=!0;try{s.kind==="mv"?S({url:s.video.url,title:s.video.title,isMv:!0}):S(s.stream)}finally{bt=!1}}}window.__playMyListInViewer=t=>{t?.items?.length&&($={name:t.name||"\u30DE\u30A4\u30EA\u30B9\u30C8",items:t.items,idx:0,repeat:localStorage.getItem("kanauListRepeat")==="1",collapsed:localStorage.getItem(Xt)==="1"},Pt(Math.max(0,Math.min(t.idx||0,t.items.length-1))))};window.__openMusicQueueInViewer=(t,e=0,s=0)=>{if(!t?.length)return!1;let n=t.filter(i=>i?.url).map((i,r)=>i._stream?{kind:"stream",key:i._stream.url||`stream:${r}`,stream:i._stream}:{kind:"mv",key:`mv:${E(i.url)||r}`,video:{...i,isMv:!0}});if(!n.length)return!1;$={name:"\u97F3\u697D\u30D7\u30EC\u30A4\u30E4\u30FC\u306E\u30AD\u30E5\u30FC",items:n,idx:Math.max(0,Math.min(e,n.length-1)),repeat:localStorage.getItem("kanauListRepeat")==="1",collapsed:localStorage.getItem(Xt)==="1"};let a=$.items[$.idx];bt=!0;try{a.kind==="mv"?S({...a.video,isMv:!0},s):S(a.stream,s)}finally{bt=!1}return!0};function Zt(){let t=$;if(!t?.items?.length)return"";let e=t.items[t.idx],s=e?.kind==="mv"?e.video?.title||"\u52D5\u753B":e?.stream?.title||"\u914D\u4FE1";return`
  ...
  </button>`}function Bs(t){let e=l("#sv-below-player");if(!e)return;let s=u.data?.streams||[],n=s.findIndex(v=>v.channel===t.channel&&v.index===t.index),a=n>=0&&n<s.length-1?s[n+1]:null,i=n>0?s[n-1]:null,r=new Set(t.songs.map(v=>v.title)),c=s.filter((v,p)=>p!==n).map(v=>{let p=v.songs.filter(m=>r.has(m.title));return{stream:v,overlap:p.length,sharedSongs:p.slice(0,3).map(m=>m.title)}}).filter(v=>v.overlap>0).sort((v,p)=>p.overlap-v.overlap).slice(0,8),o=je(),d=W(t);e.innerHTML=`
    <div class="sv-bp-wrap">
      ...
      <div class="sv-bp-section">
        ...
        <div class="sv-bp-related-list">
          ${c.map(v=>{let p=pt(v.stream.url);return`<button class="sv-bp-rel-card" type="button" data-bp-action="open-stream" data-bp-channel="${f(v.stream.channel)}" data-bp-index="${v.stream.index}">
              ...
              <div class="sv-bp-rel-info">
                ...
                <div class="sv-bp-rel-meta">${M(v.stream.date)}</div>
      ...
      <div class="sv-bp-section">
        ...
        <div class="sv-bp-pl-list" id="sv-bp-pl-list">
          ${o.map(v=>{let p=(v.streams||[]).includes(d);return`<button class="sv-bp-pl-btn${p?" sv-bp-pl-btn--added":""}" type="button"
  ...
  `,e.onchange=v=>{let p=v.target.closest("#sv-ap-check"),m=v.target.closest("#sv-repeat-check");if(p){H=p.checked;let h=p.closest(".sv-bp-ap-switch");h&&h.classList.toggle("sv-bp-ap-switch--on",H)}if(m){B=m.checked;let h=m.closest(".sv-bp-ap-switch");h&&h.classList.toggle("sv-bp-ap-switch--on",B)}},e.onclick=v=>{if(Fe(v))return;let p=v.target.closest("[data-bp-action]");if(!p)return;let m=p.dataset.bpAction;if(m==="open-stream"){let h=p.dataset.bpChannel,y=parseInt(p.dataset.bpIndex,10),b=(u.data?.streams||[]).find(k=>k.channel===h&&k.index===y);b&&S(b)}else if(m==="add-pl"){let h=p.dataset.bpPlId;if(qs(h,d)){p.classList.add("sv-bp-pl-btn--added"),p.disabled=!0;let y=p.querySelector(".sv-bp-pl-status");y&&(y.textContent="\u2713 \u767B\u9332\u6E08\u307F")}}},te(e)}var ut=null;async function Oe(){if(ut)return ut;try{ut=(await(await fetch("data/music.json")).json())?.videos||[]}catch{ut=[]}return ut}function Rs(t){let e=String(t||"");return e=e.replace(/【[^】]*】/g," "),e=e.replace(/^\s*MV[⌇|｜♪♬:：\-\s]*/i," "),e=e.split(/[\/／|｜]/)[0],e=e.replace(/歌ってみた|covered?\s*(by.*)?$/gi," "),e.trim()}async function Us(t){let e=l("#sv-below-player");if(!e)return;try{await jt()}catch{}let s=await Oe();if(l("#stream-viewer")?._currentStream!==t)return;let n=u.channelData?.combined?.streams||u.data?.streams||[],a=Z(Rs(t.title)),i=[];if(a.length>1)for(let m of n){let h=(m.songs||[]).find(y=>{let b=Z(y.title);return b===a||b.length>1&&(b.includes(a)||a.includes(b))});h&&i.push({stream:m,songTitle:h.title})}let r=i.slice(0,8),c={original:"\u30AA\u30EA\u30B8\u30CA\u30EB",office:"Re:AcT",character:"\u30AD\u30E3\u30E9\u30BD\u30F3",cover:"\u30AB\u30D0\u30FC"},o=s.find(m=>m.url===t.url),d=s.filter(m=>m.url!==t.url).sort((m,h)=>{let y=o&&m.type===o.type?1:0,b=o&&h.type===o.type?1:0;return y!==b?b-y:(h.publishedAt||"").localeCompare(m.publishedAt||"")}).slice(0,12),v=s.findIndex(m=>E(m.url)===E(t.url)),p=v>=0&&v<s.length-1?s[v+1]:null;e.innerHTML=`
    <div class="sv-bp-wrap">
      ${Zt()}
      <div class="sv-bp-section sv-bp-section--nav">
        <div class="sv-bp-autoplay-bar">
      ...
      <div class="sv-bp-section">
        ...
        <div class="sv-mv-grid">
          ${d.map(m=>{let h=pt(m.url);return`<button class="sv-mv-card" type="button" data-mv-action="open-mv" data-mv-url="${f(m.url)}" data-mv-title="${f(m.title)}">
...
`).map(v=>ee(v)).filter(v=>v!==null);if(!c.length)return;let o=ht(a);c.forEach((v,p)=>{p<a.songs.length&&(o[p]=v)}),Ut(a,o),vt(l("#sv-setlist"),a.songs,o);let d=l("#sv-import-area");d&&(d.hidden=!0),i.value=""}),l("#sv-cts-bulk-btn").addEventListener("click",()=>{let a=e._currentStream;a&&As(a)}),l("#sv-setlist").addEventListener("click",a=>{let i=a.target.closest("[data-action]");if(!i)return;let r=parseInt(i.dataset.idx,10),c=e._currentStream;if(!c)return;let o=ht(c);if(i.dataset.action==="seek"){if(o[r]!=null&&g?.seekTo){g.seekTo(o[r],!0);try{g.playVideo()}catch{}}}else if(i.dataset.action==="set-ts"){let d=g?.getCurrentTime?.();d!=null&&(o[r]=Math.floor(d),Ut(c,o),vt(l("#sv-setlist"),c.songs,o))}else if(i.dataset.action==="del-ts")delete o[r],Ut(c,o),vt(l("#sv-setlist"),c.songs,o);else if(i.dataset.action==="cts-seek"){let d=Number(i.dataset.ctsSeconds);if(!isNaN(d)&&g?.seekTo){g.seekTo(d,!0);try{g.playVideo()}catch{}}}else if(i.dataset.action==="cts-propose"){let d=c.songs[r];Ps(c,r,d?.title||`\u66F2 ${r+1}`)}})}function S(t,e=0){if(!t?.url)return;let s=E(t.url);if(!s){Mt(t.url);return}ze(),Qt(),st(),bt||($=null);let n=l("#stream-viewer");if(U(n)){if(n._currentStream?.url===t.url){if(!De()&&!window.__restoreMusicExternalPlayer?.()&&qe(),e>0)try{g?.seekTo(Math.floor(e),!0),g?.playVideo()}catch{}return}At()}let a=window.__takeOverMusicPlayerVideo?.(t.url)||null;a||import("./chunk-7Y7QZX3A.js").then(b=>(b.releaseMusicPlayerVideo||b.pauseMusicPlayer)()).catch(()=>{});let i=l("#yt-player-panel");if(i&&!i.hidden){try{w?.pauseVideo()}catch{}i.hidden=!0,nt()}if(T=null,I){I=!1;let b=l("#stream-viewer");b&&b.classList.remove("sv-fullscreen"),document.body.classList.remove("has-sv-fullscreen"),document.body.style.overflow=""}I=!1,Wt();let r=l("#stream-viewer");r.classList.remove("sv-fullscreen"),r.classList.toggle("sv-mv-mode",!!t.isMv),r._currentStream=t;let c=++N,o=r.querySelectorAll("[data-bc-tab]");o[1]&&(t.isMv?(o[1].dataset.bcTab="playlists",o[1].textContent="\u30D7\u30EC\u30A4\u30EA\u30B9\u30C8"):(o[1].dataset.bcTab="timeline",o[1].textContent="\u30BF\u30A4\u30E0\u30E9\u30A4\u30F3"));let d=l("#sv-bc-title");d&&(d.textContent=t.title||"\u914D\u4FE1");let v=l("#sv-stream-meta");v&&(v.textContent=t.isMv?"":`${M(t.date)}\u3000\u7B2C${t.index}\u67A0\u3000\u{1F3A4} ${t.songs.length}\u66F2`);let p=l("#sv-yt-link");p&&(p.href=t.url);let m=l("#sv-song-count");if(m&&(m.textContent=t.isMv?"":`${t.songs.length}\u66F2`),A={},t.isMv){let b=l("#sv-setlist");b&&(b.innerHTML="");let k=l("#sv-below-player");k&&(k.innerHTML=""),Us(t)}else{let b=ht(t);vt(l("#sv-setlist"),t.songs,b),Cs(t),Bs(t)}r.hidden=!1,document.body.style.overflow="",q(),setTimeout(()=>{l("#sv-close")?.focus({preventScroll:!0})},50),g=null;let h=l("#sv-player-wrap");h.innerHTML='<div class="sv-player-loading">\u8AAD\u307F\u8FBC\u307F\u4E2D\u2026</div>';let y=Math.floor(e||a?.currentTime||0);if(a?.player){h.innerHTML="",a.iframe?(a.iframe.style.width="100%",a.iframe.style.height="100%",h.appendChild(a.iframe)):h.innerHTML='<div class="sv-player-loading">\u518D\u751F\u3092\u5F15\u304D\u7D99\u304E\u307E\u3057\u305F</div>',g=a.player;try{g.setVolume?.(Q()),y>1&&g.seekTo?.(y,!0),g.playVideo?.()}catch{}et(l("#sv-vol-slider"),l("#sv-vol-btn"),null,Q()),Hs(c,r);return}Ue(()=>{if(c!==N||r.hidden)return;h.innerHTML="";let b=document.createElement("div");h.appendChild(b);try{g=new window.YT.Player(b,{videoId:s,width:"100%",height:"100%",playerVars:{autoplay:1,playsinline:1,rel:0,modestbranding:1,...y>0?{start:y}:{}},events:{onReady:k=>{let K=Q();try{k.target.setVolume(K)}catch{}et(l("#sv-vol-slider"),l("#sv-vol-btn"),null,K);try{k.target.setPlaybackQuality("hd1080")}catch{}try{k.target.setPlaybackQualityRange("hd720","hd1080")}catch{}if(y>5)try{k.target.seekTo(y,!0)}catch{}},onStateChange:k=>{if(c===N){if(k.data===window.YT.PlayerState.PLAYING)try{k.target.setPlaybackQuality("hd1080")}catch{}k.data===window.YT.PlayerState.ENDED&&Ke(r)}},onError:()=>{c===N&&(h.innerHTML=`<iframe src="https://www.youtube.com/embed/${f(s)}?autoplay=1&playsinline=1&rel=0${y>0?`&start=${y}`:""}" allow="autoplay; encrypted-media; picture-in-picture" allowfullscreen></iframe>`)}}})}catch{h.innerHTML=`<iframe src="https://www.youtube.com/embed/${f(s)}?autoplay=1&playsinline=1&rel=0${y>0?`&start=${y}`:""}" allow="autoplay; encrypted-media; picture-in-picture" allowfullscreen></iframe>`}})}function yt(){let t=l("#stream-viewer");if(!t||t.hidden||U(t))return;if(I){I=!1,t.classList.remove("sv-fullscreen"),document.body.classList.remove("has-sv-fullscreen"),document.body.style.overflow="";let s=l("#sv-close");s&&(s.title="\u30DF\u30CB\u30D7\u30EC\u30A4\u30E4\u30FC\u3067\u518D\u751F\u3092\u7D9A\u3051\u306A\u304C\u3089\u623B\u308A\u307E\u3059\uFF08Esc\uFF09");let n=l("#sv-fullscreen-btn");n&&n.setAttribute("aria-pressed","false");return}if(gs())return;++N,t.hidden=!0,t._currentStream=null,st(),g=null;let e=l("#sv-player-wrap");e&&(e.innerHTML=""),document.body.style.overflow="",Dt(),q()}window.__openStreamViewer=S;window.__closeStreamMiniPlayer=()=>{let t=l("#stream-viewer");if(U(t))return At(),!0;let e=l("#yt-player-panel");return e&&!e.hidden?(e.hidden=!0,nt(),T=null,!0):!1};function Fs(t){let e=t.streamRefs||[];if(e.length<=1)return"";let s=new Map;for(let x of e){if(!x.date)continue;let at=x.date instanceof Date?x.date:new Date(x.date);if(isNaN(at))continue;let it=`${at.getFullYear()}-${String(at.getMonth()+1).padStart(2,"0")}`;s.set(it,(s.get(it)||0)+1)}if(!s.size)return"";let n=[...s.keys()].sort(),a=n[n.length-1],[i,r]=a.split("-").map(Number),c=new Date(i,r-19,1),o=n[0],[d,v]=o.split("-").map(Number),p=new Date(d,v-1,1)<c?c:new Date(d,v-1,1),m=`${p.getFullYear()}-${String(p.getMonth()+1).padStart(2,"0")}`,h=[],y=new Date(p),b=new Date(i,r-1,1);for(;y<=b;){let x=`${y.getFullYear()}-${String(y.getMonth()+1).padStart(2,"0")}`;h.push({k:x,count:s.get(x)||0}),y=new Date(y.getFullYear(),y.getMonth()+1,1)}if(h.length<2)return"";let k=Math.max(1,...h.map(x=>x.count)),K=300,C=40,Y=Math.max(3,Math.floor(K/h.length)-1),ne=Math.max(1,Math.floor(K/h.length)-Y),Qe=h.length*(Y+ne),Je=h.map((x,at)=>{let it=x.count>0?Math.max(4,Math.round(x.count/k*(C-4))):0,ae=at*(Y+ne),We=C-it,Xe=x.count>0?1:0,ie=`${x.k} (${x.count}\u56DE)`;return x.count>0?`<rect x="${ae}" y="${We}" width="${Y}" height="${it}" fill="var(--primary)" opacity="${Xe}" rx="1"><title>${f(ie)}</title></rect>`:`<rect x="${ae}" y="${C-2}" width="${Y}" height="2" fill="var(--border)" opacity="0.5" rx="1"><title>${f(ie)}</title></rect>`}).join("");return`
  ...
  `,s.hidden=!1,l("#song-modal-close")?.focus()}function Ks(){let t=l("#song-modal"),e=l("#song-modal-close");if(!t||!e)return;let s=()=>{t.hidden=!0};e.addEventListener("click",s),t.addEventListener("click",n=>{n.target===t&&s();let a=n.target.closest("[data-inline-youtube]");if(a){n.preventDefault(),n.stopPropagation(),Mt(a.dataset.inlineYoutube);return}let i=n.target.closest("[data-detail-action]");if(i){if(n.stopPropagation(),i.dataset.detailAction==="close"&&s(),i.dataset.detailAction==="favorite"){let r=i.dataset.songkey;le(r);let c=qt(r);i.textContent=c?"\u2665 \u304A\u6C17\u306B\u5165\u308A\u89E3\u9664":"\u2661 \u304A\u6C17\u306B\u5165\u308A\u306B\u8FFD\u52A0",i.classList.toggle("primary",c),i.classList.toggle("ghost",!c)}if(i.dataset.detailAction==="timeline"){let r=xt(i.dataset.songkey);s(),r&&ps(r)}if(i.dataset.detailAction==="stream"){let r=xt(i.dataset.songkey),c=r?.streamRefs?.find(o=>W(o)===i.dataset.streamkey);s(),r&&c&&ms(r,c)}if(i.dataset.detailAction==="artist"){let r=xt(i.dataset.songkey);s(),r&&fs(r)}}}),t.addEventListener("error",n=>{let a=n.target.closest?.(".song-detail-thumb");if(!a)return;let i=a.dataset.fallback||a.dataset.tiny||"";if(i&&a.src!==i){a.src=i,a.dataset.fallback===i?delete a.dataset.fallback:delete a.dataset.tiny;return}a.closest(".song-detail-thumb-link")?.classList.add("thumb-missing")},!0),document.addEventListener("keydown",n=>{n.key==="Escape"&&!t.hidden&&s()})}var Ee=!1;function Os(){if(!u.data)return;let{stats:t,streams:e=[]}=u.data,s=e[0]?.date||null,n=Vt(s),a=t.dataGeneratedDate||u.channelData?.dataGeneratedDate||null,i=Vt(a),r=t.channelLabel||t.channelId||"",c=r?`<span class="badge accent" style="margin-right:8px;">${f(r)}</span>`:"";l("#updated-info").innerHTML=c+`\u30C7\u30FC\u30BF\u66F4\u65B0\u65E5\uFF1A<strong>${M(a)||"\u2014"}</strong>`+(i!=null?` <span class="badge">${i}\u65E5\u524D</span>`:"");let o=l("#stats-grid");if(!Ee)o.innerHTML=`
    ...
    `,Ee=!0;else{let d=o.querySelectorAll(".stat-value");d.length>=6&&(d[0].textContent=O(t.total),d[0].innerHTML+='<span class="stat-unit">\u56DE</span>',d[1].textContent=O(t.repertoire),d[1].innerHTML+='<span class="stat-unit">\u66F2</span>',d[2].textContent=O(t.streams),d[2].innerHTML+='<span class="stat-unit">\u56DE</span>',d[3].textContent=t.avgPerStream,d[3].innerHTML+='<span class="stat-unit">\u66F2</span>',d[4].textContent=n??"\u2014",d[4].innerHTML+='<span class="stat-unit">\u65E5</span>',d[5].textContent=Me(u.data),d[5].innerHTML+='<span class="stat-unit">\u65E5</span>')}}function Me(t){if(!t.streams?.length)return"\u2014";let e=t.streams[t.streams.length-1].date,s=t.streams[0].date;return Math.floor((s-e)/864e5)+1}function zs(){l("#loading").hidden=!1,l("#error").hidden=!0}function Gs(){l("#loading").hidden=!0}function Qs(t){let e=l("#loading"),s=l("#error"),n=l("#err-detail");e&&(e.hidden=!0),s&&(s.hidden=!1),n&&(n.textContent=t&&t.message?t.message:String(t))}function Js(t){let e=document.getElementById("page-title");if(!e)return;t==="new"?(e.innerHTML='<img class="hero-title-icon" src="assets/site-icon.svg" alt="" width="32" height="32" fetchpriority="high" decoding="sync">\u5922\u5DDD\u304B\u306A\u3046 \u65B0ch \u6B4C\u5531\u30C7\u30FC\u30BF\u30D9\u30FC\u30B9',document.title="\u5922\u5DDD\u304B\u306A\u3046 \u65B0ch \u6B4C\u5531\u30C7\u30FC\u30BF\u30D9\u30FC\u30B9"):t==="old"?(e.innerHTML='<img class="hero-title-icon" src="assets/site-icon.svg" alt="" width="32" height="32" fetchpriority="high" decoding="sync">\u5922\u5DDD\u304B\u306A\u3046 \u65E7ch \u6B4C\u5531\u30C7\u30FC\u30BF\u30D9\u30FC\u30B9',document.title="\u5922\u5DDD\u304B\u306A\u3046 \u65E7ch \u6B4C\u5531\u30C7\u30FC\u30BF\u30D9\u30FC\u30B9"):(e.innerHTML='<img class="hero-title-icon" src="assets/site-icon.svg" alt="" width="32" height="32" fetchpriority="high" decoding="sync">\u5922\u5DDD\u304B\u306A\u3046 \u6B4C\u5531\u30C7\u30FC\u30BF\u30D9\u30FC\u30B9',document.title="\u5922\u5DDD\u304B\u306A\u3046 \u6B4C\u5531\u30C7\u30FC\u30BF\u30D9\u30FC\u30B9");let s=document.getElementById("hero-ch-bg");s&&(s.dataset.mode=t||"all")}var Ws={new:{name:"\u5922\u5DDD\u304B\u306A\u3046 - Kanau Yumekawa",handle:"@YumekawaKanau",url:"https://www.youtube.com/@YumekawaKanau",label:"\u65B0ch",desc:`Re:AcT\u6240\u5C5E\u306E\u6D77\u306E\u304A\u59EB\u3055\u307E\u306B\u306A\u308A\u305F\u3044\u3001\u6CE1\u6CAB\u305F\u3086\u305F\u3046Vsinger \u{1F41F}
\u5922\u5DDD\u304B\u306A\u3046\u3058\u3083\u3088\u3001\u3061\u3087\u3063\u3068\u4F11\u61A9\u3057\u3066\u3044\u3053\u301C

import{b as yt,c as gt,d as wt,i as kt,k as st,l as R}from"./chunk-DSNH5IKV.js";import{a as $t,b as Lt,e as nt,f as St}from"./chunk-SIADDXVK.js";import{a as B}from"./chunk-MKJIXTK4.js";import{I as at,J as $,L as P,Q as x,R as bt,a as ft,b as et,c as ht,e as o,f as i,g as k,i as u}from"./chunk-6YA3HG5E.js";var y=-1,L=[],it=null;function xt(t){it=t;let e=document.createElement("div");e.id="omni-backdrop",e.hidden=!0,e.setAttribute("role","dialog"),e.setAttribute("aria-modal","true"),e.setAttribute("aria-label","\u30B5\u30A4\u30C8\u5185\u691C\u7D22"),e.innerHTML=`
  ...
  `,document.body.appendChild(e),e.addEventListener("click",n=>{n.target===e&&Y()});let a=document.getElementById("omni-input");a.addEventListener("input",()=>Ct(a.value)),a.addEventListener("keydown",Xt),document.getElementById("omni-listbox").addEventListener("click",n=>{let l=n.target.closest("[data-omni-idx]");l&&Pt(Number(l.dataset.omniIdx))})}function _t(){let t=document.getElementById("omni-backdrop");if(!t)return;t.hidden=!1,y=-1,L=[];let e=document.getElementById("omni-input");e&&(e.value="",e.focus(),e.select()),Ct("")}function Y(){let t=document.getElementById("omni-backdrop");t&&(t.hidden=!0),y=-1}function Mt(){let t=document.getElementById("omni-backdrop");return!!(t&&!t.hidden)}function Xt(t){let e=document.querySelectorAll("#omni-listbox [data-omni-idx]");t.key==="ArrowDown"?(t.preventDefault(),y=Math.min(y+1,e.length-1),Tt(e)):t.key==="ArrowUp"?(t.preventDefault(),y=Math.max(y-1,-1),Tt(e)):t.key==="Enter"?(t.preventDefault(),y>=0&&L[y]&&Pt(y)):t.key==="Escape"&&(t.preventDefault(),Y())}function Tt(t){t.forEach((e,a)=>{e.classList.toggle("is-active",a===y),e.setAttribute("aria-selected",String(a===y))}),y>=0&&t[y]?.scrollIntoView({block:"nearest"})}function Pt(t){let e=L[t];!e||!it||(Y(),it(e))}function Ct(t){let e=document.getElementById("omni-listbox");if(!e)return;y=-1,L=[];let a=o.data?.songs||[],n=o.data?.streams||[],l=t.trim().toLowerCase(),s="",r=0;if(!o.data){e.innerHTML='<div class="omni-empty">\u30C7\u30FC\u30BF\u8AAD\u307F\u8FBC\u307F\u4E2D\u2026</div>';return}if(!l){let c=a.slice(0,8);if(c.length){s+=V("\u{1F3C6} \u3088\u304F\u6B4C\u308F\u308C\u308B\u66F2");for(let p of c)L.push({type:"song",song:p}),s+=Et(p,r++,"")}e.innerHTML=s||'<div class="omni-empty">\u691C\u7D22\u30EF\u30FC\u30C9\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044</div>';return}let d=a.filter(c=>C(c.title).includes(l)||C(c.artist).includes(l)).slice(0,8);if(d.length){s+=V("\u{1F3B5} \u66F2");for(let c of d)L.push({type:"song",song:c}),s+=Et(c,r++,l)}let v=new Set,m=[];for(let c of a)if(C(c.artist).includes(l)&&!v.has(c.artist)&&(v.add(c.artist),m.push(c.artist),m.length>=4))break;if(m.length){s+=V("\u{1F3A4} \u30A2\u30FC\u30C6\u30A3\u30B9\u30C8");for(let c of m){let p=a.filter(f=>f.artist===c).length;L.push({type:"artist",artist:c}),s+=`<div class="omni-item" role="option" aria-selected="false" data-omni-idx="${r++}">
      ...
      </div>`}}if(n.length){let c=n.filter(p=>C(p.title).includes(l)||p.songs?.some(f=>C(f.title).includes(l)||C(f.artist).includes(l))).slice(0,5);if(c.length){s+=V("\u{1F4C5} \u914D\u4FE1\u67A0");for(let p of c){L.push({type:"stream",stream:p});let f=p.channel==="new"?"\u65B0ch":p.channel==="old"?"\u65E7ch":"";s+=`<div class="omni-item" role="option" aria-selected="false" data-omni-idx="${r++}">
  ...
  </div>`}function C(t){return String(t||"").toLowerCase()}function O(t,e){if(!e)return t;let n=t.toLowerCase().indexOf(e);return n<0?t:t.slice(0,n)+'<mark class="hl">'+t.slice(n,n+e.length)+"</mark>"+t.slice(n+e.length)}Lt();ht();var Nt={dashboard:()=>import("./chunk-5PGBMNJS.js").then(t=>t.renderDashboard),ranking:()=>import("./chunk-ESHPASDY.js").then(t=>t.renderRanking),songs:()=>import("./chunk-DKUP6YRL.js").then(t=>t.renderSongs),timeline:()=>import("./chunk-5GZHGOGX.js").then(t=>t.renderTimeline),analytics:()=>import("./chunk-3D4M2QCZ.js").then(t=>t.renderAnalytics),playlists:()=>import("./chunk-PWLV57AH.js").then(t=>t.renderPlaylists)},z=new Map,Dt=0,I=null;function Z(t){return Object.prototype.hasOwnProperty.call(Nt,t)}async function Wt(t){z.has(t)||z.set(t,Nt[t]());try{return await z.get(t)}catch(e){throw z.delete(t),e}}function Bt(t){return["dashboard","timeline","analytics"].includes(t)}function te(t,e={}){let a=i(`#panel-${t}`);if(!a)return;let n={dashboard:"\u30C0\u30C3\u30B7\u30E5\u30DC\u30FC\u30C9\u8A73\u7D30",ranking:"\u30E9\u30F3\u30AD\u30F3\u30B0",songs:"\u66F2\u30EA\u30B9\u30C8",timeline:"\u914D\u4FE1\u30BF\u30A4\u30E0\u30E9\u30A4\u30F3",analytics:"\u30A2\u30CA\u30EA\u30C6\u30A3\u30AF\u30B9"};a.innerHTML=`
  ...
  `)}function ae(t){if(o.channelData?.fullLoaded)return;o.channelData=t;let e=S(o.channel)?o.channel:B,a=S(e);a&&(o.data=a),!Bt(o.activeTab)&&o.data&&M(o.activeTab,{autoLoad:!1})}function ne(t){o.channelData=t,o.channelData.fullLoaded=!0;let e=S(o.channel)?o.channel:B;tt(e,{resetSearch:!1,updateUrl:!1,render:!1}),M(o.activeTab,{autoLoad:!1})}function Yt(){return I=gt({meta:o.channelData,onSongsReady:ae}).then(ne).finally(()=>{I=null}),I}async function se(){o.channelData?.fullLoaded||(I||Yt(),await I)}async function M(t=o.activeTab,e={}){if(t!=="playlists"&&(!o.data||!Z(t))||!Z(t))return;let a=o.channelData?.partialLoaded||o.channelData?.fullLoaded,n=o.channelData?.fullLoaded;if(t==="playlists"?!1:Bt(t)?!n:!a)if(e.autoLoad){ee(t);try{await se()}catch(r){console.error("[data] full load failed",r);let d=i(`#panel-${t}`);d&&(d.innerHTML=`
            <div class="state-card">
  ...
  `,document.body.appendChild(t),i("#yt-player-close").addEventListener("click",()=>{t.hidden=!0,ut(),_=null}),i("#yt-mini-play").addEventListener("click",()=>{if(h)try{h.getPlayerState?.()===window.YT?.PlayerState?.PLAYING?h.pauseVideo():h.playVideo()}catch{}}),i("#yt-mini-restore").addEventListener("click",()=>{_&&H(_,fe())}),i("#yt-mini-progress-bar").addEventListener("click",e=>{if(!h)return;let n=e.currentTarget.getBoundingClientRect(),l=Math.max(0,Math.min(1,(e.clientX-n.left)/n.width));try{let s=h.getDuration?.()||0;s>0&&h.seekTo(l*s,!0)}catch{}})}var jt=!1,qt=[];window.onYouTubeIframeAPIReady=()=>{jt=!0,qt.splice(0).forEach(t=>t())};function Rt(){if(document.getElementById("yt-iframe-api-script"))return;let t=document.createElement("script");t.id="yt-iframe-api-script",t.src="https://www.youtube.com/iframe_api",document.head.appendChild(t)}function Vt(t){if(jt&&window.YT?.Player){t();return}qt.push(t)}var w=null,U=0,_=null,ot=0,Ot=0,T=!1,pt="timeline",D={},F=!1,h=null,J=null;function he(){pt=o.activeTab||"timeline",o.activeTab="player",k(".tab-btn").forEach(t=>t.classList.remove("active")),k(".panel").forEach(t=>t.classList.toggle("active",t.id==="panel-player"))}function be(){E(pt||"timeline")}function ye(){T=!0;let t=i("#stream-viewer");if(!t)return;document.body.appendChild(t),t.classList.add("sv-fullscreen"),document.body.style.overflow="hidden";let e=i("#sv-close");e&&(e.title="\u901A\u5E38\u8868\u793A\u306B\u623B\u308B\uFF08Esc\uFF09");let a=i("#sv-fullscreen-btn");a&&a.setAttribute("aria-pressed","true")}function K(t){let e=Math.floor(t),a=Math.floor(e/3600),n=Math.floor(e%3600/60),l=e%60;return a>0?`${a}:${String(n).padStart(2,"0")}:${String(l).padStart(2,"0")}`:`${n}:${String(l).padStart(2,"0")}`}function zt(t){return`kanau-ts-${t.channel||""}-${t.index||""}`}function X(t){try{return JSON.parse(localStorage.getItem(zt(t))||"null")||{}}catch{return{}}}function lt(t,e){try{localStorage.setItem(zt(t),JSON.stringify(e))}catch{}}function ge(t,e,a){let n=a[e],l=n!=null?`<button class="sv-ts-badge" data-idx="${e}" data-action="seek" title="${u(K(n))} \u306B\u79FB\u52D5">${u(K(n))}</button><button class="sv-ts-del" data-idx="${e}" data-action="del-ts" aria-label="\u30BF\u30A4\u30E0\u30B9\u30BF\u30F3\u30D7\u524A\u9664">\u2715</button>`:"",r=(D[e]||[]).map(m=>`<button class="sv-cts-badge" data-idx="${e}" data-action="cts-seek" data-cts-seconds="${m.timeSeconds}" title="\u307F\u3093\u306A\u306E\u30BF\u30A4\u30E0\u30B9\u30BF\u30F3\u30D7: ${u(K(m.timeSeconds))}">${u(K(m.timeSeconds))}</button>`).join(""),d=`<button class="sv-cts-propose" data-idx="${e}" data-action="cts-propose" type="button">+ \u63D0\u6848</button>`,v=`<div class="sv-cts-row">${r}${d}</div>`;return`<div class="sv-song" data-idx="${e}">
    ...
    ${v}
  </div>`}async function we(t){if(D={},!t?.channel||t?.index==null)return;try{let n=`/api/timestamps/${encodeURIComponent(t.channel)}/${t.index}`,l=await fetch(n);if(!l.ok)return;let s=await l.json();for(let r of s.items||[])D[r.songIndex]||(D[r.songIndex]=[]),D[r.songIndex].push({timeSeconds:r.timeSeconds,note:r.note??null})}catch{}let e=i("#stream-viewer");if(!e||e._currentStream!==t)return;let a=i("#sv-setlist");a&&j(a,t.songs,X(t))}function ke(t,e,a){i("#sv-cts-modal")?.remove();let n=w?.getCurrentTime?.()??0,l=K(Math.floor(n)),s=document.createElement("div");s.id="sv-cts-modal",s.className="sv-cts-modal-overlay",s.innerHTML=`
...
`).map(v=>Qt(v)).filter(v=>v!==null);if(!s.length)return;let r=X(a);s.forEach((v,m)=>{m<a.songs.length&&(r[m]=v)}),lt(a,r),j(i("#sv-setlist"),a.songs,r);let d=i("#sv-import-area");d&&(d.hidden=!0),n.value=""}),i("#sv-setlist").addEventListener("click",a=>{let n=a.target.closest("[data-action]");if(!n)return;let l=parseInt(n.dataset.idx,10),s=e._currentStream;if(!s)return;let r=X(s);if(n.dataset.action==="seek"){if(r[l]!=null&&w?.seekTo){w.seekTo(r[l],!0);try{w.playVideo()}catch{}}}else if(n.dataset.action==="set-ts"){let d=w?.getCurrentTime?.();d!=null&&(r[l]=Math.floor(d),lt(s,r),j(i("#sv-setlist"),s.songs,r))}else if(n.dataset.action==="del-ts")delete r[l],lt(s,r),j(i("#sv-setlist"),s.songs,r);else if(n.dataset.action==="cts-seek"){let d=Number(n.dataset.ctsSeconds);if(!isNaN(d)&&w?.seekTo){w.seekTo(d,!0);try{w.playVideo()}catch{}}}else if(n.dataset.action==="cts-propose"){let d=s.songs[l];ke(s,l,d?.title||`\u66F2 ${l+1}`)}})}function H(t,e=0){if(!t?.url)return;let a=A(t.url);if(!a){q(t.url);return}Jt(),Rt();let n=i("#yt-player-panel");if(n&&!n.hidden&&(n.hidden=!0,ut()),_=null,T){T=!1;let g=i("#stream-viewer");if(g){g.classList.remove("sv-fullscreen");let b=i("#panel-player");b&&b.appendChild(g)}document.body.style.overflow=""}T=!1,he();let l=i("#stream-viewer");l.classList.remove("sv-fullscreen"),l._currentStream=t;let s=++U,r=i("#sv-bc-title");r&&(r.textContent=t.title||"\u914D\u4FE1");let d=i("#sv-stream-meta");d&&(d.textContent=`${$(t.date)}\u3000\u7B2C${t.index}\u67A0\u3000\u{1F3A4} ${t.songs.length}\u66F2`);let v=i("#sv-yt-link");v&&(v.href=t.url);let m=i("#sv-song-count");m&&(m.textContent=`${t.songs.length}\u66F2`),D={};let c=X(t);j(i("#sv-setlist"),t.songs,c),we(t),Te(t),l.hidden=!1,document.body.style.overflow="",setTimeout(()=>{i("#sv-close")?.focus({preventScroll:!0})},50),w=null;let p=i("#sv-player-wrap");p.innerHTML='<div class="sv-player-loading">\u8AAD\u307F\u8FBC\u307F\u4E2D\u2026</div>';let f=Math.floor(e);Vt(()=>{if(s!==U||l.hidden)return;p.innerHTML="";let g=document.createElement("div");p.appendChild(g);try{w=new window.YT.Player(g,{videoId:a,width:"100%",height:"100%",playerVars:{autoplay:1,playsinline:1,rel:0,modestbranding:1,...f>0?{start:f}:{}},events:{onReady:b=>{try{b.target.setPlaybackQuality("hd1080")}catch{}try{b.target.setPlaybackQualityRange("hd720","hd1080")}catch{}if(f>5)try{b.target.seekTo(f,!0)}catch{}},onStateChange:b=>{s===U&&b.data===window.YT.PlayerState.ENDED&&F&&Se()},onError:()=>{s===U&&(p.innerHTML=`<iframe src="https://www.youtube.com/embed/${u(a)}?autoplay=1&playsinline=1&rel=0${f>0?`&start=${f}`:""}" allow="autoplay; encrypted-media; picture-in-picture" allowfullscreen></iframe>`)}}})}catch{p.innerHTML=`<iframe src="https://www.youtube.com/embed/${u(a)}?autoplay=1&playsinline=1&rel=0${f>0?`&start=${f}`:""}" allow="autoplay; encrypted-media; picture-in-picture" allowfullscreen></iframe>`}})}function W(){let t=i("#stream-viewer");if(!t)return;if(T){T=!1,t.classList.remove("sv-fullscreen"),document.body.style.overflow="";let s=i("#panel-player");s&&s.appendChild(t);let r=i("#sv-close");r&&(r.title="\u30DF\u30CB\u30D7\u30EC\u30A4\u30E4\u30FC\u3067\u518D\u751F\u3092\u7D9A\u3051\u306A\u304C\u3089\u623B\u308A\u307E\u3059\uFF08Esc\uFF09");let d=i("#sv-fullscreen-btn");d&&d.setAttribute("aria-pressed","false");return}let e=t._currentStream,a=w?.getCurrentTime?.()??0,n=e?.url?A(e.url):"";++U,t.hidden=!0,t._currentStream=null,w=null;let l=i("#sv-player-wrap");l&&(l.innerHTML=""),document.body.style.overflow="",be(),n&&e?.url&&(_=e,ot=Math.floor(a),Ot=Date.now(),q(e.url,ot,e.title||""))}window.__openStreamViewer=H;function Zt(t){let e=Q(t),a=i("#song-modal"),n=i("#song-modal-body"),l=i("#song-modal-title");if(!e||!a||!n||!l)return;yt(e),l.textContent=e.title;let s=(e.streamRefs||[]).slice(0,8).map(v=>({...v,thumbnail:dt(v.url),thumbnailFallback:pe(v.url),thumbnailTiny:ve(v.url),detailKey:P(v)})),r=[e.genre,...e.seasonTags||[],...e.moodTags||[],...e.singerTags||[]].filter(Boolean),d=et(e.key);n.innerHTML=`

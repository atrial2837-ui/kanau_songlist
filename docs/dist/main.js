import{b as ct,c as dt,d as ut,i as pt,k as G,l as F}from"./chunk-4TPCNLDP.js";import{a as mt,b as ft,e as z,f as vt}from"./chunk-SIADDXVK.js";import{a as C}from"./chunk-MKJIXTK4.js";import{I as Q,J as $,L as D,N as S,O as rt,a as lt,b as j,c as ot,e as a,f as i,g,i as u}from"./chunk-5JCHYUC5.js";var v=-1,k=[],Z=null;function yt(t){Z=t;let e=document.createElement("div");e.id="omni-backdrop",e.hidden=!0,e.setAttribute("role","dialog"),e.setAttribute("aria-modal","true"),e.setAttribute("aria-label","\u30B5\u30A4\u30C8\u5185\u691C\u7D22"),e.innerHTML=`
    <div id="omni-box">
  ...
  `,document.body.appendChild(e),e.addEventListener("click",s=>{s.target===e&&I()});let n=document.getElementById("omni-input");n.addEventListener("input",()=>Lt(n.value)),n.addEventListener("keydown",Kt),document.getElementById("omni-listbox").addEventListener("click",s=>{let o=s.target.closest("[data-omni-idx]");o&&wt(Number(o.dataset.omniIdx))})}function bt(){let t=document.getElementById("omni-backdrop");if(!t)return;t.hidden=!1,v=-1,k=[];let e=document.getElementById("omni-input");e&&(e.value="",e.focus(),e.select()),Lt("")}function I(){let t=document.getElementById("omni-backdrop");t&&(t.hidden=!0),v=-1}function kt(){let t=document.getElementById("omni-backdrop");return!!(t&&!t.hidden)}function Kt(t){let e=document.querySelectorAll("#omni-listbox [data-omni-idx]");t.key==="ArrowDown"?(t.preventDefault(),v=Math.min(v+1,e.length-1),ht(e)):t.key==="ArrowUp"?(t.preventDefault(),v=Math.max(v-1,-1),ht(e)):t.key==="Enter"?(t.preventDefault(),v>=0&&k[v]&&wt(v)):t.key==="Escape"&&(t.preventDefault(),I())}function ht(t){t.forEach((e,n)=>{e.classList.toggle("is-active",n===v),e.setAttribute("aria-selected",String(n===v))}),v>=0&&t[v]?.scrollIntoView({block:"nearest"})}function wt(t){let e=k[t];!e||!Z||(I(),Z(e))}function Lt(t){let e=document.getElementById("omni-listbox");if(!e)return;v=-1,k=[];let n=a.data?.songs||[],s=a.data?.streams||[],o=t.trim().toLowerCase(),l="",r=0;if(!a.data){e.innerHTML='<div class="omni-empty">\u30C7\u30FC\u30BF\u8AAD\u307F\u8FBC\u307F\u4E2D\u2026</div>';return}if(!o){let m=n.slice(0,8);if(m.length){l+=B("\u{1F3C6} \u3088\u304F\u6B4C\u308F\u308C\u308B\u66F2");for(let f of m)k.push({type:"song",song:f}),l+=gt(f,r++,"")}e.innerHTML=l||'<div class="omni-empty">\u691C\u7D22\u30EF\u30FC\u30C9\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044</div>';return}let c=n.filter(m=>M(m.title).includes(o)||M(m.artist).includes(o)).slice(0,8);if(c.length){l+=B("\u{1F3B5} \u66F2");for(let m of c)k.push({type:"song",song:m}),l+=gt(m,r++,o)}let d=new Set,p=[];for(let m of n)if(M(m.artist).includes(o)&&!d.has(m.artist)&&(d.add(m.artist),p.push(m.artist),p.length>=4))break;if(p.length){l+=B("\u{1F3A4} \u30A2\u30FC\u30C6\u30A3\u30B9\u30C8");for(let m of p){let f=n.filter(h=>h.artist===m).length;k.push({type:"artist",artist:m}),l+=`<div class="omni-item" role="option" aria-selected="false" data-omni-idx="${r++}">
        ...
        <div class="omni-item-body">
          ...
          <div class="omni-item-body">
            ...
            <span class="omni-item-meta">${$(f.date)} \xB7 ${f.songs?.length||0}\u66F2</span>
          </div>
        </div>`}}l||(l=`<div class="omni-empty">\u300C${u(t)}\u300D\u306B\u4E00\u81F4\u3059\u308B\u7D50\u679C\u304C\u3042\u308A\u307E\u305B\u3093 \u{1F420}</div>`),e.innerHTML=l}function B(t){return`<div class="omni-section-label" role="presentation">${t}</div>`}function gt(t,e,n){return`<div class="omni-item" role="option" aria-selected="false" data-omni-idx="${e}">
  ...
  </div>`}function M(t){return String(t||"").toLowerCase()}function K(t,e){if(!e)return t;let s=t.toLowerCase().indexOf(e);return s<0?t:t.slice(0,s)+'<mark class="hl">'+t.slice(s,s+e.length)+"</mark>"+t.slice(s+e.length)}ft();ot();var xt={dashboard:()=>import("./chunk-HGAGP5IO.js").then(t=>t.renderDashboard),ranking:()=>import("./chunk-AMQYUYKF.js").then(t=>t.renderRanking),songs:()=>import("./chunk-QT7AEQRW.js").then(t=>t.renderSongs),timeline:()=>import("./chunk-3GETE4YO.js").then(t=>t.renderTimeline),analytics:()=>import("./chunk-GLVWGAKD.js").then(t=>t.renderAnalytics),playlists:()=>import("./chunk-ZSXWKZ7E.js").then(t=>t.renderPlaylists)},R=new Map,Et=0,_=null;function q(t){return Object.prototype.hasOwnProperty.call(xt,t)}async function Rt(t){R.has(t)||R.set(t,xt[t]());try{return await R.get(t)}catch(e){throw R.delete(t),e}}function Dt(t){return["dashboard","timeline","analytics"].includes(t)}function Ut(t,e={}){let n=i(`#panel-${t}`);if(!n)return;let s={dashboard:"\u30C0\u30C3\u30B7\u30E5\u30DC\u30FC\u30C9\u8A73\u7D30",ranking:"\u30E9\u30F3\u30AD\u30F3\u30B0",songs:"\u66F2\u30EA\u30B9\u30C8",timeline:"\u914D\u4FE1\u30BF\u30A4\u30E0\u30E9\u30A4\u30F3",analytics:"\u30A2\u30CA\u30EA\u30C6\u30A3\u30AF\u30B9"};n.innerHTML=`
    <div class="state-card">
      <div class="msg">${u(s[t]||"\u8A73\u7D30\u30C7\u30FC\u30BF")}</div>
      <div class="err-detail">\u8AAD\u307F\u8FBC\u307F\u4E2D\u3067\u3059\u3002</div>
    </div>
  `}function Vt(t){let e=i(`#panel-${t}`);e&&(e.innerHTML=`
    <div class="state-card">
      <div class="msg">\u8A73\u7D30\u30C7\u30FC\u30BF\u3092\u8AAD\u307F\u8FBC\u3093\u3067\u3044\u307E\u3059</div>
    </div>
  `)}function Yt(t){if(a.channelData?.fullLoaded)return;a.channelData=t;let e=L(a.channel)?a.channel:C,n=L(e);n&&(a.data=n),!Dt(a.activeTab)&&a.data&&x(a.activeTab,{autoLoad:!1})}function qt(t){a.channelData=t,a.channelData.fullLoaded=!0;let e=L(a.channel)?a.channel:C;O(e,{resetSearch:!1,updateUrl:!1,render:!1}),x(a.activeTab,{autoLoad:!1})}function Mt(){return _=dt({meta:a.channelData,onSongsReady:Yt}).then(qt).finally(()=>{_=null}),_}async function Nt(){a.channelData?.fullLoaded||(_||Mt(),await _)}async function x(t=a.activeTab,e={}){if(t!=="playlists"&&(!a.data||!q(t))||!q(t))return;let n=a.channelData?.partialLoaded||a.channelData?.fullLoaded,s=a.channelData?.fullLoaded;if(t==="playlists"?!1:Dt(t)?!s:!n)if(e.autoLoad){Vt(t);try{await Nt()}catch(r){console.error("[data] full load failed",r);let c=i(`#panel-${t}`);c&&(c.innerHTML=`
            <div class="state-card">
  ...
  `,document.body.appendChild(t),i("#yt-player-close").addEventListener("click",()=>{t.hidden=!0;let e=i("#yt-player-container");e&&(e.innerHTML=""),A=null}),i("#yt-mini-expand").addEventListener("click",()=>{if(!A)return;let e=(Date.now()-It)/1e3,n=Math.max(0,J+e);at(A,n)})}var Pt=!1,Ct=[];window.onYouTubeIframeAPIReady=()=>{Pt=!0,Ct.splice(0).forEach(t=>t())};function ee(){if(document.getElementById("yt-iframe-api-script"))return;let t=document.createElement("script");t.id="yt-iframe-api-script",t.src="https://www.youtube.com/iframe_api",document.head.appendChild(t)}function ne(t){if(Pt&&window.YT?.Player){t();return}Ct.push(t)}var w=null,V=0,A=null,J=0,It=0,E=!1,nt="timeline";function ae(){nt=a.activeTab||"timeline",a.activeTab="player",g(".tab-btn").forEach(t=>t.classList.remove("active")),g(".panel").forEach(t=>t.classList.toggle("active",t.id==="panel-player"))}function se(){b(nt||"timeline")}function ie(){E=!0;let t=i("#stream-viewer");if(!t)return;document.body.appendChild(t),t.classList.add("sv-fullscreen"),document.body.style.overflow="hidden";let e=i("#sv-close");e&&(e.title="\u901A\u5E38\u8868\u793A\u306B\u623B\u308B\uFF08Esc\uFF09");let n=i("#sv-fullscreen-btn");n&&n.setAttribute("aria-pressed","true")}function Tt(t){let e=Math.floor(t),n=Math.floor(e/3600),s=Math.floor(e%3600/60),o=e%60;return n>0?`${n}:${String(s).padStart(2,"0")}:${String(o).padStart(2,"0")}`:`${s}:${String(o).padStart(2,"0")}`}function Ht(t){return`kanau-ts-${t.channel||""}-${t.index||""}`}function X(t){try{return JSON.parse(localStorage.getItem(Ht(t))||"null")||{}}catch{return{}}}function W(t,e){try{localStorage.setItem(Ht(t),JSON.stringify(e))}catch{}}function le(t,e,n){let s=n[e],o=s!=null?`<button class="sv-ts-badge" data-idx="${e}" data-action="seek" title="${u(Tt(s))} \u306B\u79FB\u52D5">${u(Tt(s))}</button><button class="sv-ts-del" data-idx="${e}" data-action="del-ts" aria-label="\u30BF\u30A4\u30E0\u30B9\u30BF\u30F3\u30D7\u524A\u9664">\u2715</button>`:"";return`<div class="sv-song" data-idx="${e}">
  ...
  </div>`}function Y(t,e,n){t.innerHTML=e.map((s,o)=>le(s,o,n)).join("")}function oe(t){let e=t.match(/(\d+):(\d{2}):(\d{2})|(\d+):(\d{2})/);return e?e[1]!==void 0?parseInt(e[1])*3600+parseInt(e[2])*60+parseInt(e[3]):parseInt(e[4])*60+parseInt(e[5]):null}function Ft(){if(i("#stream-viewer"))return;let t=i("#panel-player");if(!t)return;let e=document.createElement("div");e.id="stream-viewer",e.hidden=!0,e.setAttribute("aria-label","\u914D\u4FE1\u30D7\u30EC\u30A4\u30E4\u30FC"),e.innerHTML=`
  ...
  `,t.appendChild(e),i("#sv-close").addEventListener("click",N),i("#sv-fullscreen-btn").addEventListener("click",ie),e.querySelectorAll("[data-bc-tab]").forEach(n=>{n.addEventListener("click",()=>{N(),b(n.dataset.bcTab)})}),i("#sv-import-toggle").addEventListener("click",()=>{let n=i("#sv-import-area");n&&(n.hidden=!n.hidden,n.hidden||i("#sv-import-input")?.focus())}),i("#sv-import-cancel").addEventListener("click",()=>{let n=i("#sv-import-area");n&&(n.hidden=!0);let s=i("#sv-import-input");s&&(s.value="")}),i("#sv-import-apply").addEventListener("click",()=>{let n=e._currentStream;if(!n)return;let s=i("#sv-import-input");if(!s)return;let l=s.value.split(`
`).map(d=>oe(d)).filter(d=>d!==null);if(!l.length)return;let r=X(n);l.forEach((d,p)=>{p<n.songs.length&&(r[p]=d)}),W(n,r),Y(i("#sv-setlist"),n.songs,r);let c=i("#sv-import-area");c&&(c.hidden=!0),s.value=""}),i("#sv-setlist").addEventListener("click",n=>{let s=n.target.closest("[data-action]");if(!s)return;let o=parseInt(s.dataset.idx,10),l=e._currentStream;if(!l)return;let r=X(l);if(s.dataset.action==="seek"){if(r[o]!=null&&w?.seekTo){w.seekTo(r[o],!0);try{w.playVideo()}catch{}}}else if(s.dataset.action==="set-ts"){let c=w?.getCurrentTime?.();c!=null&&(r[o]=Math.floor(c),W(l,r),Y(i("#sv-setlist"),l.songs,r))}else s.dataset.action==="del-ts"&&(delete r[o],W(l,r),Y(i("#sv-setlist"),l.songs,r))})}function at(t,e=0){if(!t?.url)return;let n=P(t.url);if(!n){H(t.url);return}Ft(),ee();let s=i("#yt-player-panel");if(s&&!s.hidden){s.hidden=!0;let y=i("#yt-player-container");y&&(y.innerHTML="")}if(A=null,E){E=!1;let y=i("#stream-viewer");if(y){y.classList.remove("sv-fullscreen");let T=i("#panel-player");T&&T.appendChild(y)}document.body.style.overflow=""}E=!1,ae();let o=i("#stream-viewer");o.classList.remove("sv-fullscreen"),o._currentStream=t;let l=++V,r=i("#sv-bc-title");r&&(r.textContent=t.title||"\u914D\u4FE1");let c=i("#sv-stream-meta");c&&(c.textContent=`${$(t.date)}\u3000\u7B2C${t.index}\u67A0\u3000\u{1F3A4} ${t.songs.length}\u66F2`);let d=i("#sv-yt-link");d&&(d.href=t.url);let p=i("#sv-song-count");p&&(p.textContent=`${t.songs.length}\u66F2`);let m=X(t);Y(i("#sv-setlist"),t.songs,m),o.hidden=!1,document.body.style.overflow="",setTimeout(()=>{i("#sv-close")?.focus({preventScroll:!0})},50),w=null;let f=i("#sv-player-wrap");f.innerHTML='<div class="sv-player-loading">\u8AAD\u307F\u8FBC\u307F\u4E2D\u2026</div>';let h=Math.floor(e);ne(()=>{if(l!==V||o.hidden)return;f.innerHTML="";let y=document.createElement("div");f.appendChild(y);try{w=new window.YT.Player(y,{videoId:n,width:"100%",height:"100%",playerVars:{autoplay:1,playsinline:1,rel:0,modestbranding:1,...h>0?{start:h}:{}},events:{onReady:T=>{try{T.target.setPlaybackQuality("hd1080")}catch{}try{T.target.setPlaybackQualityRange("hd720","hd1080")}catch{}if(h>5)try{T.target.seekTo(h,!0)}catch{}},onError:()=>{l===V&&(f.innerHTML=`<iframe src="https://www.youtube.com/embed/${u(n)}?autoplay=1&playsinline=1&rel=0${h>0?`&start=${h}`:""}" allow="autoplay; encrypted-media; picture-in-picture" allowfullscreen></iframe>`)}}})}catch{f.innerHTML=`<iframe src="https://www.youtube.com/embed/${u(n)}?autoplay=1&playsinline=1&rel=0${h>0?`&start=${h}`:""}" allow="autoplay; encrypted-media; picture-in-picture" allowfullscreen></iframe>`}})}function N(){let t=i("#stream-viewer");if(!t)return;if(E){E=!1,t.classList.remove("sv-fullscreen"),document.body.style.overflow="";let l=i("#panel-player");l&&l.appendChild(t);let r=i("#sv-close");r&&(r.title="\u30DF\u30CB\u30D7\u30EC\u30A4\u30E4\u30FC\u3067\u518D\u751F\u3092\u7D9A\u3051\u306A\u304C\u3089\u623B\u308A\u307E\u3059\uFF08Esc\uFF09");let c=i("#sv-fullscreen-btn");c&&c.setAttribute("aria-pressed","false");return}let e=t._currentStream,n=w?.getCurrentTime?.()??0,s=e?.url?P(e.url):"";++V,t.hidden=!0,t._currentStream=null,w=null;let o=i("#sv-player-wrap");o&&(o.innerHTML=""),document.body.style.overflow="",se(),s&&e?.url&&(A=e,J=Math.floor(n),It=Date.now(),H(e.url,J,e.title||""))}window.__openStreamViewer=at;function Bt(t){let e=U(t),n=i("#song-modal"),s=i("#song-modal-body"),o=i("#song-modal-title");if(!e||!n||!s||!o)return;ct(e),o.textContent=e.title;let l=(e.streamRefs||[]).slice(0,8).map(d=>({...d,thumbnail:Jt(d.url),thumbnailFallback:Xt(d.url),thumbnailTiny:te(d.url),detailKey:D(d)})),r=[e.genre,...e.seasonTags||[],...e.moodTags||[],...e.singerTags||[]].filter(Boolean),c=j(e.key);s.innerHTML=`
  ...
  `,n.hidden=!1,i("#song-modal-close")?.focus()}function re(){let t=i("#song-modal"),e=i("#song-modal-close");if(!t||!e)return;let n=()=>{t.hidden=!0};e.addEventListener("click",n),t.addEventListener("click",s=>{s.target===t&&n();let o=s.target.closest("[data-inline-youtube]");if(o){s.preventDefault(),s.stopPropagation(),H(o.dataset.inlineYoutube);return}let l=s.target.closest("[data-detail-action]");if(l){if(s.stopPropagation(),l.dataset.detailAction==="close"&&n(),l.dataset.detailAction==="favorite"){let r=l.dataset.songkey;lt(r);let c=j(r);l.textContent=c?"\u2665 \u304A\u6C17\u306B\u5165\u308A\u89E3\u9664":"\u2661 \u304A\u6C17\u306B\u5165\u308A\u306B\u8FFD\u52A0",l.classList.toggle("primary",c),l.classList.toggle("ghost",!c)}if(l.dataset.detailAction==="timeline"){let r=U(l.dataset.songkey);n(),r&&Gt(r)}if(l.dataset.detailAction==="stream"){let r=U(l.dataset.songkey),c=r?.streamRefs?.find(d=>D(d)===l.dataset.streamkey);n(),r&&c&&Zt(r,c)}if(l.dataset.detailAction==="artist"){let r=U(l.dataset.songkey);n(),r&&Wt(r)}}}),t.addEventListener("error",s=>{let o=s.target.closest?.(".song-detail-thumb");if(!o)return;let l=o.dataset.fallback||o.dataset.tiny||"";if(l&&o.src!==l){o.src=l,o.dataset.fallback===l?delete o.dataset.fallback:delete o.dataset.tiny;return}o.closest(".song-detail-thumb-link")?.classList.add("thumb-missing")},!0),document.addEventListener("keydown",s=>{s.key==="Escape"&&!t.hidden&&n()})}var $t=!1;function ce(){if(!a.data)return;let{stats:t,streams:e=[]}=a.data,n=e[0]?.date||null,s=Q(n),o=t.dataGeneratedDate||a.channelData?.dataGeneratedDate||null,l=Q(o),r=t.channelLabel||t.channelId||"",c=r?`<span class="badge accent" style="margin-right:8px;">${u(r)}</span>`:"";i("#updated-info").innerHTML=c+`\u30C7\u30FC\u30BF\u66F4\u65B0\u65E5\uFF1A<strong>${$(o)||"\u2014"}</strong>`+(l!=null?` <span class="badge">${l}\u65E5\u524D</span>`:"");let d=i("#stats-grid");if(!$t)d.innerHTML=`
      ...
      <div class="stat-card gold">
        ...
        <div class="stat-value">${St(a.data)}<span class="stat-unit">\u65E5</span></div>
      </div>
    `,$t=!0;else{let p=d.querySelectorAll(".stat-value");p.length>=6&&(p[0].textContent=S(t.total),p[0].innerHTML+='<span class="stat-unit">\u56DE</span>',p[1].textContent=S(t.repertoire),p[1].innerHTML+='<span class="stat-unit">\u66F2</span>',p[2].textContent=S(t.streams),p[2].innerHTML+='<span class="stat-unit">\u56DE</span>',p[3].textContent=t.avgPerStream,p[3].innerHTML+='<span class="stat-unit">\u66F2</span>',p[4].textContent=s??"\u2014",p[4].innerHTML+='<span class="stat-unit">\u65E5</span>',p[5].textContent=St(a.data),p[5].innerHTML+='<span class="stat-unit">\u65E5</span>')}}function St(t){if(!t.streams?.length)return"\u2014";let e=t.streams[t.streams.length-1].date,n=t.streams[0].date;return Math.floor((n-e)/864e5)+1}function de(){i("#loading").hidden=!1,i("#error").hidden=!0}function ue(){i("#loading").hidden=!0}function pe(t){let e=i("#loading"),n=i("#error"),s=i("#err-detail");e&&(e.hidden=!0),n&&(n.hidden=!1),s&&(s.textContent=t&&t.message?t.message:String(t))}function me(t){let e=document.getElementById("page-title");e&&(t==="new"?(e.innerHTML='<img class="hero-title-icon" src="assets/site-icon.svg" alt="" width="32" height="32" fetchpriority="high" decoding="sync">\u5922\u5DDD\u304B\u306A\u3046 \u65B0ch \u6B4C\u5531\u30C7\u30FC\u30BF\u30D9\u30FC\u30B9',document.title="\u5922\u5DDD\u304B\u306A\u3046 \u65B0ch \u6B4C\u5531\u30C7\u30FC\u30BF\u30D9\u30FC\u30B9"):t==="old"?(e.innerHTML='<img class="hero-title-icon" src="assets/site-icon.svg" alt="" width="32" height="32" fetchpriority="high" decoding="sync">\u5922\u5DDD\u304B\u306A\u3046 \u65E7ch \u6B4C\u5531\u30C7\u30FC\u30BF\u30D9\u30FC\u30B9',document.title="\u5922\u5DDD\u304B\u306A\u3046 \u65E7ch \u6B4C\u5531\u30C7\u30FC\u30BF\u30D9\u30FC\u30B9"):(e.innerHTML='<img class="hero-title-icon" src="assets/site-icon.svg" alt="" width="32" height="32" fetchpriority="high" decoding="sync">\u5922\u5DDD\u304B\u306A\u3046 \u6B4C\u5531\u30C7\u30FC\u30BF\u30D9\u30FC\u30B9',document.title="\u5922\u5DDD\u304B\u306A\u3046 \u6B4C\u5531\u30C7\u30FC\u30BF\u30D9\u30FC\u30B9"))}function fe(){let t=i("#help-modal"),e=i("#help-btn"),n=i("#help-close");if(!t||!e||!n)return;let s=()=>{t.hidden=!1,n.focus()},o=()=>{t.hidden=!0,e.focus()};e.addEventListener("click",s),n.addEventListener("click",o),t.addEventListener("click",l=>{l.target===t&&o()}),document.addEventListener("keydown",l=>{l.key==="Escape"&&!t.hidden&&o()})}function ve(){let t=i("#welcome-tip"),e=i("#welcome-close");if(!t||!e||window.matchMedia("(max-width: 760px)").matches||localStorage.getItem("kanau-welcome-tip-dismissed")==="1")return;let n=()=>{t.hidden=!1};"requestIdleCallback"in window?window.requestIdleCallback(n,{timeout:5e3}):window.setTimeout(n,2500),e.addEventListener("click",()=>{t.hidden=!0,localStorage.setItem("kanau-welcome-tip-dismissed","1")})}async function st(){de();try{let t=await ut();a.channelData=t,!_&&!t.fullLoaded&&Mt();let e=G();a.songsQuery=e.q,a.activeTab=q(e.tab)?e.tab:"dashboard",_t(a.activeTab);let n=e.channel||a.channel||C;if(L(n)||(n=C),!L(n)){let s=Object.keys(t.channels)[0];s&&(n=s)}if(!L(n))throw new Error("No channel data could be loaded");zt(),ue(),O(n,{resetSearch:!1,updateUrl:!1,autoLoad:!0,initial:!0})}catch(t){console.error("[init] failed:",t),pe(t)}}function he(){if(!a.channelData)return;let t=G();a.songsQuery=t.q,t.channel!==a.channel&&L(t.channel)&&O(t.channel,{resetSearch:!1,updateUrl:!1}),b(t.tab,{updateUrl:!1})}g(".tab-btn").forEach(t=>{t.addEventListener("click",()=>{let e=t.dataset.tab,n=i("#stream-viewer");if(e!=="player"&&n&&!n.hidden&&!E){nt=e,N();return}b(e)})});g(".ch-btn").forEach(t=>{t.addEventListener("click",()=>{t.dataset.channel&&(t.disabled||O(t.dataset.channel))})});window.addEventListener("popstate",he);g("[data-audience]").forEach(t=>{t.addEventListener("click",()=>Ot(t.dataset.audience))});document.body.addEventListener("click",t=>{let e=t.target.closest("[data-artist-search]");if(e){t.preventDefault(),t.stopPropagation(),et(e.dataset.artistSearch||e.textContent||"");return}let n=t.target.closest("[data-playlist-add]");if(n){t.preventDefault(),t.stopPropagation();let r=n.dataset.playlistAdd,c=n.dataset.streamTitle||"";import("./chunk-ZSXWKZ7E.js").then(d=>d.showAddToPlaylistModal(r,c));return}let s=t.target.closest("[data-stream-play]");if(s){t.preventDefault(),t.stopPropagation();let r=s.dataset.streamPlay,c=(a.data?.streams||[]).find(d=>D(d)===r);c?.url?at(c):s.dataset.inlineYoutube&&H(s.dataset.inlineYoutube);return}let o=t.target.closest("[data-inline-youtube]");if(o){t.preventDefault(),t.stopPropagation(),H(o.dataset.inlineYoutube);return}if(rt(t.target))return;let l=t.target.closest("[data-songkey]");l&&Bt(l.dataset.songkey)});i("#retry-btn").addEventListener("click",st);i("#reload-btn").addEventListener("click",st);fe();At();Ft();re();jt();Qt();ve();yt(t=>{t.type==="song"?Bt(t.song.key):t.type==="artist"?et(t.artist):t.type==="stream"&&(a.timelineFocus=D(t.stream),a.timelineFilter=null,a.timelineLimit=9999,b("timeline"),i("#panel-timeline")?.scrollIntoView({behavior:"smooth",block:"start"}))});document.addEventListener("keydown",t=>{let e=document.activeElement?.tagName,n=e==="INPUT"||e==="TEXTAREA"||e==="SELECT";if(t.key==="/"&&!n&&!t.metaKey&&!t.ctrlKey||t.key==="k"&&(t.ctrlKey||t.metaKey)&&!t.shiftKey){t.preventDefault(),bt();return}if(t.key==="t"&&!n&&!t.metaKey&&!t.ctrlKey){t.preventDefault(),mt();return}if(t.key==="?"&&!n&&!t.metaKey&&!t.ctrlKey){t.preventDefault();let o=i("#help-modal");o&&o.hidden&&(o.hidden=!1,i("#help-close")?.focus());return}if(t.key==="Escape"&&!t.metaKey&&!t.ctrlKey){let o=i("#stream-viewer"),l=!!i("#panel-player.active");if(o&&!o.hidden&&(E||l)){t.preventDefault(),N();return}if(kt()){t.preventDefault(),I();return}let r=i("#song-modal");if(r&&!r.hidden)return;let c=i("#help-modal");if(c&&!c.hidden){c.hidden=!0,i("#help-btn")?.focus();return}let d=i("#songs-search");d&&document.activeElement===d&&d.value&&(t.preventDefault(),d.value="",d.dispatchEvent(new Event("input",{bubbles:!0})))}});vt(()=>{a.data&&(z(),(a.activeTab==="dashboard"||a.activeTab==="analytics")&&x())});function ge(){st()}ge();

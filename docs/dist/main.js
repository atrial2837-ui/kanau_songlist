import{b as wt,c as kt,d as $t,i as Lt,k as ot,l as G}from"./chunk-3QAEH344.js";import{a as St,b as Tt,e as lt,f as Et}from"./chunk-SIADDXVK.js";import{a as R}from"./chunk-MKJIXTK4.js";import{a as bt,b as nt,c as yt,e as c}from"./chunk-N3S3MIXU.js";import{D as it,E as L,G as D,L as M,M as gt,a as i,b as k,d as m}from"./chunk-FKVR6ZKV.js";var g=-1,E=[],ct=null;function Ct(t){ct=t;let e=document.createElement("div");e.id="omni-backdrop",e.hidden=!0,e.setAttribute("role","dialog"),e.setAttribute("aria-modal","true"),e.setAttribute("aria-label","\u30B5\u30A4\u30C8\u5185\u691C\u7D22"),e.innerHTML=`
    <div id="omni-box">
  ...
  </div>`}function A(t){return String(t||"").toLowerCase()}function Q(t,e){if(!e)return t;let s=t.toLowerCase().indexOf(e);return s<0?t:t.slice(0,s)+'<mark class="hl">'+t.slice(s,s+e.length)+"</mark>"+t.slice(s+e.length)}Tt();yt();var Bt={dashboard:()=>import("./chunk-NX4KOKQI.js").then(t=>t.renderDashboard),ranking:()=>import("./chunk-AOWB3BNY.js").then(t=>t.renderRanking),songs:()=>import("./chunk-EQQ27U7N.js").then(t=>t.renderSongs),timeline:()=>import("./chunk-4GOYTJ2B.js").then(t=>t.renderTimeline),analytics:()=>import("./chunk-QEXZHCSH.js").then(t=>t.renderAnalytics),playlists:()=>import("./chunk-RW2OMLXW.js").then(t=>t.renderPlaylists)},J=new Map,At=0,N=null;function tt(t){return Object.prototype.hasOwnProperty.call(Bt,t)}async function ee(t){J.has(t)||J.set(t,Bt[t]());try{return await J.get(t)}catch(e){throw J.delete(t),e}}function Yt(t){return["dashboard","timeline","analytics"].includes(t)}function ae(t,e={}){let a=i(`#panel-${t}`);if(!a)return;let s={dashboard:"\u30C0\u30C3\u30B7\u30E5\u30DC\u30FC\u30C9\u8A73\u7D30",ranking:"\u30E9\u30F3\u30AD\u30F3\u30B0",songs:"\u66F2\u30EA\u30B9\u30C8",timeline:"\u914D\u4FE1\u30BF\u30A4\u30E0\u30E9\u30A4\u30F3",analytics:"\u30A2\u30CA\u30EA\u30C6\u30A3\u30AF\u30B9"};a.innerHTML=`
  ...
  `,e.onchange=r=>{let v=r.target.closest("#sv-ap-check");if(!v)return;j=v.checked;let f=e.querySelector(".sv-bp-ap-switch");f&&f.classList.toggle("sv-bp-ap-switch--on",j)},e.onclick=r=>{let v=r.target.closest("[data-bp-action]");if(!v)return;let f=v.dataset.bpAction;if(f==="open-stream"){let h=v.dataset.bpChannel,b=parseInt(v.dataset.bpIndex,10),$=(c.data?.streams||[]).find(Y=>Y.channel===h&&Y.index===b);$&&B($)}else if(f==="add-pl"){let h=v.dataset.bpPlId;if(Ee(h,u)){v.classList.add("sv-bp-pl-btn--added"),v.disabled=!0;let b=v.querySelector(".sv-bp-pl-status");b&&(b.textContent="\u2713 \u767B\u9332\u6E08\u307F")}}}}function F(t,e,a){t.innerHTML=e.map((s,l)=>we(s,l,a)).join("")}function ft(t){let e=t.match(/(\d+):(\d{2}):(\d{2})|(\d+):(\d{2})/);return e?e[1]!==void 0?parseInt(e[1])*3600+parseInt(e[2])*60+parseInt(e[3]):parseInt(e[4])*60+parseInt(e[5]):null}function Xt(){if(i("#stream-viewer"))return;let t=i("#panel-player");if(!t)return;let e=document.createElement("div");e.id="stream-viewer",e.hidden=!0,e.setAttribute("aria-label","\u914D\u4FE1\u30D7\u30EC\u30A4\u30E4\u30FC"),e.innerHTML=`

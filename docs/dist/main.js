import{b as It,c as At,d as Dt,i as Ht,k as mt,l as Z}from"./chunk-3QAEH344.js";import{a as Nt,b as Vt,e as vt,f as qt}from"./chunk-SIADDXVK.js";import{a as Y}from"./chunk-MKJIXTK4.js";import{a as Ct,b as ut,c as Mt,e as c}from"./chunk-N3S3MIXU.js";import{D as pt,E as $,G as N,L as I,M as Pt,a as l,b as L,d as m}from"./chunk-FKVR6ZKV.js";var k=-1,_=[],ft=null;function Rt(t){ft=t;let e=document.createElement("div");e.id="omni-backdrop",e.hidden=!0,e.setAttribute("role","dialog"),e.setAttribute("aria-modal","true"),e.setAttribute("aria-label","\u30B5\u30A4\u30C8\u5185\u691C\u7D22"),e.innerHTML=`
  ...
  `,document.body.appendChild(e),e.addEventListener("click",n=>{n.target===e&&R()});let s=document.getElementById("omni-input");s.addEventListener("input",()=>Kt(s.value)),s.addEventListener("keydown",ue),document.getElementById("omni-listbox").addEventListener("click",n=>{let i=n.target.closest("[data-omni-idx]");i&&Ft(Number(i.dataset.omniIdx))})}function Ut(){let t=document.getElementById("omni-backdrop");if(!t)return;t.hidden=!1,k=-1,_=[];let e=document.getElementById("omni-input");e&&(e.value="",e.focus(),e.select()),Kt("")}function R(){let t=document.getElementById("omni-backdrop");t&&(t.hidden=!0),k=-1}function jt(){let t=document.getElementById("omni-backdrop");return!!(t&&!t.hidden)}function ue(t){let e=document.querySelectorAll("#omni-listbox [data-omni-idx]");t.key==="ArrowDown"?(t.preventDefault(),k=Math.min(k+1,e.length-1),Bt(e)):t.key==="ArrowUp"?(t.preventDefault(),k=Math.max(k-1,-1),Bt(e)):t.key==="Enter"?(t.preventDefault(),k>=0&&_[k]&&Ft(k)):t.key==="Escape"&&(t.preventDefault(),R())}function Bt(t){t.forEach((e,s)=>{e.classList.toggle("is-active",s===k),e.setAttribute("aria-selected",String(s===k))}),k>=0&&t[k]?.scrollIntoView({block:"nearest"})}function Ft(t){let e=_[t];!e||!ft||(R(),ft(e))}function Kt(t){let e=document.getElementById("omni-listbox");if(!e)return;k=-1,_=[];let s=c.data?.songs||[],n=c.data?.streams||[],i=t.trim().toLowerCase(),a="",o=0;if(!c.data){e.innerHTML='<div class="omni-empty">\u30C7\u30FC\u30BF\u8AAD\u307F\u8FBC\u307F\u4E2D\u2026</div>';return}if(!i){let r=s.slice(0,8);if(r.length){a+=X("\u{1F3C6} \u3088\u304F\u6B4C\u308F\u308C\u308B\u66F2");for(let v of r)_.push({type:"song",song:v}),a+=Yt(v,o++,"")}e.innerHTML=a||'<div class="omni-empty">\u691C\u7D22\u30EF\u30FC\u30C9\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044</div>';return}let u=s.filter(r=>V(r.title).includes(i)||V(r.artist).includes(i)).slice(0,8);if(u.length){a+=X("\u{1F3B5} \u66F2");for(let r of u)_.push({type:"song",song:r}),a+=Yt(r,o++,i)}let p=new Set,d=[];for(let r of s)if(V(r.artist).includes(i)&&!p.has(r.artist)&&(p.add(r.artist),d.push(r.artist),d.length>=4))break;if(d.length){a+=X("\u{1F3A4} \u30A2\u30FC\u30C6\u30A3\u30B9\u30C8");for(let r of d){let v=s.filter(f=>f.artist===r).length;_.push({type:"artist",artist:r}),a+=`<div class="omni-item" role="option" aria-selected="false" data-omni-idx="${o++}">
        <span class="omni-item-icon">\u{1F3A4}</span>
        <div class="omni-item-body">
          <span class="omni-item-title">${W(m(r),i)}</span>
          <span class="omni-item-meta">${v}\u66F2 \xB7 \u30A2\u30FC\u30C6\u30A3\u30B9\u30C8\u7D5E\u308A\u8FBC\u307F</span>
        </div>
      </div>`}}if(n.length){let r=n.filter(v=>V(v.title).includes(i)||v.songs?.some(f=>V(f.title).includes(i)||V(f.artist).includes(i))).slice(0,5);if(r.length){a+=X("\u{1F4C5} \u914D\u4FE1\u67A0");for(let v of r){_.push({type:"stream",stream:v});let f=v.channel==="new"?"\u65B0ch":v.channel==="old"?"\u65E7ch":"";a+=`<div class="omni-item" role="option" aria-selected="false" data-omni-idx="${o++}">
          <span class="omni-item-icon">\u{1F4C5}</span>
          <div class="omni-item-body">
            <span class="omni-item-title">${W(m(v.title||"\u914D\u4FE1"),i)}</span>
            <span class="omni-item-meta">${$(v.date)}${f?" \xB7 "+f:""} \xB7 ${v.songs?.length||0}\u66F2 \xB7 \u30AF\u30EA\u30C3\u30AF\u3067\u518D\u751F</span>
          </div>
        </div>`}}}a||(a=`<div class="omni-empty">\u300C${m(t)}\u300D\u306B\u4E00\u81F4\u3059\u308B\u7D50\u679C\u304C\u3042\u308A\u307E\u305B\u3093 \u{1F420}</div>`),e.innerHTML=a}function X(t){return`<div class="omni-section-label" role="presentation">${t}</div>`}function Yt(t,e,s){return`<div class="omni-item" role="option" aria-selected="false" data-omni-idx="${e}">
    <span class="omni-item-icon">\u{1F3B5}</span>
    <div class="omni-item-body">
      <span class="omni-item-title">${W(m(t.title),s)}</span>
      <span class="omni-item-meta">${W(m(t.artist||""),s)} \xB7 ${t.count}\u56DE\u6B4C\u5531</span>
    </div>
    <span class="omni-item-count">${t.count}<small>\u56DE</small></span>
  </div>`}function V(t){return String(t||"").toLowerCase()}function W(t,e){if(!e)return t;let n=t.toLowerCase().indexOf(e);return n<0?t:t.slice(0,n)+'<mark class="hl">'+t.slice(n,n+e.length)+"</mark>"+t.slice(n+e.length)}Vt();Mt();var Jt={dashboard:()=>import("./chunk-NX4KOKQI.js").then(t=>t.renderDashboard),ranking:()=>import("./chunk-AOWB3BNY.js").then(t=>t.renderRanking),songs:()=>import("./chunk-EQQ27U7N.js").then(t=>t.renderSongs),timeline:()=>import("./chunk-4GOYTJ2B.js").then(t=>t.renderTimeline),analytics:()=>import("./chunk-QEXZHCSH.js").then(t=>t.renderAnalytics),playlists:()=>import("./chunk-BWTSGM2I.js").then(t=>t.renderPlaylists)},tt=new Map,Ot=0,q=null;function it(t){return Object.prototype.hasOwnProperty.call(Jt,t)}async function pe(t){tt.has(t)||tt.set(t,Jt[t]());try{return await tt.get(t)}catch(e){throw tt.delete(t),e}}function Zt(t){return["dashboard","timeline","analytics"].includes(t)}function ve(t,e={}){let s=l(`#panel-${t}`);if(!s)return;let n={dashboard:"\u30C0\u30C3\u30B7\u30E5\u30DC\u30FC\u30C9\u8A73\u7D30",ranking:"\u30E9\u30F3\u30AD\u30F3\u30B0",songs:"\u66F2\u30EA\u30B9\u30C8",timeline:"\u914D\u4FE1\u30BF\u30A4\u30E0\u30E9\u30A4\u30F3",analytics:"\u30A2\u30CA\u30EA\u30C6\u30A3\u30AF\u30B9"};s.innerHTML=`
  ...
  `)}function fe(t){if(c.channelData?.fullLoaded)return;c.channelData=t;let e=P(c.channel)?c.channel:Y,s=P(e);s&&(c.data=s),!Zt(c.activeTab)&&c.data&&D(c.activeTab,{autoLoad:!1})}function he(t){c.channelData=t,c.channelData.fullLoaded=!0;let e=P(c.channel)?c.channel:Y;rt(e,{resetSearch:!1,updateUrl:!1,render:!1}),D(c.activeTab,{autoLoad:!1})}function Xt(){return q=At({meta:c.channelData,onSongsReady:fe}).then(he).finally(()=>{q=null}),q}async function be(){c.channelData?.fullLoaded||(q||Xt(),await q)}async function D(t=c.activeTab,e={}){if(t!=="playlists"&&(!c.data||!it(t))||!it(t))return;let s=c.channelData?.partialLoaded||c.channelData?.fullLoaded,n=c.channelData?.fullLoaded;if(t==="playlists"?!1:Zt(t)?!n:!s)if(e.autoLoad){me(t);try{await be()}catch(o){console.error("[data] full load failed",o);let u=l(`#panel-${t}`);u&&(u.innerHTML=`
            <div class="state-card">
          ...
          `,u.querySelector("[data-load-full-data]")?.addEventListener("click",()=>{D(t,{autoLoad:!0})}));return}}else{ve(t,{initial:e.initial});return}let a=++Ot;try{let o=await pe(t);if(a!==Ot||t!==c.activeTab||!c.data)return;t==="songs"&&Ht(c.data.songs||[]),o()}catch(o){console.error(`[${t}] render failed`,o);let u=l(`#panel-${t}`);u&&(u.innerHTML=`
        <div class="state-card">
          <div class="msg">\u8868\u793A\u306B\u5931\u6557\u3057\u307E\u3057\u305F</div>
          <div class="err-detail">${m(o?.message||String(o))}</div>
        </div>
      `)}}function H(t,e={}){it(t)||(t="dashboard");let s=l("#stream-viewer");if(t!=="player"&&s&&!s.hidden&&!x&&!s.classList.contains("sv-minified")){J=t,ot=e,O();return}c.activeTab=t,Wt(t),e.updateUrl!==!1&&Z({tab:t}),D(t,{autoLoad:e.autoLoad!==!1,initial:!!e.initial})}function Wt(t){L(".tab-btn").forEach(e=>e.classList.toggle("active",e.dataset.tab===t)),L(".panel").forEach(e=>e.classList.toggle("active",e.id===`panel-${t}`))}function P(t){return c.channelData?t==="all"?c.channelData.combined:c.channelData.channels[t]||null:null}function rt(t,e={}){let s=P(t);s&&(c.channel=t,Oe(t),c.data=s,c.timelineFilter=null,c.timelineFocus=null,c.timelineLimit=12,c.songsLimit=100,e.resetSearch!==!1&&(c.songsQuery="",c.songsGenre="all"),vt(),L("#channel-switch [data-channel]").forEach(n=>n.classList.toggle("active",n.dataset.channel===t)),gt(),e.updateUrl!==!1&&Z({tab:c.activeTab,channel:t,q:c.songsQuery}),Ue(),e.render!==!1&&D(c.activeTab,{autoLoad:e.autoLoad!==!1,initial:!!e.initial}))}function ye(t,e={}){c.audience=t==="singer"?"singer":"listener",c.singerMode=c.audience==="singer",c.singerMode||(c.singerPreset="all"),L(".audience-switch [data-audience]").forEach(s=>{s.classList.toggle("active",s.dataset.audience===c.audience)}),document.body.dataset.audience=c.audience,gt(),c.audience==="singer"?(c.songsLimit=100,H("songs",{autoLoad:e.autoLoad!==!1})):c.data&&D(c.activeTab,{autoLoad:e.autoLoad!==!1,initial:!!e.initial})}function gt(){let t=l("#mobile-menu-label");if(!t)return;let e=l("#channel-switch [data-channel].active")?.textContent?.trim()||"\u65B0ch",s=l("#audience-switch [data-audience].active")?.textContent?.trim()||"\u30EA\u30B9\u30CA\u30FC";t.textContent=`${e} / ${s}`}function ge(){let t=l("#mobile-menu-toggle"),e=l("#mobile-menu-state"),s=l("#topbar-actions");if(!t||!e||!s)return;let n=a=>{e.checked=a,s.classList.toggle("is-open",a),t.setAttribute("aria-expanded",String(a))},i=()=>{n(!1),t.focus()};t.addEventListener("click",a=>{a.stopPropagation(),requestAnimationFrame(()=>n(e.checked))}),t.addEventListener("keydown",a=>{a.key!=="Enter"&&a.key!==" "||(a.preventDefault(),n(!e.checked))}),e.addEventListener("change",()=>{n(e.checked)}),document.addEventListener("click",a=>{s.classList.contains("is-open")&&(a.target.closest("#topbar-actions")||a.target.closest("#mobile-menu-toggle")||a.target.closest("#mobile-menu-state")||i())}),document.addEventListener("keydown",a=>{a.key==="Escape"&&i()}),s.addEventListener("click",a=>{a.stopPropagation()}),gt()}function we(){let t=l("#page-top-toast");if(!t)return;let e=t.querySelector("img[data-src]"),s=!1,n=420,i=()=>{!e||e.src||(e.src=e.dataset.src||"")},a=()=>{s=!1;let u=window.scrollY>n;u&&i(),t.hidden=!u,t.classList.toggle("is-visible",u),t.setAttribute("aria-hidden",String(!u)),t.tabIndex=u?0:-1},o=()=>{s||(s=!0,requestAnimationFrame(a))};t.hidden=!0,t.setAttribute("aria-hidden","true"),t.tabIndex=-1,t.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})}),window.addEventListener("scroll",o,{passive:!0}),a()}function ke(){if(c.channelData)for(let t of L("#channel-switch [data-channel]")){let e=t.dataset.channel,s=e==="all"?!!c.channelData.combined:!!(c.channelData.channels&&c.channelData.channels[e]);t.disabled=!s,s?t.removeAttribute("title"):t.title="\u30C7\u30FC\u30BF\u3092\u53D6\u5F97\u3067\u304D\u307E\u305B\u3093\u3067\u3057\u305F"}}function Le({key:t,title:e,artist:s}){c.timelineFilter&&c.timelineFilter.key===t&&c.activeTab==="timeline"?c.timelineFilter=null:c.timelineFilter={key:t,title:e,artist:s},c.timelineFocus=null,c.timelineLimit=12,H("timeline"),l("#panel-timeline").scrollIntoView({behavior:"smooth",block:"start"})}function $e(t,e){c.timelineFilter={key:t.key,title:t.title,artist:t.artist},c.timelineFocus=N(e),c.timelineLimit=9999,H("timeline"),l("#panel-timeline").scrollIntoView({behavior:"smooth",block:"start"})}function Se(t){wt(t.artist||"")}function wt(t){let e=String(t||"").replace(/"/g,"");c.songsQuery=e?`artist:"${e}"`:"",c.songsLimit=100,Z({tab:"songs",q:c.songsQuery}),H("songs",{updateUrl:!1})}function nt(t){return(c.data?.songs||[]).find(e=>e.key===t)||null}function z(t){let e=String(t||""),s=[/youtu\.be\/([A-Za-z0-9_-]{11})/,/youtube\.com\/watch\?[^#]*v=([A-Za-z0-9_-]{11})/,/youtube\.com\/live\/([A-Za-z0-9_-]{11})/,/youtube\.com\/shorts\/([A-Za-z0-9_-]{11})/,/youtube\.com\/embed\/([A-Za-z0-9_-]{11})/];for(let n of s){let i=e.match(n);if(i)return i[1]}return""}function kt(t){let e=z(t);return e?`https://i.ytimg.com/vi/${e}/hqdefault.jpg`:""}function xe(t){let e=z(t);return e?`https://i.ytimg.com/vi/${e}/mqdefault.jpg`:""}function Te(t){let e=z(t);return e?`https://i.ytimg.com/vi/${e}/default.jpg`:""}function Lt(){at&&(clearInterval(at),at=null)}function te(){Lt(),at=setInterval(()=>{if(C(),!!y)try{let t=y.getDuration?.()||0,e=y.getCurrentTime?.()||0,s=t>0?Math.min(e/t*100,100):0,n=l("#yt-mini-progress-fill");n&&(n.style.width=`${s}%`);let a=y.getPlayerState?.()===window.YT?.PlayerState?.PLAYING,o=l("#yt-mini-play");o&&o.setAttribute("data-playing",a?"1":"0")}catch{}},400)}function ct(){if(Lt(),y){try{y.destroy()}catch{}y=null}let t=l("#yt-player-container");t&&(t.innerHTML="")}function Ee(){if(y?.getCurrentTime)try{return y.getCurrentTime()}catch{}return Math.max(0,yt+(Date.now()-ie)/1e3)}function C(){if(!l("#stream-viewer")?.classList.contains("sv-minified"))return;let e=l("#sv-player-wrap"),s=document.querySelector("#yt-player-panel .yt-mini-video-wrap");if(!e||!s)return;let n=s.getBoundingClientRect();e.style.left=`${n.left}px`,e.style.top=`${n.top}px`,e.style.width=`${n.width}px`,e.style.height=`${n.height}px`}function _e(){let t=l("#stream-viewer"),e=t?._currentStream;if(!t||!e||!g)return!1;St();let s=l("#yt-player-panel");if(!s)return!1;E=e;try{yt=Math.floor(g.getCurrentTime?.()??0)}catch{yt=0}ie=Date.now();let n=l("#yt-mini-title");n&&(n.textContent=e.title||"");let i=l("#yt-mini-hint");i&&(i.textContent="\u25B2 \u30BF\u30C3\u30D7\u3057\u3066\u914D\u4FE1\u30D3\u30E5\u30FC\u30EF\u30FC\u3078\u623B\u308B"),s.classList.add("has-stream"),s.hidden=!1,y=g,g=null,t.classList.add("sv-minified"),document.body.classList.add("has-sv-mini"),document.body.style.overflow="",Tt(),C(),requestAnimationFrame(C),setTimeout(C,120),setTimeout(C,400),window.addEventListener("resize",C),te();try{let a=y.getPlayerState?.();l("#yt-mini-play")?.setAttribute("data-playing",a===window.YT?.PlayerState?.PLAYING?"1":"0")}catch{}return Q(l("#yt-mini-vol-slider"),l("#yt-mini-vol-btn"),null,G()),!0}function ee(){let t=l("#stream-viewer");if(!t?.classList.contains("sv-minified"))return!1;window.removeEventListener("resize",C),Lt(),t.classList.remove("sv-minified"),document.body.classList.remove("has-sv-mini");let e=l("#sv-player-wrap");e&&(e.style.cssText=""),g=y,y=null;let s=l("#yt-player-panel");return s&&(s.hidden=!0),le(),setTimeout(()=>{l("#sv-close")?.focus({preventScroll:!0})},50),!0}function $t(){let t=l("#stream-viewer");if(!t?.classList.contains("sv-minified"))return!1;window.removeEventListener("resize",C),++A,t.classList.remove("sv-minified"),document.body.classList.remove("has-sv-mini"),t.hidden=!0,t._currentStream=null;let e=l("#sv-player-wrap");e&&(e.style.cssText="",e.innerHTML=""),ct();let s=l("#yt-player-panel");return s&&(s.hidden=!0),E=null,!0}function lt(t,e=0,s=""){let n=z(t);if(!n)return;if(window.matchMedia("(max-width: 600px)").matches){window.open(String(t||""),"_blank","noopener");return}{let p=l("#stream-viewer");if(p&&!p.hidden&&!x)if(p.classList.contains("sv-minified"))$t();else{++A,p.hidden=!0,p._currentStream=null,g=null;let d=l("#sv-player-wrap");d&&(d.innerHTML=""),document.body.style.overflow="",E=null,ot={},Tt()}}xt(),St();let i=l("#yt-player-container"),a=l("#yt-player-panel");if(!i||!a)return;ct();let o=l("#yt-mini-title");o&&(o.textContent=s||"\u30A4\u30F3\u30E9\u30A4\u30F3\u518D\u751F");let u=l("#yt-mini-hint");u&&(u.textContent=E?"\u25B2 \u30BF\u30C3\u30D7\u3057\u3066\u914D\u4FE1\u30D3\u30E5\u30FC\u30EF\u30FC\u3078\u623B\u308B":""),a.classList.toggle("has-stream",!!E),a.hidden=!1,ae(()=>{let p=document.createElement("div");i.appendChild(p);try{y=new window.YT.Player(p,{videoId:n,width:"100%",height:"100%",playerVars:{autoplay:1,playsinline:1,rel:0,controls:0,disablekb:1,modestbranding:1,...e>0?{start:Math.floor(e)}:{}},events:{onReady:d=>{let r=G();try{d.target.setVolume(r)}catch{}if(Q(l("#yt-mini-vol-slider"),l("#yt-mini-vol-btn"),null,r),e>5)try{d.target.seekTo(e,!0)}catch{}te()},onStateChange:d=>{let r=d.data===window.YT.PlayerState.PLAYING,v=l("#yt-mini-play");v&&v.setAttribute("data-playing",r?"1":"0")}}})}catch{let r=e>0?`&start=${Math.floor(e)}`:"";i.innerHTML=`<iframe src="https://www.youtube.com/embed/${n}?autoplay=1&playsinline=1${r}" frameborder="0" allowfullscreen allow="autoplay; encrypted-media; picture-in-picture"></iframe>`}})}function St(){if(l("#yt-player-panel"))return;let t=document.createElement("div");t.id="yt-player-panel",t.hidden=!0,t.innerHTML=`
  ...
  `,document.body.appendChild(t),l("#yt-player-close").addEventListener("click",()=>{t.hidden=!0,!$t()&&(ct(),E=null)}),l("#yt-mini-play").addEventListener("click",()=>{if(y)try{y.getPlayerState?.()===window.YT?.PlayerState?.PLAYING?y.pauseVideo():y.playVideo()}catch{}}),l("#yt-mini-restore").addEventListener("click",()=>{ee()||E&&B(E,Ee())}),l("#yt-mini-progress-bar").addEventListener("click",n=>{if(!y)return;let a=n.currentTarget.getBoundingClientRect(),o=Math.max(0,Math.min(1,(n.clientX-a.left)/a.width));try{let u=y.getDuration?.()||0;u>0&&y.seekTo(o*u,!0)}catch{}});let e=l("#yt-mini-vol-slider"),s=l("#yt-mini-vol-btn");if(e){let n=G();e.value=n,e.style.setProperty("--pct",`${n}%`),s&&(s.textContent=F(n)),e.addEventListener("input",i=>{let a=parseInt(i.target.value);if(i.target.style.setProperty("--pct",`${a}%`),bt(a),s&&(s.textContent=F(a)),y)try{y.setVolume(a)}catch{}})}if(s){let n=80;s.addEventListener("click",()=>{if(!e)return;let i=parseInt(e.value),a=i>0?0:n||80;i>0&&(n=i),Q(e,s,y,a)})}}var se=!1,ne=[];window.onYouTubeIframeAPIReady=()=>{se=!0,ne.splice(0).forEach(t=>t()),import("./chunk-IRKL6VIF.js").then(t=>t.notifyYtReady()).catch(()=>{})};function xt(){if(document.getElementById("yt-iframe-api-script"))return;let t=document.createElement("script");t.id="yt-iframe-api-script",t.src="https://www.youtube.com/iframe_api",document.head.appendChild(t)}function ae(t){if(se&&window.YT?.Player){t();return}ne.push(t)}var G=()=>Math.max(0,Math.min(100,parseInt(localStorage.getItem("kanaVol")??"100")||100)),bt=t=>localStorage.setItem("kanaVol",String(t)),F=t=>t===0?"\u{1F507}":t<50?"\u{1F509}":"\u{1F50A}";function Q(t,e,s,n){if(t&&(t.value=n,t.style.setProperty("--pct",`${n}%`)),e&&(e.textContent=F(n)),s)try{s.setVolume(n)}catch{}}var g=null,A=0,E=null,yt=0,ie=0,x=!1,J="timeline",ot={},S={},U=!1,y=null,at=null;function le(){J=c.activeTab||"timeline",c.activeTab="player",L(".tab-btn").forEach(t=>t.classList.remove("active")),L(".panel").forEach(t=>t.classList.toggle("active",t.id==="panel-player"))}function Tt(){let t=ot;ot={},H(J||"timeline",t)}function Ce(){x=!0;let t=l("#stream-viewer");if(!t)return;t.classList.add("sv-fullscreen"),document.body.classList.add("has-sv-fullscreen"),document.body.style.overflow="hidden";let e=l("#sv-close");e&&(e.title="\u901A\u5E38\u8868\u793A\u306B\u623B\u308B\uFF08Esc\uFF09");let s=l("#sv-fullscreen-btn");s&&s.setAttribute("aria-pressed","true")}function M(t){let e=Math.floor(t),s=Math.floor(e/3600),n=Math.floor(e%3600/60),i=e%60;return s>0?`${s}:${String(n).padStart(2,"0")}:${String(i).padStart(2,"0")}`:`${n}:${String(i).padStart(2,"0")}`}function oe(t){return`kanau-ts-${t.channel||""}-${t.index||""}`}function K(t){try{return JSON.parse(localStorage.getItem(oe(t))||"null")||{}}catch{return{}}}function ht(t,e){try{localStorage.setItem(oe(t),JSON.stringify(e))}catch{}}function Me(t,e,s){let n=s[e],i=n!=null?`<button class="sv-ts-badge" data-idx="${e}" data-action="seek" title="${m(M(n))} \u306B\u79FB\u52D5">${m(M(n))}</button><button class="sv-ts-del" data-idx="${e}" data-action="del-ts" aria-label="\u30BF\u30A4\u30E0\u30B9\u30BF\u30F3\u30D7\u524A\u9664">\u2715</button>`:"",o=(S[e]||[]).map(d=>`<button class="sv-cts-badge" data-idx="${e}" data-action="cts-seek" data-cts-seconds="${d.timeSeconds}" title="\u307F\u3093\u306A\u306E\u30BF\u30A4\u30E0\u30B9\u30BF\u30F3\u30D7: ${m(M(d.timeSeconds))}">${m(M(d.timeSeconds))}</button>`).join(""),u=`<button class="sv-cts-propose" data-idx="${e}" data-action="cts-propose" type="button">+ \u63D0\u6848</button>`,p=`<div class="sv-cts-row">${o}${u}</div>`;return`<div class="sv-song" data-idx="${e}">
...
`).map(f=>f.trim()).filter(Boolean),r=0;for(let f of d){let b=Be(f);if(!b)continue;let h=Ye(b.title,b.artist,t.songs);if(h>=0){let w=o.querySelector(`[data-bulk-ts-idx="${h}"]`);w&&(w.value=b.start,r++)}}let v=o.querySelector(".sv-paste-result");v&&(v.textContent=r>0?`${d.length}\u884C\u3092\u89E3\u6790 \u2192 ${r}\u66F2\u306B\u5165\u529B\u3057\u307E\u3057\u305F`:"\u4E00\u81F4\u3059\u308B\u66F2\u304C\u898B\u3064\u304B\u308A\u307E\u305B\u3093\u3067\u3057\u305F",v.hidden=!1)}),o.querySelector(".sv-bulk-rows").addEventListener("click",p=>{let d=p.target.closest("[data-bulk-now]");if(!d)return;let r=parseInt(d.dataset.bulkNow,10),v=g?.getCurrentTime?.();if(v!=null){let f=o.querySelector(`[data-bulk-ts-idx="${r}"]`);f&&(f.value=M(Math.floor(v)))}}),o.querySelector("#sv-bulk-submit").addEventListener("click",async()=>{let p=o.querySelector("#sv-bulk-note").value.trim()||null,d=o.querySelector("#sv-bulk-status"),r=o.querySelector("#sv-bulk-submit"),v=[];if(o.querySelectorAll("[data-bulk-ts-idx]").forEach(h=>{let w=parseInt(h.dataset.bulkTsIdx,10),T=Et(h.value.trim());T!==null&&v.push({songIndex:w,timeSeconds:T})}),!v.length){d.textContent="\u30BF\u30A4\u30E0\u30B9\u30BF\u30F3\u30D7\u304C1\u3064\u3082\u5165\u529B\u3055\u308C\u3066\u3044\u307E\u305B\u3093",d.className="sv-cts-modal-status error",d.hidden=!1;return}r.disabled=!0,r.textContent=`\u7533\u8ACB\u4E2D\u2026 (0/${v.length})`,d.hidden=!0;let f=0,b=0;await Promise.all(v.map(async h=>{try{(await fetch(`/api/timestamps/${encodeURIComponent(t.channel)}/${t.index}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({songIndex:h.songIndex,timeSeconds:h.timeSeconds,submitterNote:p})})).ok?f++:b++}catch{b++}r.textContent=`\u7533\u8ACB\u4E2D\u2026 (${f+b}/${v.length})`})),b===0?(d.textContent=`${f}\u66F2\u5206\u306E\u30BF\u30A4\u30E0\u30B9\u30BF\u30F3\u30D7\u3092\u7533\u8ACB\u3057\u307E\u3057\u305F\uFF01\u5BE9\u67FB\u5F8C\u306B\u516C\u958B\u3055\u308C\u307E\u3059\u3002`,d.className="sv-cts-modal-status success",r.hidden=!0,o.querySelector(".sv-cts-modal-cancel").textContent="\u9589\u3058\u308B"):(d.textContent=`${f}\u4EF6\u6210\u529F / ${b}\u4EF6\u5931\u6557\u3002\u5931\u6557\u5206\u3092\u518D\u8A66\u884C\u3057\u3066\u304F\u3060\u3055\u3044\u3002`,d.className="sv-cts-modal-status error",r.disabled=!1,r.textContent="\u4E00\u62EC\u7533\u8ACB\u3059\u308B"),d.hidden=!1}),document.addEventListener("keydown",function p(d){d.key==="Escape"&&(u(),document.removeEventListener("keydown",p))})}function re(){try{return JSON.parse(localStorage.getItem("kanau-playlists")||"null")||[]}catch{return[]}}function He(t){try{localStorage.setItem("kanau-playlists",JSON.stringify(t))}catch{}}function Ne(t,e){let s=re(),n=s.find(i=>String(i.id)===String(t));return n?(n.streams||(n.streams=[]),n.streams.includes(e)||(n.streams.push(e),He(s)),!0):!1}function Ve(){let t=c.data?.streams||[],s=l("#stream-viewer")?._currentStream;if(!s)return;let n=t.findIndex(i=>i.channel===s.channel&&i.index===s.index);n<0||n>=t.length-1||B(t[n+1])}function zt(t,e){if(!t)return`<div class="sv-bp-nav-card sv-bp-nav-empty">${m(e==="newer"?"\u6700\u65B0\u914D\u4FE1":"\u6700\u521D\u306E\u914D\u4FE1")}</div>`;let s=kt(t.url),n=e==="newer"?"\u65B0\u3057\u3044\u914D\u4FE1 \u2192":"\u2190 \u53E4\u3044\u914D\u4FE1";return`<button class="sv-bp-nav-card" type="button" data-bp-action="open-stream" data-bp-channel="${m(t.channel)}" data-bp-index="${t.index}">
        ...
        <div class="sv-bp-autoplay-bar">
          <label class="sv-bp-ap-label" for="sv-ap-check">
            <span class="sv-bp-ap-switch${U?" sv-bp-ap-switch--on":""}">
              <input type="checkbox" id="sv-ap-check" class="sv-bp-ap-check"${U?" checked":""}>
  ...
  `,e.onchange=r=>{let v=r.target.closest("#sv-ap-check");if(!v)return;U=v.checked;let f=e.querySelector(".sv-bp-ap-switch");f&&f.classList.toggle("sv-bp-ap-switch--on",U)},e.onclick=r=>{let v=r.target.closest("[data-bp-action]");if(!v)return;let f=v.dataset.bpAction;if(f==="open-stream"){let b=v.dataset.bpChannel,h=parseInt(v.dataset.bpIndex,10),w=(c.data?.streams||[]).find(T=>T.channel===b&&T.index===h);w&&B(w)}else if(f==="add-pl"){let b=v.dataset.bpPlId;if(Ne(b,d)){v.classList.add("sv-bp-pl-btn--added"),v.disabled=!0;let h=v.querySelector(".sv-bp-pl-status");h&&(h.textContent="\u2713 \u767B\u9332\u6E08\u307F")}}}}function j(t,e,s){t.innerHTML=e.map((n,i)=>Me(n,i,s)).join("")}function Et(t){let e=t.match(/(\d+):(\d{2}):(\d{2})|(\d+):(\d{2})/);return e?e[1]!==void 0?parseInt(e[1])*3600+parseInt(e[2])*60+parseInt(e[3]):parseInt(e[4])*60+parseInt(e[5]):null}function Be(t){let e=t.match(/^(\d{1,2}:\d{2}(?::\d{2})?)[\s　]+(.+?)\s*\/\s*(.+?)[\s　]+(\d{1,2}:\d{2}(?::\d{2})?)$/);return e?{start:e[1].trim(),title:e[2].trim(),artist:e[3].trim(),end:e[4].trim()}:null}function et(t){return(t||"").toLowerCase().replace(/[\s　]/g,"").replace(/[！-～]/g,e=>String.fromCharCode(e.charCodeAt(0)-65248)).replace(/[・｡。、，,．.！!？?「」『』【】（）()]/g,"")}function Ye(t,e,s){let n=et(t),i=et(e),a=-1,o=0;for(let u=0;u<s.length;u++){let p=et(s[u].title),d=et(s[u].artist),r=0;p===n?r+=80:n.length>1&&(p.includes(n)||n.includes(p))&&(r+=40),i&&d===i?r+=20:i&&i.length>1&&(d.includes(i)||i.includes(d))&&(r+=10),r>o&&(o=r,a=u)}return o>=40?a:-1}function ce(){if(l("#stream-viewer"))return;let t=l("#panel-player");if(!t)return;let e=document.createElement("div");e.id="stream-viewer",e.hidden=!0,e.setAttribute("aria-label","\u914D\u4FE1\u30D7\u30EC\u30A4\u30E4\u30FC"),e.innerHTML=`
  ...
  `,t.appendChild(e),l("#sv-close").addEventListener("click",()=>O()),l("#sv-fullscreen-btn").addEventListener("click",Ce);let s=l("#sv-vol-slider"),n=l("#sv-vol-btn");if(s){let i=G();s.value=i,s.style.setProperty("--pct",`${i}%`),n&&(n.textContent=F(i)),s.addEventListener("input",a=>{let o=parseInt(a.target.value);if(a.target.style.setProperty("--pct",`${o}%`),bt(o),n&&(n.textContent=F(o)),g)try{g.setVolume(o)}catch{}})}if(n){let i=80;n.addEventListener("click",()=>{if(!s)return;let a=parseInt(s.value),o=a>0?0:i||80;a>0&&(i=a),Q(s,n,g,o),bt(o)})}e.querySelectorAll("[data-bc-tab]").forEach(i=>{i.addEventListener("click",()=>{J=i.dataset.bcTab,O()})}),l("#sv-import-toggle").addEventListener("click",()=>{let i=l("#sv-import-area");i&&(i.hidden=!i.hidden,i.hidden||l("#sv-import-input")?.focus())}),l("#sv-import-cancel").addEventListener("click",()=>{let i=l("#sv-import-area");i&&(i.hidden=!0);let a=l("#sv-import-input");a&&(a.value="")}),l("#sv-import-apply").addEventListener("click",()=>{let i=e._currentStream;if(!i)return;let a=l("#sv-import-input");if(!a)return;let u=a.value.split(`
`).map(r=>Et(r)).filter(r=>r!==null);if(!u.length)return;let p=K(i);u.forEach((r,v)=>{v<i.songs.length&&(p[v]=r)}),ht(i,p),j(l("#sv-setlist"),i.songs,p);let d=l("#sv-import-area");d&&(d.hidden=!0),a.value=""}),l("#sv-cts-bulk-btn").addEventListener("click",()=>{let i=e._currentStream;i&&De(i)}),l("#sv-setlist").addEventListener("click",i=>{let a=i.target.closest("[data-action]");if(!a)return;let o=parseInt(a.dataset.idx,10),u=e._currentStream;if(!u)return;let p=K(u);if(a.dataset.action==="seek"){if(p[o]!=null&&g?.seekTo){g.seekTo(p[o],!0);try{g.playVideo()}catch{}}}else if(a.dataset.action==="set-ts"){let d=g?.getCurrentTime?.();d!=null&&(p[o]=Math.floor(d),ht(u,p),j(l("#sv-setlist"),u.songs,p))}else if(a.dataset.action==="del-ts")delete p[o],ht(u,p),j(l("#sv-setlist"),u.songs,p);else if(a.dataset.action==="cts-seek"){let d=Number(a.dataset.ctsSeconds);if(!isNaN(d)&&g?.seekTo){g.seekTo(d,!0);try{g.playVideo()}catch{}}}else if(a.dataset.action==="cts-propose"){let d=u.songs[o];Ie(u,o,d?.title||`\u66F2 ${o+1}`)}})}function B(t,e=0){if(!t?.url)return;let s=z(t.url);if(!s){lt(t.url);return}ce(),xt();let n=l("#stream-viewer");if(n?.classList.contains("sv-minified")){if(n._currentStream?.url===t.url){if(ee(),e>0)try{g?.seekTo(Math.floor(e),!0),g?.playVideo()}catch{}return}$t()}let i=l("#yt-player-panel");if(i&&!i.hidden){try{y?.pauseVideo()}catch{}i.hidden=!0,ct()}if(E=null,import("./chunk-IRKL6VIF.js").then(h=>h.pauseMusicPlayer()).catch(()=>{}),x){x=!1;let h=l("#stream-viewer");h&&h.classList.remove("sv-fullscreen"),document.body.classList.remove("has-sv-fullscreen"),document.body.style.overflow=""}x=!1,le();let a=l("#stream-viewer");a.classList.remove("sv-fullscreen"),a.classList.toggle("sv-mv-mode",!!t.isMv),a._currentStream=t;let o=++A,u=a.querySelectorAll("[data-bc-tab]");u[1]&&(t.isMv?(u[1].dataset.bcTab="playlists",u[1].textContent="\u30D7\u30EC\u30A4\u30EA\u30B9\u30C8"):(u[1].dataset.bcTab="timeline",u[1].textContent="\u30BF\u30A4\u30E0\u30E9\u30A4\u30F3"));let p=l("#sv-bc-title");p&&(p.textContent=t.title||"\u914D\u4FE1");let d=l("#sv-stream-meta");d&&(d.textContent=t.isMv?"":`${$(t.date)}\u3000\u7B2C${t.index}\u67A0\u3000\u{1F3A4} ${t.songs.length}\u66F2`);let r=l("#sv-yt-link");r&&(r.href=t.url);let v=l("#sv-song-count");if(v&&(v.textContent=t.isMv?"":`${t.songs.length}\u66F2`),S={},t.isMv){let h=l("#sv-setlist");h&&(h.innerHTML="");let w=l("#sv-below-player");w&&(w.innerHTML="")}else{let h=K(t);j(l("#sv-setlist"),t.songs,h),Pe(t),qe(t)}a.hidden=!1,document.body.style.overflow="",setTimeout(()=>{l("#sv-close")?.focus({preventScroll:!0})},50),g=null;let f=l("#sv-player-wrap");f.innerHTML='<div class="sv-player-loading">\u8AAD\u307F\u8FBC\u307F\u4E2D\u2026</div>';let b=Math.floor(e);ae(()=>{if(o!==A||a.hidden)return;f.innerHTML="";let h=document.createElement("div");f.appendChild(h);try{g=new window.YT.Player(h,{videoId:s,width:"100%",height:"100%",playerVars:{autoplay:1,playsinline:1,rel:0,modestbranding:1,...b>0?{start:b}:{}},events:{onReady:w=>{let T=G();try{w.target.setVolume(T)}catch{}Q(l("#sv-vol-slider"),l("#sv-vol-btn"),null,T);try{w.target.setPlaybackQuality("hd1080")}catch{}try{w.target.setPlaybackQualityRange("hd720","hd1080")}catch{}if(b>5)try{w.target.seekTo(b,!0)}catch{}},onStateChange:w=>{if(o===A){if(w.data===window.YT.PlayerState.PLAYING)try{w.target.setPlaybackQuality("hd1080")}catch{}w.data===window.YT.PlayerState.ENDED&&U&&!a.classList.contains("sv-minified")&&Ve()}},onError:()=>{o===A&&(f.innerHTML=`<iframe src="https://www.youtube.com/embed/${m(s)}?autoplay=1&playsinline=1&rel=0${b>0?`&start=${b}`:""}" allow="autoplay; encrypted-media; picture-in-picture" allowfullscreen></iframe>`)}}})}catch{f.innerHTML=`<iframe src="https://www.youtube.com/embed/${m(s)}?autoplay=1&playsinline=1&rel=0${b>0?`&start=${b}`:""}" allow="autoplay; encrypted-media; picture-in-picture" allowfullscreen></iframe>`}})}function O(){let t=l("#stream-viewer");if(!t||t.hidden||t.classList.contains("sv-minified"))return;if(x){x=!1,t.classList.remove("sv-fullscreen"),document.body.classList.remove("has-sv-fullscreen"),document.body.style.overflow="";let s=l("#sv-close");s&&(s.title="\u30DF\u30CB\u30D7\u30EC\u30A4\u30E4\u30FC\u3067\u518D\u751F\u3092\u7D9A\u3051\u306A\u304C\u3089\u623B\u308A\u307E\u3059\uFF08Esc\uFF09");let n=l("#sv-fullscreen-btn");n&&n.setAttribute("aria-pressed","false");return}if(_e())return;++A,t.hidden=!0,t._currentStream=null,g=null;let e=l("#sv-player-wrap");e&&(e.innerHTML=""),document.body.style.overflow="",Tt()}window.__openStreamViewer=B;function de(t){let e=nt(t),s=l("#song-modal"),n=l("#song-modal-body"),i=l("#song-modal-title");if(!e||!s||!n||!i)return;It(e),i.textContent=e.title;let a=(e.streamRefs||[]).slice(0,8).map(p=>({...p,thumbnail:kt(p.url),thumbnailFallback:xe(p.url),thumbnailTiny:Te(p.url),detailKey:N(p)})),o=[e.genre,...e.seasonTags||[],...e.moodTags||[],...e.singerTags||[]].filter(Boolean),u=ut(e.key);n.innerHTML=`
...
`).map(o=>m(o)).join("<br>")}</p>`:"",a=e.links?.length?`
    ...
    </div>`}function Ge(t){let e=l("#ch-modal"),s=l("#ch-modal-body");if(!e||!s)return;let n="";t==="new"?n=st("new"):t==="old"?n=st("old"):n=st("new")+st("old"),s.innerHTML=n,e.hidden=!1,l("#ch-modal-close")?.focus()}function Qe(){let t=l("#ch-modal"),e=l("#ch-modal-close");if(!t||!e)return;let s=()=>{t.hidden=!0};e.addEventListener("click",s),t.addEventListener("click",n=>{n.target===t&&s()}),document.querySelectorAll("[data-ch-modal]").forEach(n=>{n.addEventListener("click",()=>Ge(n.dataset.chModal))})}function Je(){let t=l("#help-modal"),e=l("#help-btn"),s=l("#help-close");if(!t||!e||!s)return;let n=()=>{t.hidden=!1,s.focus()},i=()=>{t.hidden=!0,e.focus()};e.addEventListener("click",n),s.addEventListener("click",i),t.addEventListener("click",a=>{a.target===t&&i()}),document.addEventListener("keydown",a=>{a.key==="Escape"&&!t.hidden&&i()})}function Ze(){let t=l("#welcome-tip"),e=l("#welcome-close");if(!t||!e||window.matchMedia("(max-width: 760px)").matches||localStorage.getItem("kanau-welcome-tip-dismissed")==="1")return;let s=()=>{t.hidden=!1};"requestIdleCallback"in window?window.requestIdleCallback(s,{timeout:5e3}):window.setTimeout(s,2500),e.addEventListener("click",()=>{t.hidden=!0,localStorage.setItem("kanau-welcome-tip-dismissed","1")})}async function _t(){je();try{let t=await Dt();c.channelData=t,!q&&!t.fullLoaded&&Xt();let e=mt();c.songsQuery=e.q,c.activeTab=it(e.tab)?e.tab:"dashboard",Wt(c.activeTab);let s=e.channel||c.channel||Y;if(P(s)||(s=Y),!P(s)){let n=Object.keys(t.channels)[0];n&&(s=n)}if(!P(s))throw new Error("No channel data could be loaded");ke(),Fe(),rt(s,{resetSearch:!1,updateUrl:!1,autoLoad:!0,initial:!0})}catch(t){console.error("[init] failed:",t),Ke(t)}}function Xe(){if(!c.channelData)return;let t=mt();c.songsQuery=t.q,t.channel!==c.channel&&P(t.channel)&&rt(t.channel,{resetSearch:!1,updateUrl:!1}),H(t.tab,{updateUrl:!1})}L(".tab-btn").forEach(t=>{t.addEventListener("click",()=>{let e=t.dataset.tab,s=l("#stream-viewer");if(e!=="player"&&s&&!s.hidden&&!x&&!s.classList.contains("sv-minified")){J=e,O();return}H(e)})});L(".ch-btn").forEach(t=>{t.addEventListener("click",()=>{t.dataset.channel&&(t.disabled||rt(t.dataset.channel))})});window.addEventListener("popstate",Xe);L("[data-audience]").forEach(t=>{t.addEventListener("click",()=>ye(t.dataset.audience))});document.body.addEventListener("click",t=>{let e=t.target.closest("[data-artist-search]");if(e){t.preventDefault(),t.stopPropagation(),wt(e.dataset.artistSearch||e.textContent||"");return}let s=t.target.closest("[data-playlist-add]");if(s){t.preventDefault(),t.stopPropagation();let o=s.dataset.playlistAdd,u=s.dataset.streamTitle||"";import("./chunk-BWTSGM2I.js").then(p=>p.showAddToPlaylistModal(o,u));return}let n=t.target.closest("[data-stream-play]");if(n){t.preventDefault(),t.stopPropagation();let o=n.dataset.streamPlay,u=(c.data?.streams||[]).find(p=>N(p)===o);u?.url?B(u):n.dataset.inlineYoutube&&lt(n.dataset.inlineYoutube);return}let i=t.target.closest("[data-inline-youtube]");if(i){t.preventDefault(),t.stopPropagation(),lt(i.dataset.inlineYoutube);return}if(Pt(t.target))return;let a=t.target.closest("[data-songkey]");a&&de(a.dataset.songkey)});l("#retry-btn").addEventListener("click",_t);l("#reload-btn").addEventListener("click",_t);Je();Qe();St();ce();Re();ge();we();Ze();import("./chunk-IRKL6VIF.js").then(t=>{t.setApiLoader(xt),t.initMusicPlayer()}).catch(()=>{});Rt(t=>{t.type==="song"?de(t.song.key):t.type==="artist"?wt(t.artist):t.type==="stream"&&B(t.stream)});document.addEventListener("keydown",t=>{let e=document.activeElement?.tagName,s=e==="INPUT"||e==="TEXTAREA"||e==="SELECT";if(t.key==="/"&&!s&&!t.metaKey&&!t.ctrlKey||t.key==="k"&&(t.ctrlKey||t.metaKey)&&!t.shiftKey){t.preventDefault(),Ut();return}if(t.key==="t"&&!s&&!t.metaKey&&!t.ctrlKey){t.preventDefault(),Nt();return}if(t.key==="?"&&!s&&!t.metaKey&&!t.ctrlKey){t.preventDefault();let i=l("#help-modal");i&&i.hidden&&(i.hidden=!1,l("#help-close")?.focus());return}if(t.key==="Escape"&&!t.metaKey&&!t.ctrlKey){let i=l("#stream-viewer"),a=!!l("#panel-player.active");if(i&&!i.hidden&&(x||a)){t.preventDefault(),O();return}if(jt()){t.preventDefault(),R();return}let o=l("#song-modal");if(o&&!o.hidden)return;let u=l("#ch-modal");if(u&&!u.hidden){u.hidden=!0;return}let p=l("#help-modal");if(p&&!p.hidden){p.hidden=!0,l("#help-btn")?.focus();return}let d=l("#songs-search");d&&document.activeElement===d&&d.value&&(t.preventDefault(),d.value="",d.dispatchEvent(new Event("input",{bubbles:!0})))}});qt(()=>{c.data&&(vt(),(c.activeTab==="dashboard"||c.activeTab==="analytics")&&D())});function We(){_t()}We();

import{b as Nt,c as Vt,d as qt,i as Bt,k as Lt,l as at}from"./chunk-3QAEH344.js";import{a as Yt,b as Rt,e as $t,f as Ut}from"./chunk-SIADDXVK.js";import{a as K}from"./chunk-MKJIXTK4.js";import{a as At,b as wt,c as Dt,e as d}from"./chunk-N3S3MIXU.js";import{D as kt,E as T,G as q,L as A,M as Ht,a as l,b as S,d as m}from"./chunk-FKVR6ZKV.js";var $=-1,C=[],St=null;function Kt(t){St=t;let e=document.createElement("div");e.id="omni-backdrop",e.hidden=!0,e.setAttribute("role","dialog"),e.setAttribute("aria-modal","true"),e.setAttribute("aria-label","\u30B5\u30A4\u30C8\u5185\u691C\u7D22"),e.innerHTML=`
  ...
  `,document.body.appendChild(e),e.addEventListener("click",s=>{s.target===e&&O()});let n=document.getElementById("omni-input");n.addEventListener("input",()=>Qt(n.value)),n.addEventListener("keydown",ue),document.getElementById("omni-listbox").addEventListener("click",s=>{let i=s.target.closest("[data-omni-idx]");i&&zt(Number(i.dataset.omniIdx))})}function Ot(){let t=document.getElementById("omni-backdrop");if(!t)return;t.hidden=!1,$=-1,C=[];let e=document.getElementById("omni-input");e&&(e.value="",e.focus(),e.select()),Qt("")}function O(){let t=document.getElementById("omni-backdrop");t&&(t.hidden=!0),$=-1}function Gt(){let t=document.getElementById("omni-backdrop");return!!(t&&!t.hidden)}function ue(t){let e=document.querySelectorAll("#omni-listbox [data-omni-idx]");t.key==="ArrowDown"?(t.preventDefault(),$=Math.min($+1,e.length-1),jt(e)):t.key==="ArrowUp"?(t.preventDefault(),$=Math.max($-1,-1),jt(e)):t.key==="Enter"?(t.preventDefault(),$>=0&&C[$]&&zt($)):t.key==="Escape"&&(t.preventDefault(),O())}function jt(t){t.forEach((e,n)=>{e.classList.toggle("is-active",n===$),e.setAttribute("aria-selected",String(n===$))}),$>=0&&t[$]?.scrollIntoView({block:"nearest"})}function zt(t){let e=C[t];!e||!St||(O(),St(e))}function Qt(t){let e=document.getElementById("omni-listbox");if(!e)return;$=-1,C=[];let n=d.data?.songs||[],s=d.data?.streams||[],i=t.trim().toLowerCase(),a="",o=0;if(!d.data){e.innerHTML='<div class="omni-empty">\u30C7\u30FC\u30BF\u8AAD\u307F\u8FBC\u307F\u4E2D\u2026</div>';return}if(!i){let r=n.slice(0,8);if(r.length){a+=it("\u{1F3C6} \u3088\u304F\u6B4C\u308F\u308C\u308B\u66F2");for(let v of r)C.push({type:"song",song:v}),a+=Ft(v,o++,"")}e.innerHTML=a||'<div class="omni-empty">\u691C\u7D22\u30EF\u30FC\u30C9\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044</div>';return}let p=n.filter(r=>B(r.title).includes(i)||B(r.artist).includes(i)).slice(0,8);if(p.length){a+=it("\u{1F3B5} \u66F2");for(let r of p)C.push({type:"song",song:r}),a+=Ft(r,o++,i)}let u=new Set,c=[];for(let r of n)if(B(r.artist).includes(i)&&!u.has(r.artist)&&(u.add(r.artist),c.push(r.artist),c.length>=4))break;if(c.length){a+=it("\u{1F3A4} \u30A2\u30FC\u30C6\u30A3\u30B9\u30C8");for(let r of c){let v=n.filter(f=>f.artist===r).length;C.push({type:"artist",artist:r}),a+=`<div class="omni-item" role="option" aria-selected="false" data-omni-idx="${o++}">
        <span class="omni-item-icon">\u{1F3A4}</span>
        <div class="omni-item-body">
          <span class="omni-item-title">${lt(m(r),i)}</span>
          <span class="omni-item-meta">${v}\u66F2 \xB7 \u30A2\u30FC\u30C6\u30A3\u30B9\u30C8\u7D5E\u308A\u8FBC\u307F</span>
        </div>
      </div>`}}if(s.length){let r=s.filter(v=>B(v.title).includes(i)||v.songs?.some(f=>B(f.title).includes(i)||B(f.artist).includes(i))).slice(0,5);if(r.length){a+=it("\u{1F4C5} \u914D\u4FE1\u67A0");for(let v of r){C.push({type:"stream",stream:v});let f=v.channel==="new"?"\u65B0ch":v.channel==="old"?"\u65E7ch":"";a+=`<div class="omni-item" role="option" aria-selected="false" data-omni-idx="${o++}">
          <span class="omni-item-icon">\u{1F4C5}</span>
          <div class="omni-item-body">
            <span class="omni-item-title">${lt(m(v.title||"\u914D\u4FE1"),i)}</span>
            <span class="omni-item-meta">${T(v.date)}${f?" \xB7 "+f:""} \xB7 ${v.songs?.length||0}\u66F2 \xB7 \u30AF\u30EA\u30C3\u30AF\u3067\u518D\u751F</span>
          </div>
        </div>`}}}a||(a=`<div class="omni-empty">\u300C${m(t)}\u300D\u306B\u4E00\u81F4\u3059\u308B\u7D50\u679C\u304C\u3042\u308A\u307E\u305B\u3093 \u{1F420}</div>`),e.innerHTML=a}function it(t){return`<div class="omni-section-label" role="presentation">${t}</div>`}function Ft(t,e,n){return`<div class="omni-item" role="option" aria-selected="false" data-omni-idx="${e}">
    <span class="omni-item-icon">\u{1F3B5}</span>
    <div class="omni-item-body">
      <span class="omni-item-title">${lt(m(t.title),n)}</span>
      <span class="omni-item-meta">${lt(m(t.artist||""),n)} \xB7 ${t.count}\u56DE\u6B4C\u5531</span>
    </div>
    <span class="omni-item-count">${t.count}<small>\u56DE</small></span>
  </div>`}function B(t){return String(t||"").toLowerCase()}function lt(t,e){if(!e)return t;let s=t.toLowerCase().indexOf(e);return s<0?t:t.slice(0,s)+'<mark class="hl">'+t.slice(s,s+e.length)+"</mark>"+t.slice(s+e.length)}Rt();Dt();var te={dashboard:()=>import("./chunk-NX4KOKQI.js").then(t=>t.renderDashboard),ranking:()=>import("./chunk-AOWB3BNY.js").then(t=>t.renderRanking),songs:()=>import("./chunk-EQQ27U7N.js").then(t=>t.renderSongs),timeline:()=>import("./chunk-4GOYTJ2B.js").then(t=>t.renderTimeline),analytics:()=>import("./chunk-QEXZHCSH.js").then(t=>t.renderAnalytics),playlists:()=>import("./chunk-BWTSGM2I.js").then(t=>t.renderPlaylists)},ot=new Map,Jt=0,Y=null;function vt(t){return Object.prototype.hasOwnProperty.call(te,t)}async function pe(t){ot.has(t)||ot.set(t,te[t]());try{return await ot.get(t)}catch(e){throw ot.delete(t),e}}function ee(t){return["dashboard","timeline","analytics"].includes(t)}function ve(t,e={}){let n=l(`#panel-${t}`);if(!n)return;let s={dashboard:"\u30C0\u30C3\u30B7\u30E5\u30DC\u30FC\u30C9\u8A73\u7D30",ranking:"\u30E9\u30F3\u30AD\u30F3\u30B0",songs:"\u66F2\u30EA\u30B9\u30C8",timeline:"\u914D\u4FE1\u30BF\u30A4\u30E0\u30E9\u30A4\u30F3",analytics:"\u30A2\u30CA\u30EA\u30C6\u30A3\u30AF\u30B9"};n.innerHTML=`
  ...
  `)}function fe(t){if(d.channelData?.fullLoaded)return;d.channelData=t;let e=M(d.channel)?d.channel:K,n=M(e);n&&(d.data=n),!ee(d.activeTab)&&d.data&&H(d.activeTab,{autoLoad:!1})}function he(t){d.channelData=t,d.channelData.fullLoaded=!0;let e=M(d.channel)?d.channel:K;yt(e,{resetSearch:!1,updateUrl:!1,render:!1}),H(d.activeTab,{autoLoad:!1})}function ne(){return Y=Vt({meta:d.channelData,onSongsReady:fe}).then(he).finally(()=>{Y=null}),Y}async function be(){d.channelData?.fullLoaded||(Y||ne(),await Y)}async function H(t=d.activeTab,e={}){if(t!=="playlists"&&(!d.data||!vt(t))||!vt(t))return;let n=d.channelData?.partialLoaded||d.channelData?.fullLoaded,s=d.channelData?.fullLoaded;if(t==="playlists"?!1:ee(t)?!s:!n)if(e.autoLoad){me(t);try{await be()}catch(o){console.error("[data] full load failed",o);let p=l(`#panel-${t}`);p&&(p.innerHTML=`
            <div class="state-card">
          ...
          `,p.querySelector("[data-load-full-data]")?.addEventListener("click",()=>{H(t,{autoLoad:!0})}));return}}else{ve(t,{initial:e.initial});return}let a=++Jt;try{let o=await pe(t);if(a!==Jt||t!==d.activeTab||!d.data)return;t==="songs"&&Bt(d.data.songs||[]),o()}catch(o){console.error(`[${t}] render failed`,o);let p=l(`#panel-${t}`);p&&(p.innerHTML=`
        <div class="state-card">
          <div class="msg">\u8868\u793A\u306B\u5931\u6557\u3057\u307E\u3057\u305F</div>
          <div class="err-detail">${m(o?.message||String(o))}</div>
        </div>
      `)}}function N(t,e={}){vt(t)||(t="dashboard");let n=l("#stream-viewer");if(t!=="player"&&n&&!n.hidden&&!E){nt=t,bt=e,et({instant:!0});return}d.activeTab=t,se(t),e.updateUrl!==!1&&at({tab:t}),H(t,{autoLoad:e.autoLoad!==!1,initial:!!e.initial})}function se(t){S(".tab-btn").forEach(e=>e.classList.toggle("active",e.dataset.tab===t)),S(".panel").forEach(e=>e.classList.toggle("active",e.id===`panel-${t}`))}function M(t){return d.channelData?t==="all"?d.channelData.combined:d.channelData.channels[t]||null:null}function yt(t,e={}){let n=M(t);n&&(d.channel=t,Oe(t),d.data=n,d.timelineFilter=null,d.timelineFocus=null,d.timelineLimit=12,d.songsLimit=100,e.resetSearch!==!1&&(d.songsQuery="",d.songsGenre="all"),$t(),S("#channel-switch [data-channel]").forEach(s=>s.classList.toggle("active",s.dataset.channel===t)),_t(),e.updateUrl!==!1&&at({tab:d.activeTab,channel:t,q:d.songsQuery}),Ue(),e.render!==!1&&H(d.activeTab,{autoLoad:e.autoLoad!==!1,initial:!!e.initial}))}function ye(t,e={}){d.audience=t==="singer"?"singer":"listener",d.singerMode=d.audience==="singer",d.singerMode||(d.singerPreset="all"),S(".audience-switch [data-audience]").forEach(n=>{n.classList.toggle("active",n.dataset.audience===d.audience)}),document.body.dataset.audience=d.audience,_t(),d.audience==="singer"?(d.songsLimit=100,N("songs",{autoLoad:e.autoLoad!==!1})):d.data&&H(d.activeTab,{autoLoad:e.autoLoad!==!1,initial:!!e.initial})}function _t(){let t=l("#mobile-menu-label");if(!t)return;let e=l("#channel-switch [data-channel].active")?.textContent?.trim()||"\u65B0ch",n=l("#audience-switch [data-audience].active")?.textContent?.trim()||"\u30EA\u30B9\u30CA\u30FC";t.textContent=`${e} / ${n}`}function ge(){let t=l("#mobile-menu-toggle"),e=l("#mobile-menu-state"),n=l("#topbar-actions");if(!t||!e||!n)return;let s=a=>{e.checked=a,n.classList.toggle("is-open",a),t.setAttribute("aria-expanded",String(a))},i=()=>{s(!1),t.focus()};t.addEventListener("click",a=>{a.stopPropagation(),requestAnimationFrame(()=>s(e.checked))}),t.addEventListener("keydown",a=>{a.key!=="Enter"&&a.key!==" "||(a.preventDefault(),s(!e.checked))}),e.addEventListener("change",()=>{s(e.checked)}),document.addEventListener("click",a=>{n.classList.contains("is-open")&&(a.target.closest("#topbar-actions")||a.target.closest("#mobile-menu-toggle")||a.target.closest("#mobile-menu-state")||i())}),document.addEventListener("keydown",a=>{a.key==="Escape"&&i()}),n.addEventListener("click",a=>{a.stopPropagation()}),_t()}function we(){let t=l("#page-top-toast");if(!t)return;let e=t.querySelector("img[data-src]"),n=!1,s=420,i=()=>{!e||e.src||(e.src=e.dataset.src||"")},a=()=>{n=!1;let p=window.scrollY>s;p&&i(),t.hidden=!p,t.classList.toggle("is-visible",p),t.setAttribute("aria-hidden",String(!p)),t.tabIndex=p?0:-1},o=()=>{n||(n=!0,requestAnimationFrame(a))};t.hidden=!0,t.setAttribute("aria-hidden","true"),t.tabIndex=-1,t.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})}),window.addEventListener("scroll",o,{passive:!0}),a()}function ke(){if(d.channelData)for(let t of S("#channel-switch [data-channel]")){let e=t.dataset.channel,n=e==="all"?!!d.channelData.combined:!!(d.channelData.channels&&d.channelData.channels[e]);t.disabled=!n,n?t.removeAttribute("title"):t.title="\u30C7\u30FC\u30BF\u3092\u53D6\u5F97\u3067\u304D\u307E\u305B\u3093\u3067\u3057\u305F"}}function $e({key:t,title:e,artist:n}){d.timelineFilter&&d.timelineFilter.key===t&&d.activeTab==="timeline"?d.timelineFilter=null:d.timelineFilter={key:t,title:e,artist:n},d.timelineFocus=null,d.timelineLimit=12,N("timeline"),l("#panel-timeline").scrollIntoView({behavior:"smooth",block:"start"})}function Le(t,e){d.timelineFilter={key:t.key,title:t.title,artist:t.artist},d.timelineFocus=q(e),d.timelineLimit=9999,N("timeline"),l("#panel-timeline").scrollIntoView({behavior:"smooth",block:"start"})}function Se(t){Ct(t.artist||"")}function Ct(t){let e=String(t||"").replace(/"/g,"");d.songsQuery=e?`artist:"${e}"`:"",d.songsLimit=100,at({tab:"songs",q:d.songsQuery}),N("songs",{updateUrl:!1})}function dt(t){return(d.data?.songs||[]).find(e=>e.key===t)||null}function D(t){let e=String(t||""),n=[/youtu\.be\/([A-Za-z0-9_-]{11})/,/youtube\.com\/watch\?[^#]*v=([A-Za-z0-9_-]{11})/,/youtube\.com\/live\/([A-Za-z0-9_-]{11})/,/youtube\.com\/shorts\/([A-Za-z0-9_-]{11})/,/youtube\.com\/embed\/([A-Za-z0-9_-]{11})/];for(let s of n){let i=e.match(s);if(i)return i[1]}return""}function Pt(t){let e=D(t);return e?`https://i.ytimg.com/vi/${e}/hqdefault.jpg`:""}function Te(t){let e=D(t);return e?`https://i.ytimg.com/vi/${e}/mqdefault.jpg`:""}function xe(t){let e=D(t);return e?`https://i.ytimg.com/vi/${e}/default.jpg`:""}function ae(){ut&&(clearInterval(ut),ut=null)}function xt(){ae(),ut=setInterval(()=>{if(y)try{let t=y.getDuration?.()||0,e=y.getCurrentTime?.()||0,n=t>0?Math.min(e/t*100,100):0,s=l("#yt-mini-progress-fill");s&&(s.style.width=`${n}%`);let a=y.getPlayerState?.()===window.YT?.PlayerState?.PLAYING,o=l("#yt-mini-play");o&&o.setAttribute("data-playing",a?"1":"0")}catch{}},400)}function Z(){if(ae(),y){try{y.destroy()}catch{}y=null}let t=l("#yt-player-container");t&&(t.innerHTML="")}function Ee(){if(y?.getCurrentTime)try{return y.getCurrentTime()}catch{}return Math.max(0,G+(Date.now()-z)/1e3)}function mt(t,e=0,n=""){let s=D(t);if(!s)return;if(window.matchMedia("(max-width: 600px)").matches){window.open(String(t||""),"_blank","noopener");return}{let u=l("#stream-viewer");if(u&&!u.hidden&&!E){++L,u.hidden=!0,u._currentStream=null,w=null;let c=l("#sv-player-wrap");c&&(c.innerHTML=""),document.body.style.overflow="",_=null,bt={},pt()}}X(),ft();let i=l("#yt-player-container"),a=l("#yt-player-panel");if(!i||!a)return;Z();let o=l("#yt-mini-title");o&&(o.textContent=n||"\u30A4\u30F3\u30E9\u30A4\u30F3\u518D\u751F");let p=l("#yt-mini-hint");p&&(p.textContent=_?"\u25B2 \u30BF\u30C3\u30D7\u3057\u3066\u914D\u4FE1\u30D3\u30E5\u30FC\u30EF\u30FC\u3078\u623B\u308B":""),a.classList.toggle("has-stream",!!_),a.hidden=!1,ht(()=>{let u=document.createElement("div");i.appendChild(u);try{y=new window.YT.Player(u,{videoId:s,width:"100%",height:"100%",playerVars:{autoplay:1,playsinline:1,rel:0,controls:0,disablekb:1,modestbranding:1,...e>0?{start:Math.floor(e)}:{}},events:{onReady:c=>{let r=R();try{c.target.setVolume(r)}catch{}if(U(l("#yt-mini-vol-slider"),l("#yt-mini-vol-btn"),null,r),e>5)try{c.target.seekTo(e,!0)}catch{}xt()},onStateChange:c=>{let r=c.data===window.YT.PlayerState.PLAYING,v=l("#yt-mini-play");v&&v.setAttribute("data-playing",r?"1":"0")}}})}catch{let r=e>0?`&start=${Math.floor(e)}`:"";i.innerHTML=`<iframe src="https://www.youtube.com/embed/${s}?autoplay=1&playsinline=1${r}" frameborder="0" allowfullscreen allow="autoplay; encrypted-media; picture-in-picture"></iframe>`}})}function ft(){if(l("#yt-player-panel"))return;let t=document.createElement("div");t.id="yt-player-panel",t.hidden=!0,t.innerHTML=`
  ...
  `,document.body.appendChild(t),l("#yt-player-close").addEventListener("click",()=>{t.hidden=!0,Z(),_=null}),l("#yt-mini-play").addEventListener("click",()=>{if(y)try{y.getPlayerState?.()===window.YT?.PlayerState?.PLAYING?y.pauseVideo():y.playVideo()}catch{}}),l("#yt-mini-restore").addEventListener("click",()=>{_&&j(_,Ee())}),l("#yt-mini-progress-bar").addEventListener("click",s=>{if(!y)return;let a=s.currentTarget.getBoundingClientRect(),o=Math.max(0,Math.min(1,(s.clientX-a.left)/a.width));try{let p=y.getDuration?.()||0;p>0&&y.seekTo(o*p,!0)}catch{}});let e=l("#yt-mini-vol-slider"),n=l("#yt-mini-vol-btn");if(e){let s=R();e.value=s,e.style.setProperty("--pct",`${s}%`),n&&(n.textContent=W(s)),e.addEventListener("input",i=>{let a=parseInt(i.target.value);if(i.target.style.setProperty("--pct",`${a}%`),Et(a),n&&(n.textContent=W(a)),y)try{y.setVolume(a)}catch{}})}if(n){let s=80;n.addEventListener("click",()=>{if(!e)return;let i=parseInt(e.value),a=i>0?0:s||80;i>0&&(s=i),U(e,n,y,a)})}}var ie=!1,le=[];window.onYouTubeIframeAPIReady=()=>{ie=!0,le.splice(0).forEach(t=>t()),import("./chunk-IRKL6VIF.js").then(t=>t.notifyYtReady()).catch(()=>{})};function X(){if(document.getElementById("yt-iframe-api-script"))return;let t=document.createElement("script");t.id="yt-iframe-api-script",t.src="https://www.youtube.com/iframe_api",document.head.appendChild(t)}function ht(t){if(ie&&window.YT?.Player){t();return}le.push(t)}var R=()=>Math.max(0,Math.min(100,parseInt(localStorage.getItem("kanaVol")??"100")||100)),Et=t=>localStorage.setItem("kanaVol",String(t)),W=t=>t===0?"\u{1F507}":t<50?"\u{1F509}":"\u{1F50A}";function U(t,e,n,s){if(t&&(t.value=s,t.style.setProperty("--pct",`${s}%`)),e&&(e.textContent=W(s)),n)try{n.setVolume(s)}catch{}}var w=null,L=0,_=null,G=0,z=0,E=!1,nt="timeline",bt={},x={},Q=!1,y=null,ut=null;function _e(){nt=d.activeTab||"timeline",d.activeTab="player",S(".tab-btn").forEach(t=>t.classList.remove("active")),S(".panel").forEach(t=>t.classList.toggle("active",t.id==="panel-player"))}function pt(){let t=bt;bt={},N(nt||"timeline",t)}function Ce(){E=!0;let t=l("#stream-viewer");if(!t)return;t.classList.add("sv-fullscreen"),document.body.classList.add("has-sv-fullscreen"),document.body.style.overflow="hidden";let e=l("#sv-close");e&&(e.title="\u901A\u5E38\u8868\u793A\u306B\u623B\u308B\uFF08Esc\uFF09");let n=l("#sv-fullscreen-btn");n&&n.setAttribute("aria-pressed","true")}function P(t){let e=Math.floor(t),n=Math.floor(e/3600),s=Math.floor(e%3600/60),i=e%60;return n>0?`${n}:${String(s).padStart(2,"0")}:${String(i).padStart(2,"0")}`:`${s}:${String(i).padStart(2,"0")}`}function oe(t){return`kanau-ts-${t.channel||""}-${t.index||""}`}function tt(t){try{return JSON.parse(localStorage.getItem(oe(t))||"null")||{}}catch{return{}}}function Tt(t,e){try{localStorage.setItem(oe(t),JSON.stringify(e))}catch{}}function Pe(t,e,n){let s=n[e],i=s!=null?`<button class="sv-ts-badge" data-idx="${e}" data-action="seek" title="${m(P(s))} \u306B\u79FB\u52D5">${m(P(s))}</button><button class="sv-ts-del" data-idx="${e}" data-action="del-ts" aria-label="\u30BF\u30A4\u30E0\u30B9\u30BF\u30F3\u30D7\u524A\u9664">\u2715</button>`:"",o=(x[e]||[]).map(c=>`<button class="sv-cts-badge" data-idx="${e}" data-action="cts-seek" data-cts-seconds="${c.timeSeconds}" title="\u307F\u3093\u306A\u306E\u30BF\u30A4\u30E0\u30B9\u30BF\u30F3\u30D7: ${m(P(c.timeSeconds))}">${m(P(c.timeSeconds))}</button>`).join(""),p=`<button class="sv-cts-propose" data-idx="${e}" data-action="cts-propose" type="button">+ \u63D0\u6848</button>`,u=`<div class="sv-cts-row">${o}${p}</div>`;return`<div class="sv-song" data-idx="${e}">
...
`).map(f=>f.trim()).filter(Boolean),r=0;for(let f of c){let h=Be(f);if(!h)continue;let b=Ye(h.title,h.artist,t.songs);if(b>=0){let g=o.querySelector(`[data-bulk-ts-idx="${b}"]`);g&&(g.value=h.start,r++)}}let v=o.querySelector(".sv-paste-result");v&&(v.textContent=r>0?`${c.length}\u884C\u3092\u89E3\u6790 \u2192 ${r}\u66F2\u306B\u5165\u529B\u3057\u307E\u3057\u305F`:"\u4E00\u81F4\u3059\u308B\u66F2\u304C\u898B\u3064\u304B\u308A\u307E\u305B\u3093\u3067\u3057\u305F",v.hidden=!1)}),o.querySelector(".sv-bulk-rows").addEventListener("click",u=>{let c=u.target.closest("[data-bulk-now]");if(!c)return;let r=parseInt(c.dataset.bulkNow,10),v=w?.getCurrentTime?.();if(v!=null){let f=o.querySelector(`[data-bulk-ts-idx="${r}"]`);f&&(f.value=P(Math.floor(v)))}}),o.querySelector("#sv-bulk-submit").addEventListener("click",async()=>{let u=o.querySelector("#sv-bulk-note").value.trim()||null,c=o.querySelector("#sv-bulk-status"),r=o.querySelector("#sv-bulk-submit"),v=[];if(o.querySelectorAll("[data-bulk-ts-idx]").forEach(b=>{let g=parseInt(b.dataset.bulkTsIdx,10),k=Mt(b.value.trim());k!==null&&v.push({songIndex:g,timeSeconds:k})}),!v.length){c.textContent="\u30BF\u30A4\u30E0\u30B9\u30BF\u30F3\u30D7\u304C1\u3064\u3082\u5165\u529B\u3055\u308C\u3066\u3044\u307E\u305B\u3093",c.className="sv-cts-modal-status error",c.hidden=!1;return}r.disabled=!0,r.textContent=`\u7533\u8ACB\u4E2D\u2026 (0/${v.length})`,c.hidden=!0;let f=0,h=0;await Promise.all(v.map(async b=>{try{(await fetch(`/api/timestamps/${encodeURIComponent(t.channel)}/${t.index}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({songIndex:b.songIndex,timeSeconds:b.timeSeconds,submitterNote:u})})).ok?f++:h++}catch{h++}r.textContent=`\u7533\u8ACB\u4E2D\u2026 (${f+h}/${v.length})`})),h===0?(c.textContent=`${f}\u66F2\u5206\u306E\u30BF\u30A4\u30E0\u30B9\u30BF\u30F3\u30D7\u3092\u7533\u8ACB\u3057\u307E\u3057\u305F\uFF01\u5BE9\u67FB\u5F8C\u306B\u516C\u958B\u3055\u308C\u307E\u3059\u3002`,c.className="sv-cts-modal-status success",r.hidden=!0,o.querySelector(".sv-cts-modal-cancel").textContent="\u9589\u3058\u308B"):(c.textContent=`${f}\u4EF6\u6210\u529F / ${h}\u4EF6\u5931\u6557\u3002\u5931\u6557\u5206\u3092\u518D\u8A66\u884C\u3057\u3066\u304F\u3060\u3055\u3044\u3002`,c.className="sv-cts-modal-status error",r.disabled=!1,r.textContent="\u4E00\u62EC\u7533\u8ACB\u3059\u308B"),c.hidden=!1}),document.addEventListener("keydown",function u(c){c.key==="Escape"&&(p(),document.removeEventListener("keydown",u))})}function re(){try{return JSON.parse(localStorage.getItem("kanau-playlists")||"null")||[]}catch{return[]}}function He(t){try{localStorage.setItem("kanau-playlists",JSON.stringify(t))}catch{}}function Ne(t,e){let n=re(),s=n.find(i=>String(i.id)===String(t));return s?(s.streams||(s.streams=[]),s.streams.includes(e)||(s.streams.push(e),He(n)),!0):!1}function Ve(){let t=d.data?.streams||[],n=l("#stream-viewer")?._currentStream;if(!n)return;let s=t.findIndex(i=>i.channel===n.channel&&i.index===n.index);s<0||s>=t.length-1||j(t[s+1])}function Zt(t,e){if(!t)return`<div class="sv-bp-nav-card sv-bp-nav-empty">${m(e==="newer"?"\u6700\u65B0\u914D\u4FE1":"\u6700\u521D\u306E\u914D\u4FE1")}</div>`;let n=Pt(t.url),s=e==="newer"?"\u65B0\u3057\u3044\u914D\u4FE1 \u2192":"\u2190 \u53E4\u3044\u914D\u4FE1";return`<button class="sv-bp-nav-card" type="button" data-bp-action="open-stream" data-bp-channel="${m(t.channel)}" data-bp-index="${t.index}">
  ...
  `,e.onchange=r=>{let v=r.target.closest("#sv-ap-check");if(!v)return;Q=v.checked;let f=e.querySelector(".sv-bp-ap-switch");f&&f.classList.toggle("sv-bp-ap-switch--on",Q)},e.onclick=r=>{let v=r.target.closest("[data-bp-action]");if(!v)return;let f=v.dataset.bpAction;if(f==="open-stream"){let h=v.dataset.bpChannel,b=parseInt(v.dataset.bpIndex,10),g=(d.data?.streams||[]).find(k=>k.channel===h&&k.index===b);g&&j(g)}else if(f==="add-pl"){let h=v.dataset.bpPlId;if(Ne(h,c)){v.classList.add("sv-bp-pl-btn--added"),v.disabled=!0;let b=v.querySelector(".sv-bp-pl-status");b&&(b.textContent="\u2713 \u767B\u9332\u6E08\u307F")}}}}function J(t,e,n){t.innerHTML=e.map((s,i)=>Pe(s,i,n)).join("")}function Mt(t){let e=t.match(/(\d+):(\d{2}):(\d{2})|(\d+):(\d{2})/);return e?e[1]!==void 0?parseInt(e[1])*3600+parseInt(e[2])*60+parseInt(e[3]):parseInt(e[4])*60+parseInt(e[5]):null}function Be(t){let e=t.match(/^(\d{1,2}:\d{2}(?::\d{2})?)[\s　]+(.+?)\s*\/\s*(.+?)[\s　]+(\d{1,2}:\d{2}(?::\d{2})?)$/);return e?{start:e[1].trim(),title:e[2].trim(),artist:e[3].trim(),end:e[4].trim()}:null}function rt(t){return(t||"").toLowerCase().replace(/[\s　]/g,"").replace(/[！-～]/g,e=>String.fromCharCode(e.charCodeAt(0)-65248)).replace(/[・｡。、，,．.！!？?「」『』【】（）()]/g,"")}function Ye(t,e,n){let s=rt(t),i=rt(e),a=-1,o=0;for(let p=0;p<n.length;p++){let u=rt(n[p].title),c=rt(n[p].artist),r=0;u===s?r+=80:s.length>1&&(u.includes(s)||s.includes(u))&&(r+=40),i&&c===i?r+=20:i&&i.length>1&&(c.includes(i)||i.includes(c))&&(r+=10),r>o&&(o=r,a=p)}return o>=40?a:-1}function ce(){if(l("#stream-viewer"))return;let t=l("#panel-player");if(!t)return;let e=document.createElement("div");e.id="stream-viewer",e.hidden=!0,e.setAttribute("aria-label","\u914D\u4FE1\u30D7\u30EC\u30A4\u30E4\u30FC"),e.innerHTML=`
  ...
  `,t.appendChild(e),l("#sv-close").addEventListener("click",()=>et({instant:!0})),l("#sv-fullscreen-btn").addEventListener("click",Ce);let n=l("#sv-vol-slider"),s=l("#sv-vol-btn");if(n){let i=R();n.value=i,n.style.setProperty("--pct",`${i}%`),s&&(s.textContent=W(i)),n.addEventListener("input",a=>{let o=parseInt(a.target.value);if(a.target.style.setProperty("--pct",`${o}%`),Et(o),s&&(s.textContent=W(o)),w)try{w.setVolume(o)}catch{}})}if(s){let i=80;s.addEventListener("click",()=>{if(!n)return;let a=parseInt(n.value),o=a>0?0:i||80;a>0&&(i=a),U(n,s,w,o),Et(o)})}e.querySelectorAll("[data-bc-tab]").forEach(i=>{i.addEventListener("click",()=>{nt=i.dataset.bcTab,et({instant:!0})})}),l("#sv-import-toggle").addEventListener("click",()=>{let i=l("#sv-import-area");i&&(i.hidden=!i.hidden,i.hidden||l("#sv-import-input")?.focus())}),l("#sv-import-cancel").addEventListener("click",()=>{let i=l("#sv-import-area");i&&(i.hidden=!0);let a=l("#sv-import-input");a&&(a.value="")}),l("#sv-import-apply").addEventListener("click",()=>{let i=e._currentStream;if(!i)return;let a=l("#sv-import-input");if(!a)return;let p=a.value.split(`
`).map(r=>Mt(r)).filter(r=>r!==null);if(!p.length)return;let u=tt(i);p.forEach((r,v)=>{v<i.songs.length&&(u[v]=r)}),Tt(i,u),J(l("#sv-setlist"),i.songs,u);let c=l("#sv-import-area");c&&(c.hidden=!0),a.value=""}),l("#sv-cts-bulk-btn").addEventListener("click",()=>{let i=e._currentStream;i&&De(i)}),l("#sv-setlist").addEventListener("click",i=>{let a=i.target.closest("[data-action]");if(!a)return;let o=parseInt(a.dataset.idx,10),p=e._currentStream;if(!p)return;let u=tt(p);if(a.dataset.action==="seek"){if(u[o]!=null&&w?.seekTo){w.seekTo(u[o],!0);try{w.playVideo()}catch{}}}else if(a.dataset.action==="set-ts"){let c=w?.getCurrentTime?.();c!=null&&(u[o]=Math.floor(c),Tt(p,u),J(l("#sv-setlist"),p.songs,u))}else if(a.dataset.action==="del-ts")delete u[o],Tt(p,u),J(l("#sv-setlist"),p.songs,u);else if(a.dataset.action==="cts-seek"){let c=Number(a.dataset.ctsSeconds);if(!isNaN(c)&&w?.seekTo){w.seekTo(c,!0);try{w.playVideo()}catch{}}}else if(a.dataset.action==="cts-propose"){let c=p.songs[o];Ie(p,o,c?.title||`\u66F2 ${o+1}`)}})}function j(t,e=0){if(!t?.url)return;let n=D(t.url);if(!n){mt(t.url);return}ce(),X();let s=l("#yt-player-panel");if(s&&!s.hidden){try{y?.pauseVideo()}catch{}s.hidden=!0,Z()}if(_=null,import("./chunk-IRKL6VIF.js").then(h=>h.pauseMusicPlayer()).catch(()=>{}),E){E=!1;let h=l("#stream-viewer");h&&h.classList.remove("sv-fullscreen"),document.body.classList.remove("has-sv-fullscreen"),document.body.style.overflow=""}E=!1,_e();let i=l("#stream-viewer");i.classList.remove("sv-fullscreen"),i.classList.toggle("sv-mv-mode",!!t.isMv),i._currentStream=t;let a=++L,o=i.querySelectorAll("[data-bc-tab]");o[1]&&(t.isMv?(o[1].dataset.bcTab="playlists",o[1].textContent="\u30D7\u30EC\u30A4\u30EA\u30B9\u30C8"):(o[1].dataset.bcTab="timeline",o[1].textContent="\u30BF\u30A4\u30E0\u30E9\u30A4\u30F3"));let p=l("#sv-bc-title");p&&(p.textContent=t.title||"\u914D\u4FE1");let u=l("#sv-stream-meta");u&&(u.textContent=t.isMv?"":`${T(t.date)}\u3000\u7B2C${t.index}\u67A0\u3000\u{1F3A4} ${t.songs.length}\u66F2`);let c=l("#sv-yt-link");c&&(c.href=t.url);let r=l("#sv-song-count");if(r&&(r.textContent=t.isMv?"":`${t.songs.length}\u66F2`),x={},t.isMv){let h=l("#sv-setlist");h&&(h.innerHTML="");let b=l("#sv-below-player");b&&(b.innerHTML="")}else{let h=tt(t);J(l("#sv-setlist"),t.songs,h),Me(t),qe(t)}i.hidden=!1,document.body.style.overflow="",setTimeout(()=>{l("#sv-close")?.focus({preventScroll:!0})},50),w=null;let v=l("#sv-player-wrap");v.innerHTML='<div class="sv-player-loading">\u8AAD\u307F\u8FBC\u307F\u4E2D\u2026</div>';let f=Math.floor(e);ht(()=>{if(a!==L||i.hidden)return;v.innerHTML="";let h=document.createElement("div");v.appendChild(h);try{w=new window.YT.Player(h,{videoId:n,width:"100%",height:"100%",playerVars:{autoplay:1,playsinline:1,rel:0,modestbranding:1,...f>0?{start:f}:{}},events:{onReady:b=>{let g=R();try{b.target.setVolume(g)}catch{}U(l("#sv-vol-slider"),l("#sv-vol-btn"),null,g);try{b.target.setPlaybackQuality("hd1080")}catch{}try{b.target.setPlaybackQualityRange("hd720","hd1080")}catch{}if(f>5)try{b.target.seekTo(f,!0)}catch{}},onStateChange:b=>{if(a===L){if(b.data===window.YT.PlayerState.PLAYING)try{b.target.setPlaybackQuality("hd1080")}catch{}b.data===window.YT.PlayerState.ENDED&&Q&&Ve()}},onError:()=>{a===L&&(v.innerHTML=`<iframe src="https://www.youtube.com/embed/${m(n)}?autoplay=1&playsinline=1&rel=0${f>0?`&start=${f}`:""}" allow="autoplay; encrypted-media; picture-in-picture" allowfullscreen></iframe>`)}}})}catch{v.innerHTML=`<iframe src="https://www.youtube.com/embed/${m(n)}?autoplay=1&playsinline=1&rel=0${f>0?`&start=${f}`:""}" allow="autoplay; encrypted-media; picture-in-picture" allowfullscreen></iframe>`}})}function et({instant:t=!1}={}){let e=l("#stream-viewer");if(!e||e.hidden||e.dataset.svTransitioning)return;if(E){E=!1,e.classList.remove("sv-fullscreen"),document.body.classList.remove("has-sv-fullscreen"),document.body.style.overflow="";let p=l("#sv-close");p&&(p.title="\u30DF\u30CB\u30D7\u30EC\u30A4\u30E4\u30FC\u3067\u518D\u751F\u3092\u7D9A\u3051\u306A\u304C\u3089\u623B\u308A\u307E\u3059\uFF08Esc\uFF09");let u=l("#sv-fullscreen-btn");u&&u.setAttribute("aria-pressed","false");return}if(t){let p=e._currentStream,u=p?.url?D(p.url):"",c=w?.getCurrentTime?.()??0,r=w;++L;let v=L;w=null,e.hidden=!0,e._currentStream=null;let f=l("#sv-player-wrap");if(f&&(f.innerHTML=""),document.body.style.overflow="",pt(),setTimeout(()=>{try{r?.destroy?.()}catch{}},100),u){_=p,G=Math.floor(c),z=Date.now(),X(),ft();let h=l("#yt-player-container"),b=l("#yt-player-panel");Z();let g=l("#yt-mini-title");g&&(g.textContent=p.title||"");let k=l("#yt-mini-hint");k&&(k.textContent="\u25B2 \u30BF\u30C3\u30D7\u3057\u3066\u914D\u4FE1\u30D3\u30E5\u30FC\u30EF\u30FC\u3078\u623B\u308B"),b&&(b.classList.add("has-stream"),b.hidden=!1),ht(()=>{if(v!==L||!h)return;let I=G+(Date.now()-z)/1e3,V=document.createElement("div");h.appendChild(V);try{y=new window.YT.Player(V,{videoId:u,width:"100%",height:"100%",playerVars:{autoplay:1,playsinline:1,rel:0,controls:0,disablekb:1,modestbranding:1,start:Math.floor(I)},events:{onReady:st=>{let F=R();try{st.target.setVolume(F)}catch{}U(l("#yt-mini-vol-slider"),l("#yt-mini-vol-btn"),null,F)},onStateChange:st=>{let F=st.data===window.YT?.PlayerState?.PLAYING,gt=l("#yt-mini-play");gt&&gt.setAttribute("data-playing",F?"1":"0"),F&&xt()}}})}catch{}})}return}let n=e._currentStream,s=w?.getCurrentTime?.()??0,i=n?.url?D(n.url):"";++L;let a=L;if(i&&n?.url){_=n,G=Math.floor(s),z=Date.now(),e.dataset.svTransitioning="1",e.classList.add("sv-to-mini"),X(),ft();let p=l("#yt-player-container"),u=l("#yt-player-panel");Z();let c=l("#yt-mini-title");c&&(c.textContent=n.title||"");let r=l("#yt-mini-hint");r&&(r.textContent="\u25B2 \u30BF\u30C3\u30D7\u3057\u3066\u914D\u4FE1\u30D3\u30E5\u30FC\u30EF\u30FC\u3078\u623B\u308B"),u.classList.add("has-stream"),u.hidden=!1;let v=!1,f=()=>{if(v)return;if(v=!0,a!==L){e.classList.remove("sv-to-mini"),delete e.dataset.svTransitioning;return}e.classList.remove("sv-to-mini"),delete e.dataset.svTransitioning;let b=w;w=null,e.hidden=!0,e._currentStream=null;let g=l("#sv-player-wrap");g&&(g.innerHTML=""),document.body.style.overflow="",pt(),setTimeout(()=>{try{b?.destroy?.()}catch{}},100)},h=setTimeout(f,3e3);ht(()=>{if(a!==L){clearTimeout(h),e.classList.remove("sv-to-mini"),delete e.dataset.svTransitioning;return}let b=G+(Date.now()-z)/1e3,g=document.createElement("div");p.appendChild(g);try{y=new window.YT.Player(g,{videoId:i,width:"100%",height:"100%",playerVars:{autoplay:1,playsinline:1,rel:0,controls:0,disablekb:1,modestbranding:1,start:Math.floor(b)},events:{onReady:k=>{let I=R();try{k.target.setVolume(I)}catch{}U(l("#yt-mini-vol-slider"),l("#yt-mini-vol-btn"),null,I)},onStateChange:k=>{let I=k.data===window.YT?.PlayerState?.PLAYING,V=l("#yt-mini-play");V&&V.setAttribute("data-playing",I?"1":"0"),I&&a===L&&(clearTimeout(h),f(),xt())}}})}catch{clearTimeout(h),f()}});return}e.hidden=!0,e._currentStream=null,w=null;let o=l("#sv-player-wrap");o&&(o.innerHTML=""),document.body.style.overflow="",pt()}window.__openStreamViewer=j;function de(t){let e=dt(t),n=l("#song-modal"),s=l("#song-modal-body"),i=l("#song-modal-title");if(!e||!n||!s||!i)return;Nt(e),i.textContent=e.title;let a=(e.streamRefs||[]).slice(0,8).map(u=>({...u,thumbnail:Pt(u.url),thumbnailFallback:Te(u.url),thumbnailTiny:xe(u.url),detailKey:q(u)})),o=[e.genre,...e.seasonTags||[],...e.moodTags||[],...e.singerTags||[]].filter(Boolean),p=wt(e.key);s.innerHTML=`
...
`).map(o=>m(o)).join("<br>")}</p>`:"",a=e.links?.length?`
    ...
    </div>`}function ze(t){let e=l("#ch-modal"),n=l("#ch-modal-body");if(!e||!n)return;let s="";t==="new"?s=ct("new"):t==="old"?s=ct("old"):s=ct("new")+ct("old"),n.innerHTML=s,e.hidden=!1,l("#ch-modal-close")?.focus()}function Qe(){let t=l("#ch-modal"),e=l("#ch-modal-close");if(!t||!e)return;let n=()=>{t.hidden=!0};e.addEventListener("click",n),t.addEventListener("click",s=>{s.target===t&&n()}),document.querySelectorAll("[data-ch-modal]").forEach(s=>{s.addEventListener("click",()=>ze(s.dataset.chModal))})}function Je(){let t=l("#help-modal"),e=l("#help-btn"),n=l("#help-close");if(!t||!e||!n)return;let s=()=>{t.hidden=!1,n.focus()},i=()=>{t.hidden=!0,e.focus()};e.addEventListener("click",s),n.addEventListener("click",i),t.addEventListener("click",a=>{a.target===t&&i()}),document.addEventListener("keydown",a=>{a.key==="Escape"&&!t.hidden&&i()})}function Ze(){let t=l("#welcome-tip"),e=l("#welcome-close");if(!t||!e||window.matchMedia("(max-width: 760px)").matches||localStorage.getItem("kanau-welcome-tip-dismissed")==="1")return;let n=()=>{t.hidden=!1};"requestIdleCallback"in window?window.requestIdleCallback(n,{timeout:5e3}):window.setTimeout(n,2500),e.addEventListener("click",()=>{t.hidden=!0,localStorage.setItem("kanau-welcome-tip-dismissed","1")})}async function It(){je();try{let t=await qt();d.channelData=t,!Y&&!t.fullLoaded&&ne();let e=Lt();d.songsQuery=e.q,d.activeTab=vt(e.tab)?e.tab:"dashboard",se(d.activeTab);let n=e.channel||d.channel||K;if(M(n)||(n=K),!M(n)){let s=Object.keys(t.channels)[0];s&&(n=s)}if(!M(n))throw new Error("No channel data could be loaded");ke(),Fe(),yt(n,{resetSearch:!1,updateUrl:!1,autoLoad:!0,initial:!0})}catch(t){console.error("[init] failed:",t),Ke(t)}}function Xe(){if(!d.channelData)return;let t=Lt();d.songsQuery=t.q,t.channel!==d.channel&&M(t.channel)&&yt(t.channel,{resetSearch:!1,updateUrl:!1}),N(t.tab,{updateUrl:!1})}S(".tab-btn").forEach(t=>{t.addEventListener("click",()=>{let e=t.dataset.tab,n=l("#stream-viewer");if(e!=="player"&&n&&!n.hidden&&!E){nt=e,et({instant:!0});return}N(e)})});S(".ch-btn").forEach(t=>{t.addEventListener("click",()=>{t.dataset.channel&&(t.disabled||yt(t.dataset.channel))})});window.addEventListener("popstate",Xe);S("[data-audience]").forEach(t=>{t.addEventListener("click",()=>ye(t.dataset.audience))});document.body.addEventListener("click",t=>{let e=t.target.closest("[data-artist-search]");if(e){t.preventDefault(),t.stopPropagation(),Ct(e.dataset.artistSearch||e.textContent||"");return}let n=t.target.closest("[data-playlist-add]");if(n){t.preventDefault(),t.stopPropagation();let o=n.dataset.playlistAdd,p=n.dataset.streamTitle||"";import("./chunk-BWTSGM2I.js").then(u=>u.showAddToPlaylistModal(o,p));return}let s=t.target.closest("[data-stream-play]");if(s){t.preventDefault(),t.stopPropagation();let o=s.dataset.streamPlay,p=(d.data?.streams||[]).find(u=>q(u)===o);p?.url?j(p):s.dataset.inlineYoutube&&mt(s.dataset.inlineYoutube);return}let i=t.target.closest("[data-inline-youtube]");if(i){t.preventDefault(),t.stopPropagation(),mt(i.dataset.inlineYoutube);return}if(Ht(t.target))return;let a=t.target.closest("[data-songkey]");a&&de(a.dataset.songkey)});l("#retry-btn").addEventListener("click",It);l("#reload-btn").addEventListener("click",It);Je();Qe();ft();ce();Re();ge();we();Ze();import("./chunk-IRKL6VIF.js").then(t=>{t.setApiLoader(X),t.initMusicPlayer()}).catch(()=>{});Kt(t=>{t.type==="song"?de(t.song.key):t.type==="artist"?Ct(t.artist):t.type==="stream"&&j(t.stream)});document.addEventListener("keydown",t=>{let e=document.activeElement?.tagName,n=e==="INPUT"||e==="TEXTAREA"||e==="SELECT";if(t.key==="/"&&!n&&!t.metaKey&&!t.ctrlKey||t.key==="k"&&(t.ctrlKey||t.metaKey)&&!t.shiftKey){t.preventDefault(),Ot();return}if(t.key==="t"&&!n&&!t.metaKey&&!t.ctrlKey){t.preventDefault(),Yt();return}if(t.key==="?"&&!n&&!t.metaKey&&!t.ctrlKey){t.preventDefault();let i=l("#help-modal");i&&i.hidden&&(i.hidden=!1,l("#help-close")?.focus());return}if(t.key==="Escape"&&!t.metaKey&&!t.ctrlKey){let i=l("#stream-viewer"),a=!!l("#panel-player.active");if(i&&!i.hidden&&(E||a)){t.preventDefault(),et();return}if(Gt()){t.preventDefault(),O();return}let o=l("#song-modal");if(o&&!o.hidden)return;let p=l("#ch-modal");if(p&&!p.hidden){p.hidden=!0;return}let u=l("#help-modal");if(u&&!u.hidden){u.hidden=!0,l("#help-btn")?.focus();return}let c=l("#songs-search");c&&document.activeElement===c&&c.value&&(t.preventDefault(),c.value="",c.dispatchEvent(new Event("input",{bubbles:!0})))}});Ut(()=>{d.data&&($t(),(d.activeTab==="dashboard"||d.activeTab==="analytics")&&H())});function We(){It()}We();

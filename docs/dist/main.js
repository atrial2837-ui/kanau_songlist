import{a as pe,b as me,e as Vt,f as fe}from"./chunk-75LO2NW7.js";import{b as oe,c as ce,d as de,i as ue,j as ve,k as O,l as G}from"./chunk-I3NVQXRL.js";import{a as ot}from"./chunk-MKJIXTK4.js";import{a as ie,b as Dt,c as le,e as u}from"./chunk-JT7WCFD3.js";import{E as Ht,F as C,H as tt,M as z,N as re,P as g,a as l,b as P,c as f}from"./chunk-XREH2M7C.js";var E=-1,q=[],qt=null,Q=null,kt=null;function ge(t){qt=t;let e=document.createElement("div");e.id="omni-backdrop",e.hidden=!0,e.setAttribute("role","dialog"),e.setAttribute("aria-modal","true"),e.setAttribute("aria-label","\u30B5\u30A4\u30C8\u5185\u691C\u7D22"),e.innerHTML=`
  ...
  `)}function rs(t){if(u.channelData?.fullLoaded)return;u.channelData=t;let e=F(u.channel)?u.channel:ot,s=F(e);s&&(u.data=s),!Pe(u.activeTab)&&u.data&&Z(u.activeTab,{autoLoad:!1})}function os(t){u.channelData=t,u.channelData.fullLoaded=!0;let e=F(u.channel)?u.channel:ot;Pt(e,{resetSearch:!1,updateUrl:!1,render:!1}),Z(u.activeTab,{autoLoad:!1})}function Ie(){return nt=ce({meta:u.channelData,onSongsReady:rs}).then(os).finally(()=>{nt=null}),nt}async function Ft(){u.channelData?.fullLoaded||(nt||Ie(),await nt)}async function Z(t=u.activeTab,e={}){if(t!=="playlists"&&(!u.data||!Et(t))||!Et(t))return;let s=u.channelData?.partialLoaded||u.channelData?.fullLoaded,n=u.channelData?.fullLoaded;if(t==="playlists"?!1:Pe(t)?!n:!s)if(e.autoLoad){ls(t);try{await Ft()}catch(r){console.error("[data] full load failed",r);let c=l(`#panel-${t}`);c&&(c.innerHTML=`
            <div class="state-card">
...
${r}`)}`),r};l("#sv-share-ts-check").addEventListener("change",s),t._rebuild=s,l("#sv-share-url").addEventListener("focus",a=>a.target.select()),l("#sv-share-copy").addEventListener("click",async()=>{let a=l("#sv-share-url")?.value;if(!a)return;let i=!1;try{await navigator.clipboard.writeText(a),i=!0}catch{try{l("#sv-share-url").select(),i=document.execCommand("copy")}catch{}}let r=l("#sv-share-copy");r&&(r.textContent=i?"\u30B3\u30D4\u30FC\u3067\u304D\u307E\u3057\u305F":"\u30B3\u30D4\u30FC\u3067\u304D\u307E\u305B\u3093",r.classList.add("copied"),setTimeout(()=>{r.textContent="\u30EA\u30F3\u30AF\u3092\u30B3\u30D4\u30FC",r.classList.remove("copied")},1600))});let n=l("#sv-share-native");navigator.share&&n&&(n.hidden=!1,n.addEventListener("click",async()=>{let a=t._shareState,i=l("#sv-share-url")?.value;if(i)try{await navigator.share({title:a?.title||"",url:i})}catch{}}))}function Ss(){let e=l("#stream-viewer")?._currentStream;if(!e?.url)return;let s=x(e.url);if(!s)return;Ls();let n=l("#sv-share-modal"),a=Qt(O().t);n._shareState={id:s,t:a,title:e.title||""};let i=l("#sv-share-video-title");i&&(i.textContent=e.title||"(\u30BF\u30A4\u30C8\u30EB\u306A\u3057)");let r=l("#sv-share-ts-row"),c=l("#sv-share-ts-check"),o=l("#sv-share-ts-label");r&&(r.hidden=a<=5),c&&(c.checked=a>5),o&&(o.textContent=Y(a)),n._rebuild?.(),n.hidden=!1}var _e=new URLSearchParams(location.search).get("pl");async function _s(){if(!_e)return;let t=null;try{let n=_e.replace(/-/g,"+").replace(/_/g,"/"),a=Uint8Array.from(atob(n),i=>i.charCodeAt(0));t=JSON.parse(new TextDecoder().decode(a))}catch{return}if(!t||typeof t.n!="string"||!Array.isArray(t.s))return;let e=t.n.slice(0,60)||"\u5171\u6709\u30D7\u30EC\u30A4\u30EA\u30B9\u30C8",s=t.s.filter(n=>typeof n=="string"&&n.length<100).slice(0,300);if(s.length){if(!confirm(`\u5171\u6709\u3055\u308C\u305F\u30D7\u30EC\u30A4\u30EA\u30B9\u30C8\u300C${e}\u300D\uFF08${s.length}\u4EF6\uFF09\u3092\u53D6\u308A\u8FBC\u307F\u307E\u3059\u304B\uFF1F`)){G({},{replace:!0});return}try{let n=await import("./chunk-PUFWCSCY.js"),a=n.createPlaylist(e);for(let i of s)n.addStreamToPlaylist(a.id,i);G({tab:"playlists"},{replace:!0}),D("playlists",{updateUrl:!1})}catch{}}}async function xs(){let t=O();if(!t.v)return!1;let e=t.v,s=t.t;try{await Ft()}catch{}let n=[];u.channelData?.combined&&n.push(u.channelData.combined),Object.values(u.channelData?.channels||{}).forEach(a=>{a&&n.push(a)});for(let a of n){let i=(a.streams||[]).find(r=>x(r.url)===e);if(i)return _(i,s),!0}try{let r=((await(await fetch("data/music.json")).json())?.videos||[]).find(c=>x(c.url)===e);if(r)return _({url:r.url,title:r.title,isMv:!0},s),!0}catch{}return _({url:`https://www.youtube.com/watch?v=${e}`,title:"",isMv:!0},s),!0}function Ts(t,e=0,s=""){let n=x(t);if(!n)return;if(De()){window.open(He(t,e),"_blank","noopener");return}{let o=l("#stream-viewer");if(o&&!o.hidden&&!A)if(j(o))It();else{++B,o.hidden=!0,o._currentStream=null,b=null;let d=l("#sv-player-wrap");d&&(d.innerHTML=""),document.body.style.overflow="",M=null,Mt={},At(),H()}}Wt(),Jt();let a=l("#yt-player-container"),i=l("#yt-player-panel");if(!a||!i)return;rt();let r=l("#yt-mini-title");r&&(r.textContent=s||"\u30A4\u30F3\u30E9\u30A4\u30F3\u518D\u751F");let c=l("#yt-mini-hint");c&&(c.textContent=M?"\u25B2 \u30BF\u30C3\u30D7\u3057\u3066\u914D\u4FE1\u30D3\u30E5\u30FC\u30EF\u30FC\u3078\u623B\u308B":""),i.classList.toggle("has-stream",!!M),i.hidden=!1,Oe(()=>{let o=document.createElement("div");a.appendChild(o);try{k=new window.YT.Player(o,{videoId:n,width:"100%",height:"100%",playerVars:{autoplay:1,playsinline:1,rel:0,controls:0,disablekb:1,modestbranding:1,...e>0?{start:Math.floor(e)}:{}},events:{onReady:d=>{let p=J();try{d.target.setVolume(p)}catch{}if(it(l("#yt-mini-vol-slider"),l("#yt-mini-vol-btn"),null,p),e>5)try{d.target.seekTo(e,!0)}catch{}Gt()},onStateChange:d=>{let p=d.data===window.YT.PlayerState.PLAYING,m=l("#yt-mini-play");m&&m.setAttribute("data-playing",p?"1":"0")}}})}catch{let p=e>0?`&start=${Math.floor(e)}`:"";a.innerHTML=`<iframe src="https://www.youtube.com/embed/${n}?autoplay=1&playsinline=1${p}" frameborder="0" allowfullscreen allow="autoplay; encrypted-media; picture-in-picture"></iframe>`}})}function Jt(){if(l("#yt-player-panel"))return;let t=document.createElement("div");t.id="yt-player-panel",t.hidden=!0,t.innerHTML=`
  ...
  `,document.body.appendChild(i);let r=()=>i.remove();i.querySelector(".sv-cts-modal-close").addEventListener("click",r),i.querySelector(".sv-cts-modal-cancel").addEventListener("click",r),i.addEventListener("click",c=>{c.target===i&&r()}),i.querySelector("#sv-cts-submit").addEventListener("click",async()=>{let c=i.querySelector("#sv-cts-ts-input").value.trim(),o=i.querySelector("#sv-cts-note-input").value.trim()||null,d=ne(c),p=i.querySelector("#sv-cts-status");if(d===null){p.textContent="\u30BF\u30A4\u30E0\u30B9\u30BF\u30F3\u30D7\u306E\u5F62\u5F0F\u304C\u6B63\u3057\u304F\u3042\u308A\u307E\u305B\u3093\uFF08\u4F8B: 1:23 \u307E\u305F\u306F 1:23:45\uFF09",p.className="sv-cts-modal-status error",p.hidden=!1;return}let m=i.querySelector("#sv-cts-submit");m.disabled=!0,m.textContent="\u9001\u4FE1\u4E2D\u2026";try{let v=await fetch(`/api/timestamps/${encodeURIComponent(t.channel)}/${t.index}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({songIndex:e,timeSeconds:d,submitterNote:o})});if(v.ok)p.textContent="\u63D0\u6848\u3092\u9001\u4FE1\u3057\u307E\u3057\u305F\uFF01\u5BE9\u67FB\u5F8C\u306B\u516C\u958B\u3055\u308C\u307E\u3059\u3002",p.className="sv-cts-modal-status success",p.hidden=!1,m.hidden=!0,i.querySelector(".sv-cts-modal-cancel").textContent="\u9589\u3058\u308B";else{let h=await v.json().catch(()=>({}));p.textContent=`\u9001\u4FE1\u306B\u5931\u6557\u3057\u307E\u3057\u305F: ${h.error||v.statusText}`,p.className="sv-cts-modal-status error",p.hidden=!1,m.disabled=!1,m.textContent="\u63D0\u6848\u3059\u308B"}}catch(v){p.textContent=`\u9001\u4FE1\u306B\u5931\u6557\u3057\u307E\u3057\u305F: ${v.message}`,p.className="sv-cts-modal-status error",p.hidden=!1,m.disabled=!1,m.textContent="\u63D0\u6848\u3059\u308B"}}),setTimeout(()=>i.querySelector("#sv-cts-ts-input")?.focus(),50),document.addEventListener("keydown",function c(o){o.key==="Escape"&&(r(),document.removeEventListener("keydown",c))})}function xe(t){let e=l("#sv-cts-bulk-btn");if(!e||!t?.songs?.length)return;let n=Object.keys(I).length>=t.songs.length;e.textContent=n?"\u4FEE\u6B63\u7533\u8ACB":"\u30BB\u30C8\u30EA\u767B\u9332",e.hidden=!1}function Is(t){l("#sv-bulk-modal")?.remove();let e=W(t),a=Object.keys(I).length>=t.songs.length,i=t.songs.map((o,d)=>{let p=e[d]!=null?Y(e[d]):"",m=I[d]?.[0]?.timeSeconds!=null?Y(I[d][0].timeSeconds):"",v=p||m;return`
      <div class="sv-bulk-row" data-idx="${d}">
        ...
        <button class="sv-bulk-ts-now" type="button" title="\u73FE\u5728\u6642\u523B\u3092\u5165\u529B" data-bulk-now="${d}">${g("time")}</button>
...
`).map(v=>v.trim()).filter(Boolean),p=0;for(let v of d){let h=Gs(v);if(!h)continue;let w=Qs(h.title,h.artist,t.songs);if(w>=0){let y=r.querySelector(`[data-bulk-ts-idx="${w}"]`);y&&(y.value=h.start,p++)}}let m=r.querySelector(".sv-paste-result");m&&(m.textContent=p>0?`${d.length}\u884C\u3092\u89E3\u6790 \u2192 ${p}\u66F2\u306B\u5165\u529B\u3057\u307E\u3057\u305F`:"\u4E00\u81F4\u3059\u308B\u66F2\u304C\u898B\u3064\u304B\u308A\u307E\u305B\u3093\u3067\u3057\u305F",m.hidden=!1)}),r.querySelector(".sv-bulk-rows").addEventListener("click",o=>{let d=o.target.closest("[data-bulk-now]");if(!d)return;let p=parseInt(d.dataset.bulkNow,10),m=b?.getCurrentTime?.();if(m!=null){let v=r.querySelector(`[data-bulk-ts-idx="${p}"]`);v&&(v.value=Y(Math.floor(m)))}}),r.querySelector("#sv-bulk-submit").addEventListener("click",async()=>{let o=r.querySelector("#sv-bulk-note").value.trim()||null,d=r.querySelector("#sv-bulk-status"),p=r.querySelector("#sv-bulk-submit"),m=[];if(r.querySelectorAll("[data-bulk-ts-idx]").forEach(w=>{let y=parseInt(w.dataset.bulkTsIdx,10),$=ne(w.value.trim());$!==null&&m.push({songIndex:y,timeSeconds:$})}),!m.length){d.textContent="\u30BF\u30A4\u30E0\u30B9\u30BF\u30F3\u30D7\u304C1\u3064\u3082\u5165\u529B\u3055\u308C\u3066\u3044\u307E\u305B\u3093",d.className="sv-cts-modal-status error",d.hidden=!1;return}p.disabled=!0,p.textContent=`\u7533\u8ACB\u4E2D\u2026 (0/${m.length})`,d.hidden=!0;let v=0,h=0;await Promise.all(m.map(async w=>{try{(await fetch(`/api/timestamps/${encodeURIComponent(t.channel)}/${t.index}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({songIndex:w.songIndex,timeSeconds:w.timeSeconds,submitterNote:o})})).ok?v++:h++}catch{h++}p.textContent=`\u7533\u8ACB\u4E2D\u2026 (${v+h}/${m.length})`})),h===0?(d.textContent=`${v}\u66F2\u5206\u306E\u30BF\u30A4\u30E0\u30B9\u30BF\u30F3\u30D7\u3092\u7533\u8ACB\u3057\u307E\u3057\u305F\uFF01\u5BE9\u67FB\u5F8C\u306B\u516C\u958B\u3055\u308C\u307E\u3059\u3002`,d.className="sv-cts-modal-status success",p.hidden=!0,r.querySelector(".sv-cts-modal-cancel").textContent="\u9589\u3058\u308B"):(d.textContent=`${v}\u4EF6\u6210\u529F / ${h}\u4EF6\u5931\u6557\u3002\u5931\u6557\u5206\u3092\u518D\u8A66\u884C\u3057\u3066\u304F\u3060\u3055\u3044\u3002`,d.className="sv-cts-modal-status error",p.disabled=!1,p.textContent="\u4E00\u62EC\u7533\u8ACB\u3059\u308B"),d.hidden=!1}),document.addEventListener("keydown",function o(d){d.key==="Escape"&&(c(),document.removeEventListener("keydown",o))})}function As(){try{return JSON.parse(localStorage.getItem("kanau-playlists")||"null")||[]}catch{return[]}}var te="kanauViewerQueueCollapsed",L=null,bt=!1;function Ct(t){let e=L,s=e?.items?.[t];if(s){e.idx=t,bt=!0;try{s.kind==="mv"?_({url:s.video.url,title:s.video.title,isMv:!0}):_(s.stream)}finally{bt=!1}}}window.__playMyListInViewer=t=>{t?.items?.length&&(L={name:t.name||"\u30DE\u30A4\u30EA\u30B9\u30C8",items:t.items,idx:0,repeat:localStorage.getItem("kanauListRepeat")==="1",collapsed:localStorage.getItem(te)==="1"},Ct(Math.max(0,Math.min(t.idx||0,t.items.length-1))))};window.__openMusicQueueInViewer=(t,e=0,s=0)=>{if(!t?.length)return!1;let n=t.filter(i=>i?.url).map((i,r)=>i._stream?{kind:"stream",key:i._stream.url||`stream:${r}`,stream:i._stream}:{kind:"mv",key:`mv:${x(i.url)||r}`,video:{...i,isMv:!0}});if(!n.length)return!1;L={name:"\u97F3\u697D\u30D7\u30EC\u30A4\u30E4\u30FC\u306E\u30AD\u30E5\u30FC",items:n,idx:Math.max(0,Math.min(e,n.length-1)),repeat:localStorage.getItem("kanauListRepeat")==="1",collapsed:localStorage.getItem(te)==="1"};let a=L.items[L.idx];bt=!0;try{a.kind==="mv"?_({...a.video,isMv:!0},s):_(a.stream,s)}finally{bt=!1}return!0};function ee(){let t=L;if(!t?.items?.length)return"";let e=t.items[t.idx],s=e?.kind==="mv"?e.video?.title||"\u52D5\u753B":e?.stream?.title||"\u914D\u4FE1";return`
  ...
  </button>`}function Fs(t){let e=l("#sv-below-player");if(!e)return;let s=u.data?.streams||[],n=s.findIndex(p=>p.channel===t.channel&&p.index===t.index),a=n>=0&&n<s.length-1?s[n+1]:null,i=n>0?s[n-1]:null,r=new Set(t.songs.map(p=>p.title)),c=s.filter((p,m)=>m!==n).map(p=>{let m=p.songs.filter(v=>r.has(v.title));return{stream:p,overlap:m.length,sharedSongs:m.slice(0,3).map(v=>v.title)}}).filter(p=>p.overlap>0).sort((p,m)=>m.overlap-p.overlap).slice(0,8),o=tt(t),d=Us(o);e.innerHTML=`
    ...
    <div class="sv-bp-wrap">
      ...
      <div class="sv-bp-section">
        ...
        <div class="sv-mv-grid">
          ${d.map(v=>{let h=mt(v.url);return`<button class="sv-mv-card" type="button" data-mv-action="open-mv" data-mv-url="${f(v.url)}" data-mv-title="${f(v.title)}">
              ...
              <div class="sv-mv-card-body">
                ...
                <div class="sv-mv-card-type">${c[v.type]||"\u30AA\u30EA\u30B8\u30CA\u30EB"}</div>
              </div>
            </button>`}).join("")}
        </div>
      </div>
...
`).map(p=>ne(p)).filter(p=>p!==null);if(!c.length)return;let o=W(a);c.forEach((p,m)=>{m<a.songs.length&&(o[m]=p)}),Ut(a,o),at(l("#sv-setlist"),a.songs,o,K);let d=l("#sv-import-area");d&&(d.hidden=!0),i.value=""}),l("#sv-cts-bulk-btn").addEventListener("click",()=>{let a=e._currentStream;a&&Is(a)}),l("#sv-setlist").addEventListener("click",a=>{let i=a.target.closest("[data-action]");if(!i)return;let r=parseInt(i.dataset.idx,10),c=e._currentStream;if(!c)return;let o=W(c);if(i.dataset.action==="seek"){if(o[r]!=null&&b?.seekTo){b.seekTo(o[r],!0);try{b.playVideo()}catch{}}}else if(i.dataset.action==="set-ts"){let d=b?.getCurrentTime?.();d!=null&&(o[r]=Math.floor(d),Ut(c,o),at(l("#sv-setlist"),c.songs,o,K))}else if(i.dataset.action==="del-ts")delete o[r],Ut(c,o),at(l("#sv-setlist"),c.songs,o,K);else if(i.dataset.action==="cts-seek"){let d=Number(i.dataset.ctsSeconds);if(!isNaN(d)&&b?.seekTo){b.seekTo(d,!0);try{b.playVideo()}catch{}}}else if(i.dataset.action==="cts-propose"){let d=c.songs[r];Ps(c,r,d?.title||`\u66F2 ${r+1}`)}})}function _(t,e=0){if(!t?.url)return;let s=x(t.url);if(!s){Ts(t.url);return}if(De()){window.open(He(t.url,e),"_blank","noopener");return}Ze(),Wt(),lt(),bt||(L=null);let n=l("#stream-viewer");if(j(n)){if(n._currentStream?.url===t.url){if(!qe()&&!window.__restoreMusicExternalPlayer?.()&&Ne(),e>0)try{b?.seekTo(Math.floor(e),!0),b?.playVideo()}catch{}return}It()}let a=window.__takeOverMusicPlayerVideo?.(t.url)||null;a||import("./chunk-OEM5VAYO.js").then($=>($.releaseMusicPlayerVideo||$.pauseMusicPlayer)()).catch(()=>{});let i=l("#yt-player-panel");if(i&&!i.hidden){try{k?.pauseVideo()}catch{}i.hidden=!0,rt()}if(M=null,A){A=!1;let $=l("#stream-viewer");$&&$.classList.remove("sv-fullscreen"),document.body.classList.remove("has-sv-fullscreen"),document.body.style.overflow=""}A=!1,Xt();let r=l("#stream-viewer");r.classList.remove("sv-fullscreen"),r.classList.toggle("sv-mv-mode",!!t.isMv);let c=/縦型|たて配信|タテ|#?shorts|ショート|vertical/i.test(t.title||"")||/\/shorts\//.test(t.url||"");r.classList.toggle("sv-portrait",c),r._currentStream=t,qs();let o=++B,d=r.querySelectorAll("[data-bc-tab]");d[1]&&(t.isMv?(d[1].dataset.bcTab="playlists",d[1].textContent="\u30D7\u30EC\u30A4\u30EA\u30B9\u30C8"):(d[1].dataset.bcTab="timeline",d[1].textContent="\u30BF\u30A4\u30E0\u30E9\u30A4\u30F3"));let p=l("#sv-bc-title");p&&(p.textContent=t.title||"\u914D\u4FE1");let m=l("#sv-stream-meta");m&&(m.innerHTML=t.isMv?"":`${C(t.date)}\u3000\u7B2C${t.index}\u67A0\u3000${g("mic")} ${t.songs.length}\u66F2`);let v=l("#sv-yt-link");v&&(v.href=t.url);let h=l("#sv-song-count");if(h&&(h.textContent=t.isMv?"":`${t.songs.length}\u66F2`),I={},t.isMv){let $=l("#sv-setlist");$&&($.innerHTML="");let T=l("#sv-below-player");T&&(T.innerHTML="");let V=l("#sv-side-related");V&&(V.innerHTML=""),zs(t)}else{let $=W(t);at(l("#sv-setlist"),t.songs,$,K),Cs(t),Fs(t)}r.hidden=!1,document.body.style.overflow="",H(),window.scrollTo({top:0,behavior:"auto"}),setTimeout(()=>{l("#sv-close")?.focus({preventScroll:!0})},50),b=null;let w=l("#sv-player-wrap");w.innerHTML='<div class="sv-player-loading">\u8AAD\u307F\u8FBC\u307F\u4E2D\u2026</div>';let y=Math.floor(e||a?.currentTime||0);if(a?.player){w.innerHTML="",a.iframe?(a.iframe.style.width="100%",a.iframe.style.height="100%",w.appendChild(a.iframe)):w.innerHTML='<div class="sv-player-loading">\u518D\u751F\u3092\u5F15\u304D\u7D99\u304E\u307E\u3057\u305F</div>',b=a.player;try{b.setVolume?.(J()),y>1&&b.seekTo?.(y,!0),b.playVideo?.()}catch{}it(l("#sv-vol-slider"),l("#sv-vol-btn"),null,J()),jt(!0),Hs(o,r);return}Oe(()=>{if(o!==B||r.hidden)return;w.innerHTML="";let $=document.createElement("div");w.appendChild($);try{b=new window.YT.Player($,{videoId:s,width:"100%",height:"100%",playerVars:{autoplay:1,playsinline:1,origin:location.origin,rel:0,modestbranding:1,...y>0?{start:y}:{}},events:{onReady:T=>{let V=J();try{T.target.setVolume(V)}catch{}it(l("#sv-vol-slider"),l("#sv-vol-btn"),null,V);try{T.target.setPlaybackQuality("hd1080")}catch{}try{T.target.setPlaybackQualityRange("hd720","hd1080")}catch{}if(y>5)try{T.target.seekTo(y,!0)}catch{}},onStateChange:T=>{if(o===B){if(jt(T.data===window.YT.PlayerState.PLAYING),T.data===window.YT.PlayerState.PLAYING)try{T.target.setPlaybackQuality("hd1080")}catch{}T.data===window.YT.PlayerState.ENDED&&Qe(r)}},onError:()=>{o===B&&(w.innerHTML=`<iframe src="https://www.youtube.com/embed/${f(s)}?autoplay=1&playsinline=1&rel=0&origin=${encodeURIComponent(location.origin)}${y>0?`&start=${y}`:""}" allow="autoplay; encrypted-media; picture-in-picture" allowfullscreen></iframe>`)}}})}catch{w.innerHTML=`<iframe src="https://www.youtube.com/embed/${f(s)}?autoplay=1&playsinline=1&rel=0&origin=${encodeURIComponent(location.origin)}${y>0?`&start=${y}`:""}" allow="autoplay; encrypted-media; picture-in-picture" allowfullscreen></iframe>`}})}function yt(){let t=l("#stream-viewer");if(!t||t.hidden||j(t))return;if(A){A=!1,t.classList.remove("sv-fullscreen"),document.body.classList.remove("has-sv-fullscreen"),document.body.style.overflow="";let s=l("#sv-close");s&&(s.title="\u30DF\u30CB\u30D7\u30EC\u30A4\u30E4\u30FC\u3067\u518D\u751F\u3092\u7D9A\u3051\u306A\u304C\u3089\u623B\u308A\u307E\u3059\uFF08Esc\uFF09");let n=l("#sv-fullscreen-btn");n&&n.setAttribute("aria-pressed","false");return}if(ys())return;++B,t.hidden=!0,t._currentStream=null,lt(),b=null;let e=l("#sv-player-wrap");e&&(e.innerHTML=""),document.body.style.overflow="",At(),H()}window.__openStreamViewer=_;window.__closeStreamMiniPlayer=()=>{let t=l("#stream-viewer");if(j(t))return It(),!0;let e=l("#yt-player-panel");return e&&!e.hidden?(e.hidden=!0,rt(),M=null,!0):!1};function Ot(t){let e=_t(t),s=l("#song-modal"),n=l("#song-modal-body"),a=l("#song-modal-title");if(!e||!s||!n||!a)return;oe(e),a.textContent=e.title;let i=(e.streamRefs||[]).slice(0,8).map(o=>({...o,thumbnail:mt(o.url),thumbnailFallback:hs(o.url),thumbnailTiny:Ve(o.url),detailKey:tt(o)})),r=[e.genre,...e.seasonTags||[],...e.moodTags||[],...e.singerTags||[]].filter(Boolean),c=Dt(e.key);n.innerHTML=`
    ...
    <div class="song-detail-actions">
      <button class="btn ${c?"primary":"ghost"}" type="button" data-detail-action="favorite" data-songkey="${f(e.key)}">${g("heart")} ${c?"\u304A\u6C17\u306B\u5165\u308A\u89E3\u9664":"\u304A\u6C17\u306B\u5165\u308A\u306B\u8FFD\u52A0"}</button>
...
`).map(r=>f(r)).join("<br>")}</p>`:"",i=e.links?.length?`
    ...
    </div>`}function nn(t){let e=l("#ch-modal"),s=l("#ch-modal-body");if(!e||!s)return;let n="";t==="new"?n=St("new"):t==="old"?n=St("old"):n=St("new")+St("old"),s.innerHTML=n,e.hidden=!1,l("#ch-modal-close")?.focus()}function an(){let t=l("#ch-modal"),e=l("#ch-modal-close");if(!t||!e)return;let s=()=>{t.hidden=!0};e.addEventListener("click",s),t.addEventListener("click",n=>{n.target===t&&s()}),document.querySelectorAll("[data-ch-modal]").forEach(n=>{n.addEventListener("click",()=>nn(n.dataset.chModal))})}function ln(){let t=l("#help-modal"),e=l("#help-btn"),s=l("#help-close");if(!t||!e||!s)return;let n=()=>{t.hidden=!1,s.focus()},a=()=>{t.hidden=!0,e.focus()};e.addEventListener("click",n),s.addEventListener("click",a),t.addEventListener("click",i=>{i.target===t&&a()}),document.addEventListener("keydown",i=>{i.key==="Escape"&&!t.hidden&&a()})}function rn(){let t=l("#welcome-tip"),e=l("#welcome-close");if(!t||!e||window.matchMedia("(max-width: 760px)").matches||localStorage.getItem("kanau-welcome-tip-dismissed")==="1")return;let s=()=>{t.hidden=!1};"requestIdleCallback"in window?window.requestIdleCallback(s,{timeout:5e3}):window.setTimeout(s,2500),e.addEventListener("click",()=>{t.hidden=!0,localStorage.setItem("kanau-welcome-tip-dismissed","1")})}async function ae(){Zs();try{let t=await de();u.channelData=t,!nt&&!t.fullLoaded&&Ie();let e=O(),s=!!e.v;u.songsQuery=e.q,u.activeTab=s?"player":Et(e.tab)?e.tab:"dashboard",Ae(u.activeTab);let n=e.channel||u.channel||ot;if(F(n)||(n=ot),!F(n)){let a=Object.keys(t.channels)[0];a&&(n=a)}if(!F(n))throw new Error("No channel data could be loaded");vs(),Pt(n,{resetSearch:!1,updateUrl:!1,autoLoad:!0,initial:!0,render:!s}),s&&(await xs()||D(e.tab,{updateUrl:!1,initial:!0})),Xs(),_s()}catch(t){console.error("[init] failed:",t),tn(t)}}function on(){if(!u.channelData)return;let t=O();u.songsQuery=t.q,t.channel!==u.channel&&F(t.channel)&&Pt(t.channel,{resetSearch:!1,updateUrl:!1}),D(t.tab,{updateUrl:!1})}P(".tab-btn").forEach(t=>{t.addEventListener("click",()=>{let e=t.dataset.tab,s=l("#stream-viewer");if(e!=="player"&&s&&!s.hidden&&!A&&!j(s)){wt=e,yt();return}D(e)})});P(".ch-btn").forEach(t=>{t.addEventListener("click",()=>{t.dataset.channel&&(t.disabled||Pt(t.dataset.channel))})});window.addEventListener("popstate",on);P("[data-audience]").forEach(t=>{t.addEventListener("click",()=>cs(t.dataset.audience))});document.body.addEventListener("click",t=>{let e=t.target.closest(".timeline-setlist .setlist-title[data-songkey]");if(e){t.preventDefault(),t.stopPropagation(),Ot(e.dataset.songkey);return}let s=t.target.closest("[data-artist-search]");if(s){t.preventDefault(),t.stopPropagation(),zt(s.dataset.artistSearch||s.textContent||"");return}let n=t.target.closest("[data-playlist-add]");if(n){t.preventDefault(),t.stopPropagation();let r=n.dataset.playlistAdd,c=n.dataset.streamTitle||"",o=d=>{n.classList.toggle("is-saved",d),n.classList.contains("timeline-save-btn")&&(n.innerHTML=g("bookmark")),n.title=d?"\u30D7\u30EC\u30A4\u30EA\u30B9\u30C8\u306B\u4FDD\u5B58\u6E08\u307F":"\u30D7\u30EC\u30A4\u30EA\u30B9\u30C8\u306B\u4FDD\u5B58"};import("./chunk-PUFWCSCY.js").then(d=>d.showAddToPlaylistModal(r,c,{onChange:o}));return}let a=t.target.closest("[data-stream-play]");if(a){t.preventDefault(),t.stopPropagation();let r=a.dataset.streamPlay,c=(u.data?.streams||[]).find(o=>tt(o)===r);c?.url&&_(c);return}if(re(t.target))return;let i=t.target.closest("[data-songkey]");i&&Ot(i.dataset.songkey)});l("#retry-btn").addEventListener("click",ae);l("#reload-btn").addEventListener("click",ae);ln();an();Jt();Ze();Js();ds();us();rn();import("./chunk-OEM5VAYO.js").then(t=>{t.setApiLoader(Wt),t.initMusicPlayer()}).catch(()=>{});ge(t=>{t.type==="song"?Ot(t.song.key):t.type==="artist"?zt(t.artist):t.type==="stream"?_(t.stream):t.type==="music-video"&&_({...t.video,isMv:!0})});document.addEventListener("keydown",t=>{let e=document.activeElement?.tagName,s=e==="INPUT"||e==="TEXTAREA"||e==="SELECT";if(!s&&!t.metaKey&&!t.ctrlKey&&!t.altKey){let a=l("#stream-viewer");if(a&&!a.hidden&&!a.classList.contains("sv-minified")&&!a.classList.contains("sv-music-minified")&&l("#sv-share-modal")?.hidden!==!1&&b){if(t.key===" "){t.preventDefault();try{b.getPlayerState?.()===window.YT?.PlayerState?.PLAYING?b.pauseVideo():b.playVideo()}catch{}return}if(t.key==="ArrowLeft"||t.key==="ArrowRight"){t.preventDefault();try{let r=b.getCurrentTime?.()??0,c=Math.max(0,r+(t.key==="ArrowRight"?10:-10));b.seekTo(c,!0)}catch{}return}}}if(t.key==="/"&&!s&&!t.metaKey&&!t.ctrlKey||t.key==="k"&&(t.ctrlKey||t.metaKey)&&!t.shiftKey){t.preventDefault(),we();return}if(t.key==="t"&&!s&&!t.metaKey&&!t.ctrlKey){t.preventDefault(),pe();return}if(t.key==="?"&&!s&&!t.metaKey&&!t.ctrlKey){t.preventDefault();let a=l("#help-modal");a&&a.hidden&&(a.hidden=!1,l("#help-close")?.focus());return}if(t.key==="Escape"&&!t.metaKey&&!t.ctrlKey){let a=l("#stream-viewer"),i=!!l("#panel-player.active");if(a&&!a.hidden&&(A||i)){t.preventDefault(),yt();return}if(Bt()){t.preventDefault(),ut();return}let r=l("#song-modal");if(r&&!r.hidden)return;let c=l("#ch-modal");if(c&&!c.hidden){c.hidden=!0;return}let o=l("#help-modal");if(o&&!o.hidden){o.hidden=!0,l("#help-btn")?.focus();return}let d=l("#songs-search");d&&document.activeElement===d&&d.value&&(t.preventDefault(),d.value="",d.dispatchEvent(new Event("input",{bubbles:!0})))}});fe(()=>{u.data&&(Vt(),(u.activeTab==="dashboard"||u.activeTab==="analytics")&&Z())});function cn(){ae()}cn();export{ws as getWatchHistory};

import{l as rt,o as G}from"./chunk-BYWXM5B7.js";import"./chunk-J3NRXPJ3.js";import{a as nt,b as lt,c as C}from"./chunk-LXYT6HRB.js";import{e as K}from"./chunk-33BPFLKT.js";import{G as N,I as E,J as W,K as B,L as V,R as h,a as M,c as r}from"./chunk-J7UMASMC.js";var ut="kanau-music-videos-cache-v2",U=24,w="all-streams",P=1,tt="newest",k="grid",f=null,z=null,j=!1,H="",J=null,A=!1,x=new Set;function y(){return nt()}function T(t){lt(t)}function pt(t){let s=y(),a={id:String(Date.now()),name:t.trim(),createdAt:new Date().toISOString(),streams:[]};return s.unshift(a),T(s),a}function xt(t){T(y().filter(s=>s.id!==t))}function St(t,s){let a=y(),n=a.find(e=>e.id===t);return!n||n.streams.includes(s)?!1:(n.streams.push(s),T(a),!0)}function kt(t,s){let a=y(),n=a.find(e=>e.id===t);n&&(n.streams=n.streams.filter(e=>e!==s),T(a))}function L(){let t=M("#panel-playlists");if(!t)return;let s=K.data?.streams||[];if(w==="my-playlists"&&f===null){let e=q();e.length?f=e:ft().then(l=>{f===null&&(f=Array.isArray(l)?l:[]),w==="my-playlists"&&L()})}let a=document.activeElement?.id==="pl-music-search",n=null;if(a){try{n=document.activeElement.selectionStart}catch{}H=document.activeElement.value||""}if(t.innerHTML=`
  ...
  `,w==="music"&&At(),a){let e=M("#pl-music-search");if(e&&(e.focus(),n!==null))try{e.setSelectionRange(n,n)}catch{}}t.onclick=e=>{let l=e.target.closest("[data-nav-tab]");if(l){document.querySelector(`[data-tab="${l.dataset.navTab}"]`)?.click();return}let i=e.target.closest("[data-pl-subtab]");if(i){w=i.dataset.plSubtab,w==="all-streams"&&(P=1),L();return}let m=e.target.closest("[data-pl-sort]");if(m){tt=m.dataset.plSort,P=1,it(s);return}let u=e.target.closest("[data-pl-page]");if(u&&!u.disabled){P=Number(u.dataset.plPage),it(s);return}let p=e.target.closest("[data-music-view]:not([data-music-select-toggle])");if(p){k=p.dataset.musicView,R();return}if(e.target.closest("[data-music-select-toggle]")){A=!A,A||x.clear(),Z();return}let b=e.target.closest("[data-mv-select]");if(b){let c=b.dataset.mvSelect,o=!x.has(c);o?x.add(c):x.delete(c);let g=b.classList.contains("mv-list-row")?b:b.closest(".mv-card");g&&g.classList.toggle("is-selected",o);let _=g?.querySelector(".mv-card-checkbox, .mv-list-checkbox");_&&(_.innerHTML=o?h("check"):""),b.setAttribute("aria-pressed",String(o)),It();return}if(e.target.closest("[data-music-select-all]")){Y(f||[]).forEach(({v:c})=>x.add(c.id)),Z();return}if(e.target.closest("[data-music-select-clear]")){x.clear(),Z();return}if(e.target.closest("[data-music-select-add]")){if(!x.size)return;let c=[...f||[]].filter(o=>x.has(o.id)).map(o=>"mv:"+o.id);ot(c);return}let d=e.target.closest("[data-playlist-add-mv]");if(d){let c=d.dataset.playlistAddMv,o=d.dataset.streamTitle||"";ot("mv:"+c,o);return}let v=e.target.closest("[data-mv-watch]");if(v&&f?.length){if(e.metaKey||e.ctrlKey||e.shiftKey||e.button===1)return;e.preventDefault();let c=f[Number(v.dataset.mvWatch)];c?.url&&G({url:c.url,title:c.title,isMv:!0});return}w==="my-playlists"&&Ft(e,s)},t.oninput=e=>{let l=e.target.closest("#pl-music-search");l&&(H=l.value||"",clearTimeout(J),J=setTimeout(R,100))},t.oncompositionend=e=>{let l=e.target.closest("#pl-music-search");l&&(H=l.value||"",clearTimeout(J),R())},t.addEventListener("error",e=>{let l=e.target;if(!l.classList.contains("pl-sg-thumb"))return;let i=l.dataset.fallback;i&&l.src!==i&&(l.src=i,delete l.dataset.fallback)},!0),Nt()}var Lt=[{key:"newest",label:"\u65B0\u3057\u3044\u9806"},{key:"oldest",label:"\u53E4\u3044\u9806"},{key:"most-songs",label:"\u66F2\u6570\u2193"},{key:"fewest-songs",label:"\u66F2\u6570\u2191"}];function Tt(t,s){let a=t.slice();return s==="oldest"?a.reverse():s==="most-songs"?a.sort((n,e)=>(e.songs?.length??0)-(n.songs?.length??0)):s==="fewest-songs"?a.sort((n,e)=>(n.songs?.length??0)-(e.songs?.length??0)):a}function mt(t,s){if(!t.length)return`
      ...
      <button class="pl-sg-card" type="button" data-stream-play="${r(v)}"
        ...
        <div class="pl-sg-thumb-wrap">
          ...
          <span class="pl-sg-add${C(v)?" is-saved":""}" role="button" tabindex="0"
    ...
    </div>`}<div class="pl-stream-grid" id="pl-stream-grid">${u}</div>${p}`}function it(t){let s=M("#pl-subtab-body");if(!s){L();return}s.innerHTML=mt(t,P);let a=M("#panel-playlists");a&&a.addEventListener("error",n=>{let e=n.target;if(!e.classList.contains("pl-sg-thumb"))return;let l=e.dataset.fallback;l&&e.src!==l&&(e.src=l,delete e.dataset.fallback)},{once:!0,capture:!0}),s.scrollIntoView({behavior:"smooth",block:"start"})}function Et(){if(f===null){let t=q();t.length&&(f=t)}return st(f||[])}async function At(){if(f!==null){Q();return}f=q(),j=!0,Q();let t=await ft();j=!1,f=Array.isArray(t)?t:[],Q()}function Q(){if(w!=="music")return;let t=M("#pl-subtab-body");t&&(M("#pl-music-search")?R():t.innerHTML=st(f||[]))}function st(t){return Bt(t)+`<div id="pl-music-results">${bt(t)}</div>`}function Bt(t){let s=et(),n=Y(t).length;return`
    ...
    </div>`}function bt(t){let s=Y(t);return j&&!t.length?'<div class="pl-empty-state"><p>\u8AAD\u307F\u8FBC\u307F\u4E2D\u2026</p><p class="pl-empty-hint">\u691C\u7D22\u6B04\u306F\u3053\u306E\u307E\u307E\u5165\u529B\u3067\u304D\u307E\u3059</p></div>':t.length?s.length?k==="grid"?ct(s):k==="list"?Rt(s):k==="category"?jt(s):ct(s):j?`<div class="pl-empty-state"><p>\u6700\u65B0\u30C7\u30FC\u30BF\u3092\u78BA\u8A8D\u4E2D\u2026</p><p class="pl-empty-hint">\u300C${r(et())}\u300D\u306E\u5019\u88DC\u3092\u8AAD\u307F\u8FBC\u3093\u3067\u3044\u307E\u3059</p></div>`:'<div class="pl-empty-state"><p>\u4E00\u81F4\u3059\u308B\u52D5\u753B\u304C\u3042\u308A\u307E\u305B\u3093</p><p class="pl-empty-hint">\u300C\u66F2\u540D / \u30A2\u30FC\u30C6\u30A3\u30B9\u30C8\u300D\u306E\u3088\u3046\u306B\u533A\u5207\u3063\u3066\u691C\u7D22\u3067\u304D\u307E\u3059</p></div>':'<div class="pl-empty-state"><p>\u52D5\u753B\u304C\u767B\u9332\u3055\u308C\u3066\u3044\u307E\u305B\u3093</p><p class="pl-empty-hint">\u7BA1\u7406\u753B\u9762\u304B\u3089\u767B\u9332\u3067\u304D\u307E\u3059</p></div>'}function et(){let t=M("#pl-music-search");return t&&(H=t.value||""),H}function Z(){let t=M("#pl-subtab-body");t&&(t.innerHTML=st(f||[]))}function It(){let t=x.size,s=M("#pl-music-selcount");s&&(s.textContent=`${t}\u66F2\u3092\u9078\u629E\u4E2D`);let a=document.querySelector("[data-music-select-add]");a&&(a.disabled=!t,a.innerHTML=`${h("plus")} ${t}\u66F2\u3092\u307E\u3068\u3081\u3066\u8FFD\u52A0`);let n=document.querySelector("[data-music-select-clear]");n&&(n.disabled=!t)}function R(){let t=f||[],s=M(".pl-music-count");if(s){let n=Y(t).length;s.textContent=`${n}${n===t.length?"":` / ${t.length}`}\u4EF6`}document.querySelectorAll("[data-music-view]").forEach(n=>{n.classList.toggle("active",n.dataset.musicView===k)});let a=M("#pl-music-results");a&&(a.innerHTML=bt(t))}function q(){try{let t=JSON.parse(localStorage.getItem(ut)||"null");return Array.isArray(t?.videos)?t.videos:[]}catch{return[]}}function Pt(t){try{localStorage.setItem(ut,JSON.stringify({videos:t,cachedAt:Date.now()}))}catch{}}async function ft(){return z||(z=fetch("/data/music.json",{cache:"no-store"}).then(t=>t.ok?t.json():Promise.reject(new Error(`music.json ${t.status}`))).then(t=>{let s=Array.isArray(t?.videos)?t.videos:[];return Pt(s),s}).catch(()=>f||q()),z)}function vt(t){return String(t||"").normalize("NFKC").toLowerCase().replace(/[！-～]/g,s=>String.fromCharCode(s.charCodeAt(0)-65248)).replace(/[‐-‒–—―ー]/g,"-").replace(/\s+/g," ").trim()}function Ht(t){return vt(t).split(/[\/／|｜\s]+/).map(s=>s.trim()).filter(Boolean)}function Vt(t){let s=t.title||"",a=s.split(/[\/／|｜]/).map(e=>e.trim()).filter(Boolean),n=F(t).label;return vt([s,...a,t.originalArtist,t.character,t.type,n].filter(Boolean).join(" "))}function Y(t){let s=Ht(et()),a=t.map((n,e)=>({v:n,i:e}));return s.length?a.filter(({v:n})=>{let e=Vt(n);return s.every(l=>e.includes(l))}):a}function F(t){switch(t.type){case"cover":return{label:"\u30AB\u30D0\u30FC",cls:"mv-badge-cover",sub:t.originalArtist||"\u30AB\u30D0\u30FC\u66F2"};case"office":return{label:"Re:AcT",cls:"mv-badge-office",sub:"Re:AcT"};case"character":return{label:"\u30AD\u30E3\u30E9",cls:"mv-badge-character",sub:t.character||"\u30AD\u30E3\u30E9\u30BD\u30F3"};default:return{label:"\u30AA\u30EA\u30B8\u30CA\u30EB",cls:"mv-badge-original",sub:"\u304B\u306A\u3046"}}}function D(t){return t.publishedAt?String(t.publishedAt).replaceAll("-","/"):"\u516C\u958B\u65E5\u672A\u767B\u9332"}function ht(t,s){let a=B(t.url),n=V(t.url),{label:e,cls:l}=F(t),i=C("mv:"+t.id);if(A){let m=x.has(t.id);return`
    ...
    </div>`}function zt(t,s){let a=B(t.url),n=V(t.url),{label:e,cls:l,sub:i}=F(t),m=C("mv:"+t.id);if(A){let u=x.has(t.id);return`

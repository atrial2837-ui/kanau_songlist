import{a as it,e as at,f as G,g as ot,h as rt,j as lt,l as k}from"./chunk-I3NVQXRL.js";import{a as tt,b as D,e}from"./chunk-JT7WCFD3.js";import{B as K,D as et,F as R,L as nt,O as j,P as v,a as u,c as r,g as st,k as q,l as Q,m as _}from"./chunk-XREH2M7C.js";var L,M,x,V,Y,P,gt,C,vt=null,pt="kanau-setlist-v1",E=[],H=null,I=null,T=null;function W(){T&&(T.disconnect(),T=null)}function yt(t){if(W(),e.songsLimit>=t)return;let s=document.getElementById("songs-infinite-sentinel");s&&(T=new IntersectionObserver(i=>{i[0].isIntersecting&&(e.songsLimit+=100,h())},{rootMargin:"200px"}),T.observe(s))}function Wt(){W(),xt(),Tt(),it(e.data?.songs||[]);let t=u("#panel-songs");t.innerHTML=`
  ...
  `,L=u("#songs-search"),M=u("#songs-sort"),x=u("#songs-genre"),V=u("#songs-filters"),Y=u("#songs-genre-chips"),P=u("#songs-list"),gt=u("#songs-count"),C=u("#songs-more-wrap"),M.value=e.songsSort,x.value=$t(e.songsGenre)?e.songsGenre:"all",e.songsGenre=x.value,O(),N(),U();let s=document.getElementById("search-suggest"),i=nt(()=>{e.songsQuery=L.value,e.songsLimit=100,G(e.songsQuery),F(),k({tab:"songs",q:e.songsQuery},{replace:!0}),N(),h()},120);L.addEventListener("input",()=>{i()}),L.addEventListener("focus",()=>{ct()}),L.addEventListener("blur",()=>{setTimeout(()=>{F()},200)}),s&&s.addEventListener("click",n=>{let l=n.target.closest("[data-suggest]");if(!l)return;let d=l.dataset.suggest;L.value===d?(L.value="",e.songsQuery=""):(L.value=d,e.songsQuery=d),e.songsLimit=100,G(e.songsQuery||d),k({tab:"songs",q:e.songsQuery},{replace:!0}),N(),h()}),M.addEventListener("change",()=>{e.songsSort=M.value,h()}),x.addEventListener("change",()=>{e.songsGenre=x.value,e.songsLimit=100,U(),h()}),V.addEventListener("click",n=>{let l=n.target.closest("[data-filter]");l&&(l.dataset.filter==="favorites"?e.favoritesFilter=!e.favoritesFilter:(e.songsFilter=l.dataset.filter,e.favoritesFilter=!1),e.songsLimit=100,O(),h())}),t.querySelector(".songs-fav-toggle")?.addEventListener("click",()=>{e.favoritesFilter=!e.favoritesFilter,e.favoritesFilter&&(e.songsFilter="all"),e.songsLimit=100,O(),h()}),Y.addEventListener("click",n=>{let l=n.target.closest("[data-genre]");l&&(e.songsGenre=l.dataset.genre,x.value=e.songsGenre,e.songsLimit=100,U(),h())});for(let n of t.querySelectorAll("[data-singer-preset]"))n.addEventListener("click",()=>{e.singerMode=!0,e.singerPreset=e.singerPreset===n.dataset.singerPreset?"all":n.dataset.singerPreset,e.songsLimit=100,h()});u("#compact-btn")?.addEventListener("click",()=>{e.songsView=e.songsView==="compact"?"comfortable":"compact",h()}),u("#setlist-toggle-btn")?.addEventListener("click",()=>bt()),u("#recommend-btn")?.addEventListener("click",()=>kt()),u("#todays-song-btn")?.addEventListener("click",()=>dt());for(let n of t.querySelectorAll("[data-mobile-panel-toggle]"))n.addEventListener("click",()=>ht(n.dataset.mobilePanelToggle));t.onclick=n=>{if(n.target.closest("#search-history-clear")){n.preventDefault(),n.stopPropagation(),rt(),F();return}let d=n.target.closest(".search-history-remove");if(d){n.preventDefault(),n.stopPropagation(),ot(d.dataset.remove),ct();return}let o=n.target.closest(".search-history-item");if(o){n.preventDefault(),n.stopPropagation();let f=o.dataset.query;e.songsQuery=f,L.value=f,e.songsLimit=100,F(),k({tab:"songs",q:f}),h();return}if(n.target.closest("[data-recommend-dismiss]")){n.preventDefault(),n.stopPropagation();let f=u("#recommend-box");f&&(f.hidden=!0,f.innerHTML="");return}if(n.target.closest("[data-todays-song-dismiss]")){n.preventDefault(),n.stopPropagation();let f=u("#todays-song-box");f&&(f.hidden=!0,f.innerHTML="");return}if(n.target.closest("[data-todays-song-reroll]")){n.preventDefault(),n.stopPropagation(),dt();return}let p=n.target.closest("[data-setlist-action]");if(p){n.stopPropagation(),It(p);return}let b=n.target.closest("[data-artist-search]");if(b){n.stopPropagation();let f=String(b.dataset.artistSearch||"").replace(/"/g,"");e.songsQuery=`artist:"${f}"`,L.value=e.songsQuery,e.songsLimit=100,k({tab:"songs",q:e.songsQuery}),h();return}let m=n.target.closest("[data-fav-toggle]");if(m){n.preventDefault(),n.stopPropagation();let f=m.dataset.favToggle;tt(f);let Z=D(f);m.classList.toggle("is-active",Z),m.setAttribute("aria-pressed",String(Z)),m.innerHTML=v("heart");return}let $=n.target.closest("[data-tag-search]");if(!$)return;n.stopPropagation();let S=$.dataset.tagType||"tag";e.songsQuery=`${S}:${$.dataset.tagSearch}`,L.value=e.songsQuery,e.songsLimit=100,k({tab:"songs",q:e.songsQuery}),h()},t.oninput=n=>{n.target.id==="setlist-theme"&&(e.setlist.theme=n.target.value,w())},t.onchange=n=>{n.target.id==="setlist-copy-format"&&(e.setlist.copyFormat=n.target.value,w())},t.onkeydown=n=>{n.key==="Enter"&&(!n.target.closest(".setlist-custom-add")&&!n.target.closest(".setlist-custom-details")||n.target.tagName!=="BUTTON"&&(n.preventDefault(),mt()))},h()}function ct(){let t=at(),s=u("#search-history-dropdown");s&&(vt=s,t.length?s.innerHTML=`
      ...
      `).join("")}
    `:s.innerHTML='<div class="search-history-empty">\u691C\u7D22\u5C65\u6B74\u304C\u3042\u308A\u307E\u305B\u3093</div>',s.hidden=!1)}function F(){let t=u("#search-history-dropdown");t&&(t.hidden=!0)}function ht(t){let s=u("#songs-filter-panel"),i=u("#setlist-planner");if(t==="setlist"&&!e.singerMode){s?.classList.add("is-open"),i?.classList.remove("is-open");for(let l of document.querySelectorAll("[data-mobile-panel-toggle]"))l.classList.toggle("active",l.dataset.mobilePanelToggle==="filters");return}if(e.singerMode){s?.classList.add("is-open"),s?.scrollIntoView({behavior:"smooth",block:"start"});for(let d of document.querySelectorAll("[data-mobile-panel-toggle]"))d.classList.toggle("active",d.dataset.mobilePanelToggle==="filters");return}let n=t==="setlist";s?.classList.toggle("is-open",!n),i?.classList.toggle("is-open",n);for(let l of document.querySelectorAll("[data-mobile-panel-toggle]"))l.classList.toggle("active",l.dataset.mobilePanelToggle===t)}function bt(){if(!e.singerMode)return;e.setlistExpanded=!e.setlistExpanded,y();let t=u("#setlist-planner");e.setlistExpanded&&t?.scrollIntoView({behavior:"smooth",block:"start"})}function B(t){return String(t.genre||"\u672A\u5206\u985E").trim()||"\u672A\u5206\u985E"}function z(){let t=new Map;for(let s of e.data.songs||[]){let i=B(s);t.set(i,(t.get(i)||0)+1)}return[...t.entries()].sort((s,i)=>i[1]-s[1]||s[0].localeCompare(i[0],"ja"))}function $t(t){return t==="all"||z().some(([s])=>s===t)}function Lt(){let t=['<option value="all">\u5168\u30B8\u30E3\u30F3\u30EB</option>'];for(let[s,i]of z())t.push(`<option value="${r(s)}">${r(s)} (${i})</option>`);return t.join("")}function St(){let t=['<button class="genre-chip" type="button" data-genre="all">\u5168\u30B8\u30E3\u30F3\u30EB</button>'];for(let[s,i]of z())t.push(`
      <button class="genre-chip" type="button" data-genre="${r(s)}">
        <span>${r(s)}</span><small>${i}</small>
      </button>
    `);return t.join("")}function U(){for(let t of Y.querySelectorAll("[data-genre]"))t.classList.toggle("active",t.dataset.genre===e.songsGenre)}function O(){for(let s of V.querySelectorAll("[data-filter]"))s.dataset.filter==="favorites"?(s.classList.toggle("primary",e.favoritesFilter),s.classList.toggle("ghost",!e.favoritesFilter)):(s.classList.toggle("primary",s.dataset.filter===e.songsFilter&&!e.favoritesFilter),s.classList.toggle("ghost",s.dataset.filter!==e.songsFilter||e.favoritesFilter));let t=document.querySelector(".songs-fav-toggle");t&&(t.classList.toggle("is-active",e.favoritesFilter),t.setAttribute("aria-pressed",String(e.favoritesFilter)),t.innerHTML=v("heart"))}function N(){let t=document.getElementById("search-suggest");if(!t)return;let s=(e.songsQuery||"").trim();for(let i of t.querySelectorAll("[data-suggest]"))i.classList.toggle("is-active",i.dataset.suggest===s)}function h(){let{songs:t}=e.data,s=q(t,e.songsGenre,B),i=_(s,{singerMode:e.singerMode,preset:e.singerPreset,keyPublished:e.data?.stats?.keyPublished}),n=Q(i,e.songsFilter),{results:l,tokens:d}=lt(e.songsQuery,n),o=e.songsQuery.trim()?l.filter(a=>n.includes(a)):n;if(e.favoritesFilter&&(o=o.filter(a=>e.favorites.has(a.key))),o=K(o,e.songsSort,!!e.songsQuery.trim()),E=o,gt.textContent=`${o.length} / ${t.length}\u66F2`,!o.length){P.innerHTML='<div class="empty-state">\u8A72\u5F53\u3059\u308B\u66F2\u304C\u3042\u308A\u307E\u305B\u3093 \u{1F420}</div>',C.innerHTML="";return}let c=o.slice(0,e.songsLimit);P.classList.toggle("compact",e.songsView==="compact");for(let a of document.querySelectorAll("[data-singer-preset]")){let g=e.singerMode&&e.singerPreset===a.dataset.singerPreset;a.classList.toggle("primary",g),a.classList.toggle("ghost",!g)}u("#compact-btn")&&(u("#compact-btn").textContent=`\u8868\u793A: ${e.songsView==="compact"?"\u30B3\u30F3\u30D1\u30AF\u30C8":"\u8A73\u7D30"}`),P.innerHTML=c.map(a=>_t(a,d)).join(""),y(),e.songsLimit<o.length?(C.innerHTML=`
  ...
  `}function xt(){try{let t=localStorage.getItem(pt);if(!t)return;let s=JSON.parse(t);e.setlist.theme=String(s.theme||""),e.setlist.copyFormat=s.copyFormat==="timestamp"?"timestamp":"simple",e.setlist.items=Array.isArray(s.items)?s.items:[]}catch{e.setlist.items=[]}}function Et(){let t=e.setlist.items;if(!t.length)return window.location.href.split("?")[0];let s=btoa(unescape(encodeURIComponent(JSON.stringify(t)))),i=new URL(window.location.href.split("?")[0]);return i.searchParams.set("setlist",s),i.toString()}function Tt(){try{let s=new URLSearchParams(window.location.search).get("setlist");if(!s)return;let i=decodeURIComponent(escape(atob(s))),n=JSON.parse(i);if(!Array.isArray(n)||!n.length)return;let l=new Set(e.setlist.items.map(o=>o.key)),d=n.filter(o=>!l.has(o.key));d.length&&(e.setlist.items=[...e.setlist.items,...d],w())}catch{}}async function Mt(){let t=Et();if(!e.setlist.items.length){y("\u5171\u6709\u3059\u308B\u66F2\u304C\u3042\u308A\u307E\u305B\u3093");return}try{await navigator.clipboard.writeText(t),y("\u5171\u6709URL\u3092\u30B3\u30D4\u30FC\u3057\u307E\u3057\u305F")}catch{y("\u30B3\u30D4\u30FC\u306B\u5931\u6557\u3057\u307E\u3057\u305F")}}function w(){localStorage.setItem(pt,JSON.stringify(e.setlist))}function J(t){return(e.data.songs||[]).find(s=>s.key===t)||null}function A(t){t&&(e.setlist.items.push({key:t.key,title:t.title,artist:t.artist,displayKey:t.displayKey||"",genre:t.genre||"",moodTags:t.moodTags||[],seasonTags:t.seasonTags||[],daysSinceLast:t.daysSinceLast}),w(),y("\u8FFD\u52A0\u3057\u307E\u3057\u305F"))}function mt(){let t=u("#setlist-custom-title"),s=u("#setlist-custom-artist"),i=u("#setlist-custom-key"),n=String(t?.value||"").trim(),l=String(s?.value||"").trim(),d=String(i?.value||"").trim();if(!n){y("\u66F2\u540D\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044");return}e.setlist.items.push({key:`custom:${Date.now()}:${Math.random().toString(36).slice(2,8)}`,custom:!0,title:n,artist:l,displayKey:d,genre:"\u65B0\u898F",moodTags:[],seasonTags:[],daysSinceLast:null}),w(),y("\u65B0\u3057\u3044\u66F2\u3092\u8FFD\u52A0\u3057\u307E\u3057\u305F")}function Ht(t){if(t.custom)return t;let s=J(t.key);return s?{...t,...s}:t}function It(t){let s=t.dataset.setlistAction,i=Number(t.dataset.index);if(s==="add"&&A(J(t.dataset.songkey)),s==="todays-song-add"&&A(J(t.dataset.songkey)),s==="remove"&&e.setlist.items.splice(i,1),s==="up"&&i>0&&([e.setlist.items[i-1],e.setlist.items[i]]=[e.setlist.items[i],e.setlist.items[i-1]]),s==="down"&&i<e.setlist.items.length-1&&([e.setlist.items[i+1],e.setlist.items[i]]=[e.setlist.items[i],e.setlist.items[i+1]]),s==="copy-item"){Qt(i);return}if(s==="add-custom"){mt();return}if(s==="random"&&Ft(),s==="copy"&&qt(),s==="share"){Mt();return}s==="clear"&&confirm("\u30BB\u30C8\u30EA\u3092\u7A7A\u306B\u3057\u307E\u3059\u304B\uFF1F")&&(e.setlist.items=[]),w(),["add","random","copy"].includes(s)||y()}function Ft(){let t=new Set(e.setlist.items.map(n=>n.key)),s=(E.length?E:e.data.songs).filter(n=>n.key&&!t.has(n.key));if(!s.length){y("\u8FFD\u52A0\u3067\u304D\u308B\u5019\u88DC\u304C\u3042\u308A\u307E\u305B\u3093");return}let i=s[Math.floor(Math.random()*s.length)];A(i)}function X(){return e.setlist.items.map(Ht)}function Pt(t){let s=i=>{let n=new Map;for(let l of t)for(let d of i(l))d&&n.set(d,(n.get(d)||0)+1);return[...n.entries()].sort((l,d)=>d[1]-l[1]).slice(0,3)};return{genres:s(i=>[i.genre||"\u672A\u5206\u985E"]),moods:s(i=>i.moodTags||[]),keys:t.filter(i=>i.displayKey).length,stale:t.filter(i=>i.daysSinceLast>=180).length}}function y(t=""){let s=u("#setlist-planner");if(!s)return;if(Kt(),s.hidden=!e.singerMode||!e.setlistExpanded,s.classList.toggle("is-open",e.singerMode&&e.setlistExpanded),!e.singerMode){s.innerHTML="";return}let i=X(),n=Pt(i),l=i.length*5;s.innerHTML=`
    ...
    <div class="setlist-items">
      ${i.length?i.map((d,o)=>Ct(d,o)).join(""):'<div class="setlist-empty">\u66F2\u306E\u300C\u30BB\u30C8\u30EA\u300D\u30DC\u30BF\u30F3\u304B\u30E9\u30F3\u30C0\u30E0\u8FFD\u52A0\u304B\u3089\u4F5C\u308C\u307E\u3059</div>'}
    </div>
  ...
  `,At(),Bt()}function ut(t,s){return s.length?`<span>${t} ${s.map(([i,n])=>`${r(i)} ${n}`).join(" / ")}</span>`:`<span>${t} \u2014</span>`}function Ct(t,s){return`
  ...
  `}function At(){let t=document.getElementById("setlist-search-input"),s=document.getElementById("setlist-search-dropdown");if(!t||!s)return;let i=[],n=-1;function l(c){let a=c.trim().toLowerCase();if(!a){s.hidden=!0,i=[],n=-1;return}let p=(e.data?.songs||[]).filter(m=>m.title.toLowerCase().includes(a)||(m.artist||"").toLowerCase().includes(a)).sort((m,$)=>{let S=m.title.toLowerCase().startsWith(a)?2:m.title.toLowerCase().includes(a)?1:0,f=$.title.toLowerCase().startsWith(a)?2:$.title.toLowerCase().includes(a)?1:0;return S!==f?f-S:$.count-m.count}).slice(0,8),b={_isNew:!0,title:c.trim()};p.length?(s.innerHTML=p.map((m,$)=>`
          ...
          <div class="setlist-dd-body">
            <div class="setlist-dd-title">\u300C${r(c.trim())}\u300D\u3092\u65B0\u898F\u8FFD\u52A0</div>
        ...
        </div>`,i=[b]),n=-1,s.hidden=!1,d()}function d(){s.querySelectorAll("[data-dd-idx]").forEach((c,a)=>c.classList.toggle("is-selected",a===n))}function o(c){let a=i[c];if(a)if(s.hidden=!0,i=[],n=-1,a._isNew){let g=document.querySelector(".setlist-custom-details"),p=document.getElementById("setlist-custom-title");g&&p?(g.open=!0,p.value=a.title,t.value="",document.getElementById("setlist-custom-artist")?.focus()):t.value=""}else t.value="",A(a)}t.addEventListener("input",()=>l(t.value)),t.addEventListener("keydown",c=>{if(s.hidden)return;let a=i.length;c.key==="ArrowDown"?(c.preventDefault(),n=(n+1)%a,d()):c.key==="ArrowUp"?(c.preventDefault(),n=(n-1+a)%a,d()):c.key==="Enter"?(c.preventDefault(),c.stopPropagation(),o(n>=0?n:0)):c.key==="Escape"&&(s.hidden=!0,n=-1)}),s.addEventListener("mousedown",c=>{let a=c.target.closest("[data-dd-idx]");a&&(c.preventDefault(),o(Number(a.dataset.ddIdx)))}),H&&document.removeEventListener("click",H),H=c=>{!t.contains(c.target)&&!s.contains(c.target)&&(s.hidden=!0,n=-1)},document.addEventListener("click",H)}function Bt(){I&&(I(),I=null);let t=document.querySelector(".setlist-items");if(!t)return;let s=null,i=()=>{s&&(s.rows.forEach(o=>{o.style.transform=""}),s.row.classList.remove("is-dragging"),t.classList.remove("is-drag-active"),s.row.removeEventListener("pointermove",n),s.row.removeEventListener("pointerup",l),s.row.removeEventListener("pointercancel",d),s=null)};function n(o){if(!s)return;o.preventDefault();let c=o.clientY-s.startY;if(!s.moved&&Math.abs(c)<3)return;s.moved=!0,s.row.style.transform=`translateY(${c}px)`;let a=s.mids[s.startIdx]+c,g=0;for(let p=0;p<s.mids.length;p++)p!==s.startIdx&&a>s.mids[p]&&g++;g!==s.targetIdx&&(s.targetIdx=g,s.rows.forEach((p,b)=>{if(b===s.startIdx)return;let m=0;s.startIdx<g&&b>s.startIdx&&b<=g?m=-s.rowH:s.startIdx>g&&b>=g&&b<s.startIdx&&(m=s.rowH),p.style.transform=m?`translateY(${m}px)`:""}))}function l(){if(!s)return;let{startIdx:o,targetIdx:c,moved:a}=s;if(i(),!a||c===o)return;let g=e.setlist.items;if(o<g.length){let[p]=g.splice(o,1);g.splice(c,0,p),w(),y()}}function d(){i()}t.addEventListener("pointerdown",o=>{if(s||o.button!=null&&o.button!==0)return;let c=!!o.target.closest(".setlist-drag-handle");if(o.pointerType==="touch"&&!c||o.target.closest("button, a, input, select, textarea"))return;let a=o.target.closest(".setlist-item");if(!a)return;o.preventDefault();let g=Array.from(t.querySelectorAll(".setlist-item")),p=g.indexOf(a);if(p<0)return;let b=g.map($=>{let S=$.getBoundingClientRect();return S.top+S.height/2}),m=a.getBoundingClientRect();s={rows:g,mids:b,startIdx:p,targetIdx:p,startY:o.clientY,rowH:m.height+(parseFloat(getComputedStyle(t).rowGap||getComputedStyle(t).gap)||0),row:a,moved:!1},a.classList.add("is-dragging"),t.classList.add("is-drag-active");try{a.setPointerCapture(o.pointerId)}catch{}a.addEventListener("pointermove",n,{passive:!1}),a.addEventListener("pointerup",l),a.addEventListener("pointercancel",d)}),I=i}function Dt(){let t=X(),s=[];return e.setlist.theme&&s.push(`# ${e.setlist.theme}`,""),t.forEach(i=>{s.push(ft(i))}),s.join(`
`)}function ft(t){let s=String(t?.title||"").trim(),i=String(t?.artist||"").trim(),n=i?`${s} / ${i}`:s;return e.setlist.copyFormat==="timestamp"?`00:00\u3000${n}\u300000:00`:n}async function qt(){let t=Dt();if(!t.trim()){y("\u30B3\u30D4\u30FC\u3059\u308B\u66F2\u304C\u3042\u308A\u307E\u305B\u3093");return}try{await navigator.clipboard.writeText(t),y("\u30B3\u30D4\u30FC\u3057\u307E\u3057\u305F")}catch{y("\u30B3\u30D4\u30FC\u306B\u5931\u6557\u3057\u307E\u3057\u305F")}}async function Qt(t){let s=X()[t];if(!s){y("\u30B3\u30D4\u30FC\u3059\u308B\u66F2\u304C\u3042\u308A\u307E\u305B\u3093");return}try{await navigator.clipboard.writeText(ft(s)),y("1\u66F2\u30B3\u30D4\u30FC\u3057\u307E\u3057\u305F")}catch{y("\u30B3\u30D4\u30FC\u306B\u5931\u6557\u3057\u307E\u3057\u305F")}}function _t(t,s){let i=t.rank===1?"r1":t.rank===2?"r2":t.rank===3?"r3":"",n=t.lastSung?`<span class="last-date">${R(t.lastSung)}</span><span class="badge ${st(t.daysSinceLast)}">${t.daysSinceLast}\u65E5\u524D</span>`:'<span class="last-date">\u5C65\u6B74\u672A\u78BA\u8A8D</span><span class="badge never">\u8981\u78BA\u8A8D</span>',l=j(t.title,s),d=j(t.artist,s),o=et(t,e.songsQuery),c=D(t.key);return`
    <div class="song-row" data-songkey="${r(t.key)}" data-songtitle="${r(t.title)}" data-songartist="${r(t.artist)}" title="\u30AF\u30EA\u30C3\u30AF\u3067\u66F2\u8A73\u7D30\u3092\u8868\u793A">
      ...
      <div class="info">
        <div class="title song-title-line"><span class="song-title-text">${l}</span><button class="fav-btn ${c?"is-active":""}" type="button" data-fav-toggle="${r(t.key)}" aria-label="\u304A\u6C17\u306B\u5165\u308A" aria-pressed="${c?"true":"false"}" title="\u304A\u6C17\u306B\u5165\u308A">${v("heart")}</button></div>
        <button class="artist artist-search-btn" type="button" data-artist-search="${r(t.artist)}">${d}</button>
  ...
  `}function Kt(){let t=u("#setlist-toggle-btn");if(!t)return;let s=e.setlist.items.length;t.setAttribute("aria-expanded",e.setlistExpanded?"true":"false"),t.textContent=e.setlistExpanded?`\u30BB\u30C8\u30EA\u5236\u4F5C\u3092\u9589\u3058\u308B${s?` (${s})`:""}`:`\u30BB\u30C8\u30EA\u5236\u4F5C\u3092\u958B\u304F${s?` (${s})`:""}`}function Rt(t){return[...(t.seasonTags||[]).map(i=>({tag:i,type:"season"})),...(t.moodTags||[]).map(i=>({tag:i,type:"mood"})),...e.singerMode?(t.singerTags||[]).map(i=>({tag:i,type:"tag"})):[]].slice(0,e.songsView==="compact"?2:5).map(({tag:i,type:n})=>`

...
function rowHtml(song, tokens) {
  ...
  return `
    <div class="song-row song-row--list" data-songkey="${escapeHtml(song.key)}" data-songtitle="${escapeHtml(song.title)}" data-songartist="${escapeHtml(song.artist)}" title="クリックで曲詳細を表示">
      <div class="info">
        <div class="title">
          ${titleHtml}
